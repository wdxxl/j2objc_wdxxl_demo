...
- (OrgJsoupNodesDocument *)parseWithNSString:(NSString *)input
  ...
  state_ = JreLoadEnum(OrgJsoupParserHtmlTreeBuilderState, Initial);
...
- (id<JavaUtilList>)parseFragmentWithNSString:(NSString *)inputFragment
  ...
  if (context != nil) {
    if ([context ownerDocument] != nil) (void) [((OrgJsoupNodesDocument *) nil_chk(doc_)) quirksModeWithOrgJsoupNodesDocument_QuirksMode:[((OrgJsoupNodesDocument *) nil_chk([context ownerDocument])) quirksMode]];
    NSString *contextTag = [context tagName];
    if (OrgJsoupHelperStringUtil_inWithNSString_withNSStringArray_(contextTag, [IOSObjectArray newArrayWithObjects:(id[]){ @"title", @"textarea" } count:2 type:NSString_class_()])) [((OrgJsoupParserTokeniser *) nil_chk(tokeniser_)) transitionWithOrgJsoupParserTokeniserState:JreLoadEnum(OrgJsoupParserTokeniserState, Rcdata)];
    else if (OrgJsoupHelperStringUtil_inWithNSString_withNSStringArray_(contextTag, [IOSObjectArray newArrayWithObjects:(id[]){ @"iframe", @"noembed", @"noframes", @"style", @"xmp" } count:5 type:NSString_class_()])) [((OrgJsoupParserTokeniser *) nil_chk(tokeniser_)) transitionWithOrgJsoupParserTokeniserState:JreLoadEnum(OrgJsoupParserTokeniserState, Rawtext)];
    ...
    root = new_OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_(OrgJsoupParserTag_valueOfWithNSString_(@"html"), baseUri);
    (void) [((OrgJsoupNodesDocument *) nil_chk(doc_)) appendChildWithOrgJsoupNodesNode:root];
    ...
    for (OrgJsoupNodesElement * __strong parent in contextChain) {
      if ([parent isKindOfClass:[OrgJsoupNodesFormElement class]]) {
        formElement_ = (OrgJsoupNodesFormElement *) cast_chk(parent, [OrgJsoupNodesFormElement class]);
        break;
      }
    }
  }
...
- (void)errorWithOrgJsoupParserHtmlTreeBuilderState:(OrgJsoupParserHtmlTreeBuilderState *)state {
  if ([((OrgJsoupParserParseErrorList *) nil_chk(errors_)) canAddError]) [((OrgJsoupParserParseErrorList *) nil_chk(errors_)) addWithId:new_OrgJsoupParserParseError_initWithInt_withNSString_withNSObjectArray_([((OrgJsoupParserCharacterReader *) nil_chk(reader_)) pos], @"Unexpected token [%s] when in state [%s]", [IOSObjectArray newArrayWithObjects:(id[]){ [((OrgJsoupParserToken *) nil_chk(currentToken_)) tokenType], state } count:2 type:NSObject_class_()])];
}
...
- (OrgJsoupNodesElement *)insertWithOrgJsoupParserToken_StartTag:(OrgJsoupParserToken_StartTag *)startTag {
  ...
  OrgJsoupNodesElement *el = new_OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_withOrgJsoupNodesAttributes_(OrgJsoupParserTag_valueOfWithNSString_([startTag name]), baseUri_, startTag->attributes_);
  [self insertWithOrgJsoupNodesElement:el];
  return el;
}

- (OrgJsoupNodesElement *)insertStartTagWithNSString:(NSString *)startTagName {
  OrgJsoupNodesElement *el = new_OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_(OrgJsoupParserTag_valueOfWithNSString_(startTagName), baseUri_);
  [self insertWithOrgJsoupNodesElement:el];
  return el;
}
...
- (OrgJsoupNodesFormElement *)insertFormWithOrgJsoupParserToken_StartTag:(OrgJsoupParserToken_StartTag *)startTag
  ...
  OrgJsoupParserTag *tag = OrgJsoupParserTag_valueOfWithNSString_([((OrgJsoupParserToken_StartTag *) nil_chk(startTag)) name]);
  OrgJsoupNodesFormElement *el = new_OrgJsoupNodesFormElement_initWithOrgJsoupParserTag_withNSString_withOrgJsoupNodesAttributes_(tag, baseUri_, startTag->attributes_);
...
- (void)insertWithOrgJsoupParserToken_Character:(OrgJsoupParserToken_Character *)characterToken {
  ...
  if ([((NSString *) nil_chk(tagName)) isEqual:@"script"] || [tagName isEqual:@"style"]) node = new_OrgJsoupNodesDataNode_initWithNSString_withNSString_([((OrgJsoupParserToken_Character *) nil_chk(characterToken)) getData], baseUri_);
  else node = new_OrgJsoupNodesTextNode_initWithNSString_withNSString_([((OrgJsoupParserToken_Character *) nil_chk(characterToken)) getData], baseUri_);
...
- (jboolean)removeFromStackWithOrgJsoupNodesElement:(OrgJsoupNodesElement *)el {
  for (jint pos = [((JavaUtilArrayList *) nil_chk(stack_)) size] - 1; pos >= 0; pos--) {
    OrgJsoupNodesElement *next = [((JavaUtilArrayList *) nil_chk(stack_)) getWithInt:pos];
    if (next == el) {
      (void) [((JavaUtilArrayList *) nil_chk(stack_)) removeWithInt:pos];
      return true;
    }
  }
  return false;
...
- (void)clearStackToTableContext {
  OrgJsoupParserHtmlTreeBuilder_clearStackToContextWithNSStringArray_(self, [IOSObjectArray newArrayWithObjects:(id[]){ @"table" } count:1 type:NSString_class_()]);
}

- (void)clearStackToTableBodyContext {
  OrgJsoupParserHtmlTreeBuilder_clearStackToContextWithNSStringArray_(self, [IOSObjectArray newArrayWithObjects:(id[]){ @"tbody", @"tfoot", @"thead" } count:3 type:NSString_class_()]);
}

- (void)clearStackToTableRowContext {
  OrgJsoupParserHtmlTreeBuilder_clearStackToContextWithNSStringArray_(self, [IOSObjectArray newArrayWithObjects:(id[]){ @"tr" } count:1 type:NSString_class_()]);
}
...
- (void)setFormElementWithOrgJsoupNodesFormElement:(OrgJsoupNodesFormElement *)formElement {
  self->formElement_ = formElement;
}

- (void)newPendingTableCharacters {
  pendingTableCharacters_ = new_JavaUtilArrayList_init();
}
...
- (void)setPendingTableCharactersWithJavaUtilList:(id<JavaUtilList>)pendingTableCharacters {
  self->pendingTableCharacters_ = pendingTableCharacters;
}

- (void)generateImpliedEndTagsWithNSString:(NSString *)excludeTag {
  while ((excludeTag != nil && ![((NSString *) nil_chk([((OrgJsoupNodesElement *) nil_chk([self currentElement])) nodeName])) isEqual:excludeTag]) && OrgJsoupHelperStringUtil_inWithNSString_withNSStringArray_([((OrgJsoupNodesElement *) nil_chk([self currentElement])) nodeName], OrgJsoupParserHtmlTreeBuilder_TagSearchEndTags)) (void) [self pop];
}
...
- (void)pushActiveFormattingElementsWithOrgJsoupNodesElement:(OrgJsoupNodesElement *)inArg {
  ...
  for (jint pos = [((JavaUtilArrayList *) nil_chk(formattingElements_)) size] - 1; pos >= 0; pos--) {
    ...
    if (numSeen == 3) {
      (void) [((JavaUtilArrayList *) nil_chk(formattingElements_)) removeWithInt:pos];
      break;
    }
  }
...
- (void)reconstructFormattingElements {
  ...
  while (true) {
    ...
    (void) [((JavaUtilArrayList *) nil_chk(formattingElements_)) setWithInt:pos withId:newEl];
    if (pos == size - 1) break;
  }
}
...
- (void)insertInFosterParentWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)inArg {
  ...
  if (isLastTableParent) {
    ...
    (void) [((OrgJsoupNodesElement *) nil_chk(lastTable)) beforeWithOrgJsoupNodesNode:inArg];
  }
  else (void) [((OrgJsoupNodesElement *) nil_chk(fosterParent)) appendChildWithOrgJsoupNodesNode:inArg];
}
...
+ (void)initialize {
  if (self == [OrgJsoupParserHtmlTreeBuilder class]) {
    OrgJsoupParserHtmlTreeBuilder_TagsScriptStyle = [IOSObjectArray newArrayWithObjects:(id[]){ @"script", @"style" } count:2 type:NSString_class_()];
    OrgJsoupParserHtmlTreeBuilder_TagsSearchInScope = [IOSObjectArray newArrayWithObjects:(id[]){ @"applet", @"caption", @"html", @"table", @"td", @"th", @"marquee", @"object" } count:8 type:NSString_class_()];
    OrgJsoupParserHtmlTreeBuilder_TagSearchList = [IOSObjectArray newArrayWithObjects:(id[]){ @"ol", @"ul" } count:2 type:NSString_class_()];
    OrgJsoupParserHtmlTreeBuilder_TagSearchButton = [IOSObjectArray newArrayWithObjects:(id[]){ @"button" } count:1 type:NSString_class_()];
    OrgJsoupParserHtmlTreeBuilder_TagSearchTableScope = [IOSObjectArray newArrayWithObjects:(id[]){ @"html", @"table" } count:2 type:NSString_class_()];
    OrgJsoupParserHtmlTreeBuilder_TagSearchSelectScope = [IOSObjectArray newArrayWithObjects:(id[]){ @"optgroup", @"option" } count:2 type:NSString_class_()];
    OrgJsoupParserHtmlTreeBuilder_TagSearchEndTags = [IOSObjectArray newArrayWithObjects:(id[]){ @"dd", @"dt", @"li", @"option", @"optgroup", @"p", @"rp", @"rt" } count:8 type:NSString_class_()];
    OrgJsoupParserHtmlTreeBuilder_TagSearchSpecial = [IOSObjectArray newArrayWithObjects:(id[]){ @"address", @"applet", @"area", @"article", @"aside", @"base", @"basefont", @"bgsound", @"blockquote", @"body", @"br", @"button", @"caption", @"center", @"col", @"colgroup", @"command", @"dd", @"details", @"dir", @"div", @"dl", @"dt", @"embed", @"fieldset", @"figcaption", @"figure", @"footer", @"form", @"frame", @"frameset", @"h1", @"h2", @"h3", @"h4", @"h5", @"h6", @"head", @"header", @"hgroup", @"hr", @"html", @"iframe", @"img", @"input", @"isindex", @"li", @"link", @"listing", @"marquee", @"menu", @"meta", @"nav", @"noembed", @"noframes", @"noscript", @"object", @"ol", @"p", @"param", @"plaintext", @"pre", @"script", @"section", @"select", @"style", @"summary", @"table", @"tbody", @"td", @"textarea", @"tfoot", @"th", @"thead", @"title", @"tr", @"ul", @"wbr", @"xmp" } count:79 type:NSString_class_()];
...
void OrgJsoupParserHtmlTreeBuilder_init(OrgJsoupParserHtmlTreeBuilder *self) {
  ...
  self->formattingElements_ = new_JavaUtilArrayList_init();
  self->pendingTableCharacters_ = new_JavaUtilArrayList_init();
  self->emptyEnd_ = new_OrgJsoupParserToken_EndTag_init();
  self->framesetOk_ = true;
  self->fosterInserts_ = false;
  self->fragmentParsing_ = false;
  self->specificScopeTarget_ = [IOSObjectArray newArrayWithObjects:(id[]){ nil } count:1 type:NSString_class_()];
}
...
void OrgJsoupParserHtmlTreeBuilder_insertNodeWithOrgJsoupNodesNode_(OrgJsoupParserHtmlTreeBuilder *self, OrgJsoupNodesNode *node) {
  if ([((JavaUtilArrayList *) nil_chk(self->stack_)) size] == 0) (void) [((OrgJsoupNodesDocument *) nil_chk(self->doc_)) appendChildWithOrgJsoupNodesNode:node];
  else if ([self isFosterInserts]) [self insertInFosterParentWithOrgJsoupNodesNode:node];
  else (void) [((OrgJsoupNodesElement *) nil_chk([self currentElement])) appendChildWithOrgJsoupNodesNode:node];
  if ([node isKindOfClass:[OrgJsoupNodesElement class]] && [((OrgJsoupParserTag *) nil_chk([((OrgJsoupNodesElement *) nil_chk(((OrgJsoupNodesElement *) cast_chk(node, [OrgJsoupNodesElement class])))) tag])) isFormListed]) {
    if (self->formElement_ != nil) (void) [self->formElement_ addElementWithOrgJsoupNodesElement:(OrgJsoupNodesElement *) cast_chk(node, [OrgJsoupNodesElement class])];
  }
}
...
void OrgJsoupParserHtmlTreeBuilder_clearStackToContextWithNSStringArray_(OrgJsoupParserHtmlTreeBuilder *self, IOSObjectArray *nodeNames) {
  for (jint pos = [((JavaUtilArrayList *) nil_chk(self->stack_)) size] - 1; pos >= 0; pos--) {
    ...
    else (void) [((JavaUtilArrayList *) nil_chk(self->stack_)) removeWithInt:pos];
  }
}
...
void OrgJsoupParserHtmlTreeBuilder_replaceInQueueWithJavaUtilArrayList_withOrgJsoupNodesElement_withOrgJsoupNodesElement_(OrgJsoupParserHtmlTreeBuilder *self, JavaUtilArrayList *queue, OrgJsoupNodesElement *outArg, OrgJsoupNodesElement *inArg) {
  ...
  OrgJsoupHelperValidate_isTrueWithBoolean_(i != -1);
  (void) [queue setWithInt:i withId:inArg];
}
...
jboolean OrgJsoupParserHtmlTreeBuilder_inSpecificScopeWithNSString_withNSStringArray_withNSStringArray_(OrgJsoupParserHtmlTreeBuilder *self, NSString *targetName, IOSObjectArray *baseTypes, IOSObjectArray *extraTypes) {
  (void) IOSObjectArray_Set(nil_chk(self->specificScopeTarget_), 0, targetName);
