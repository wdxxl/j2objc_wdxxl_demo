...
__attribute__((unused)) static OrgJsoupConnection_Method *new_OrgJsoupConnection_Method_initWithBoolean_withNSString_withInt_(jboolean hasBody, NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
OrgJsoupConnection_Method *new_OrgJsoupConnection_Method_initWithBoolean_withNSString_withInt_(jboolean hasBody, NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgJsoupConnection_Method, initWithBoolean_withNSString_withInt_, hasBody, __name, __ordinal)
}
