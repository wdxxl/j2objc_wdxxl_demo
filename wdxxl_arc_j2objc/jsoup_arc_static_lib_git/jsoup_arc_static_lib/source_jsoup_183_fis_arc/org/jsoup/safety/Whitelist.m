  ...
  OrgJsoupHelperValidate_notNullWithId_(tags);
  {
    ...
    while (b__ < e__) {
      ...
      if ([((id<JavaUtilSet>) nil_chk(tagNames_)) removeWithId:tagName]) {
        (void) [((id<JavaUtilMap>) nil_chk(attributes_)) removeWithId:tagName];
        (void) [((id<JavaUtilMap>) nil_chk(enforcedAttributes_)) removeWithId:tagName];
        (void) [((id<JavaUtilMap>) nil_chk(protocols_)) removeWithId:tagName];
      }
    }
  }
  return self;
...
- (OrgJsoupSafetyWhitelist *)addAttributesWithNSString:(NSString *)tag
  ...
  id<JavaUtilSet> attributeSet = new_JavaUtilHashSet_init();
  {
  ...
  if ([((id<JavaUtilMap>) nil_chk(attributes_)) containsKeyWithId:tagName]) {
    ...
    (void) [((id<JavaUtilMap>) nil_chk(attributes_)) putWithId:tagName withId:attributeSet];
  }
  return self;
}
...
- (OrgJsoupSafetyWhitelist *)removeAttributesWithNSString:(NSString *)tag
  ...
  if ([((id<JavaUtilSet>) nil_chk(tagNames_)) containsWithId:tagName] && [((id<JavaUtilMap>) nil_chk(attributes_)) containsKeyWithId:tagName]) {
    ...
    if ([currentSet isEmpty]) (void) [((id<JavaUtilMap>) nil_chk(attributes_)) removeWithId:tagName];
  }
  if ([((NSString *) nil_chk(tag)) isEqual:@":all"]) for (OrgJsoupSafetyWhitelist_TagName * __strong name in nil_chk([((id<JavaUtilMap>) nil_chk(attributes_)) keySet])) {
    ...
    [((id<JavaUtilSet>) nil_chk(currentSet)) removeAllWithJavaUtilCollection:attributeSet];
    if ([currentSet isEmpty]) (void) [((id<JavaUtilMap>) nil_chk(attributes_)) removeWithId:name];
  }
  return self;
}
...
- (OrgJsoupSafetyWhitelist *)addEnforcedAttributeWithNSString:(NSString *)tag
  ...
  if ([((id<JavaUtilMap>) nil_chk(enforcedAttributes_)) containsKeyWithId:tagName]) {
    (void) [((id<JavaUtilMap>) nil_chk([((id<JavaUtilMap>) nil_chk(enforcedAttributes_)) getWithId:tagName])) putWithId:attrKey withId:attrVal];
  }
  else {
    id<JavaUtilMap> attrMap = new_JavaUtilHashMap_init();
    (void) [attrMap putWithId:attrKey withId:attrVal];
    (void) [((id<JavaUtilMap>) nil_chk(enforcedAttributes_)) putWithId:tagName withId:attrMap];
  }
  return self;
}
...
- (OrgJsoupSafetyWhitelist *)removeEnforcedAttributeWithNSString:(NSString *)tag
  ...
  if ([((id<JavaUtilSet>) nil_chk(tagNames_)) containsWithId:tagName] && [((id<JavaUtilMap>) nil_chk(enforcedAttributes_)) containsKeyWithId:tagName]) {
    ...
    (void) [((id<JavaUtilMap>) nil_chk(attrMap)) removeWithId:attrKey];
    if ([attrMap isEmpty]) (void) [((id<JavaUtilMap>) nil_chk(enforcedAttributes_)) removeWithId:tagName];
  }
  return self;
}
...
- (OrgJsoupSafetyWhitelist *)addProtocolsWithNSString:(NSString *)tag
  ...
  if ([((id<JavaUtilMap>) nil_chk(self->protocols_)) containsKeyWithId:tagName]) {
    ...
    attrMap = new_JavaUtilHashMap_init();
    (void) [((id<JavaUtilMap>) nil_chk(self->protocols_)) putWithId:tagName withId:attrMap];
  }
  if ([((id<JavaUtilMap>) nil_chk(attrMap)) containsKeyWithId:attrKey]) {
    protSet = [attrMap getWithId:attrKey];
  }
  else {
    protSet = new_JavaUtilHashSet_init();
    (void) [attrMap putWithId:attrKey withId:protSet];
  }
  {
  ...
  if ([((id<JavaUtilMap>) nil_chk(self->protocols_)) containsKeyWithId:tagName]) {
    ...
    if ([((id<JavaUtilMap>) nil_chk(attrMap)) containsKeyWithId:attrKey]) {
      ...
      if ([((id<JavaUtilSet>) nil_chk(protSet)) isEmpty]) {
        (void) [attrMap removeWithId:attrKey];
        if ([attrMap isEmpty]) (void) [((id<JavaUtilMap>) nil_chk(self->protocols_)) removeWithId:tagName];
      }
    }
  }
  return self;
...
- (OrgJsoupNodesAttributes *)getEnforcedAttributesWithNSString:(NSString *)tagName {
  OrgJsoupNodesAttributes *attrs = new_OrgJsoupNodesAttributes_init();
  OrgJsoupSafetyWhitelist_TagName *tag = OrgJsoupSafetyWhitelist_TagName_valueOfWithNSString_(tagName);
...
OrgJsoupSafetyWhitelist *OrgJsoupSafetyWhitelist_none() {
  ...
  return new_OrgJsoupSafetyWhitelist_init();
}

OrgJsoupSafetyWhitelist *OrgJsoupSafetyWhitelist_simpleText() {
  OrgJsoupSafetyWhitelist_initialize();
  return [new_OrgJsoupSafetyWhitelist_init() addTagsWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"b", @"em", @"i", @"strong", @"u" } count:5 type:NSString_class_()]];
}

OrgJsoupSafetyWhitelist *OrgJsoupSafetyWhitelist_basic() {
  OrgJsoupSafetyWhitelist_initialize();
  return [((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([new_OrgJsoupSafetyWhitelist_init() addTagsWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"a", @"b", @"blockquote", @"br", @"cite", @"code", @"dd", @"dl", @"dt", @"em", @"i", @"li", @"ol", @"p", @"pre", @"q", @"small", @"span", @"strike", @"strong", @"sub", @"sup", @"u", @"ul" } count:24 type:NSString_class_()]]))) addAttributesWithNSString:@"a" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"href" } count:1 type:NSString_class_()]]))) addAttributesWithNSString:@"blockquote" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"cite" } count:1 type:NSString_class_()]]))) addAttributesWithNSString:@"q" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"cite" } count:1 type:NSString_class_()]]))) addProtocolsWithNSString:@"a" withNSString:@"href" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"ftp", @"http", @"https", @"mailto" } count:4 type:NSString_class_()]]))) addProtocolsWithNSString:@"blockquote" withNSString:@"cite" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"http", @"https" } count:2 type:NSString_class_()]]))) addProtocolsWithNSString:@"cite" withNSString:@"cite" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"http", @"https" } count:2 type:NSString_class_()]]))) addEnforcedAttributeWithNSString:@"a" withNSString:@"rel" withNSString:@"nofollow"];
}

OrgJsoupSafetyWhitelist *OrgJsoupSafetyWhitelist_basicWithImages() {
  OrgJsoupSafetyWhitelist_initialize();
  return [((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(OrgJsoupSafetyWhitelist_basic())) addTagsWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"img" } count:1 type:NSString_class_()]]))) addAttributesWithNSString:@"img" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"align", @"alt", @"height", @"src", @"title", @"width" } count:6 type:NSString_class_()]]))) addProtocolsWithNSString:@"img" withNSString:@"src" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"http", @"https" } count:2 type:NSString_class_()]];
}

OrgJsoupSafetyWhitelist *OrgJsoupSafetyWhitelist_relaxed() {
  OrgJsoupSafetyWhitelist_initialize();
  return [((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([((OrgJsoupSafetyWhitelist *) nil_chk(([new_OrgJsoupSafetyWhitelist_init() addTagsWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"a", @"b", @"blockquote", @"br", @"caption", @"cite", @"code", @"col", @"colgroup", @"dd", @"div", @"dl", @"dt", @"em", @"h1", @"h2", @"h3", @"h4", @"h5", @"h6", @"i", @"img", @"li", @"ol", @"p", @"pre", @"q", @"small", @"span", @"strike", @"strong", @"sub", @"sup", @"table", @"tbody", @"td", @"tfoot", @"th", @"thead", @"tr", @"u", @"ul" } count:42 type:NSString_class_()]]))) addAttributesWithNSString:@"a" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"href", @"title" } count:2 type:NSString_class_()]]))) addAttributesWithNSString:@"blockquote" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"cite" } count:1 type:NSString_class_()]]))) addAttributesWithNSString:@"col" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"span", @"width" } count:2 type:NSString_class_()]]))) addAttributesWithNSString:@"colgroup" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"span", @"width" } count:2 type:NSString_class_()]]))) addAttributesWithNSString:@"img" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"align", @"alt", @"height", @"src", @"title", @"width" } count:6 type:NSString_class_()]]))) addAttributesWithNSString:@"ol" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"start", @"type" } count:2 type:NSString_class_()]]))) addAttributesWithNSString:@"q" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"cite" } count:1 type:NSString_class_()]]))) addAttributesWithNSString:@"table" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"summary", @"width" } count:2 type:NSString_class_()]]))) addAttributesWithNSString:@"td" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"abbr", @"axis", @"colspan", @"rowspan", @"width" } count:5 type:NSString_class_()]]))) addAttributesWithNSString:@"th" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"abbr", @"axis", @"colspan", @"rowspan", @"scope", @"width" } count:6 type:NSString_class_()]]))) addAttributesWithNSString:@"ul" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"type" } count:1 type:NSString_class_()]]))) addProtocolsWithNSString:@"a" withNSString:@"href" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"ftp", @"http", @"https", @"mailto" } count:4 type:NSString_class_()]]))) addProtocolsWithNSString:@"blockquote" withNSString:@"cite" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"http", @"https" } count:2 type:NSString_class_()]]))) addProtocolsWithNSString:@"cite" withNSString:@"cite" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"http", @"https" } count:2 type:NSString_class_()]]))) addProtocolsWithNSString:@"img" withNSString:@"src" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"http", @"https" } count:2 type:NSString_class_()]]))) addProtocolsWithNSString:@"q" withNSString:@"cite" withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"http", @"https" } count:2 type:NSString_class_()]];
}

void OrgJsoupSafetyWhitelist_init(OrgJsoupSafetyWhitelist *self) {
  NSObject_init(self);
  self->tagNames_ = new_JavaUtilHashSet_init();
  self->attributes_ = new_JavaUtilHashMap_init();
  self->enforcedAttributes_ = new_JavaUtilHashMap_init();
  self->protocols_ = new_JavaUtilHashMap_init();
...
jboolean OrgJsoupSafetyWhitelist_testValidProtocolWithOrgJsoupNodesElement_withOrgJsoupNodesAttribute_withJavaUtilSet_(OrgJsoupSafetyWhitelist *self, OrgJsoupNodesElement *el, OrgJsoupNodesAttribute *attr, id<JavaUtilSet> protocols) {
  ...
  if (!self->preserveRelativeLinks_) (void) [attr setValueWithId:value];
...
OrgJsoupSafetyWhitelist_TagName *OrgJsoupSafetyWhitelist_TagName_valueOfWithNSString_(NSString *value) {
  ...
  return new_OrgJsoupSafetyWhitelist_TagName_initWithNSString_(value);
}
...
OrgJsoupSafetyWhitelist_AttributeKey *OrgJsoupSafetyWhitelist_AttributeKey_valueOfWithNSString_(NSString *value) {
  ...
  return new_OrgJsoupSafetyWhitelist_AttributeKey_initWithNSString_(value);
}
...
OrgJsoupSafetyWhitelist_AttributeValue *OrgJsoupSafetyWhitelist_AttributeValue_valueOfWithNSString_(NSString *value) {
  ...
  return new_OrgJsoupSafetyWhitelist_AttributeValue_initWithNSString_(value);
}
...
OrgJsoupSafetyWhitelist_Protocol *OrgJsoupSafetyWhitelist_Protocol_valueOfWithNSString_(NSString *value) {
  ...
  return new_OrgJsoupSafetyWhitelist_Protocol_initWithNSString_(value);
}
