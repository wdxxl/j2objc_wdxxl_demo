...
inline id<JavaUtilMap> OrgApacheCommonsLang3ClassUtils_get_primitiveWrapperMap(void);
...
inline id<JavaUtilMap> OrgApacheCommonsLang3ClassUtils_get_wrapperPrimitiveMap(void);
...
inline id<JavaUtilMap> OrgApacheCommonsLang3ClassUtils_get_abbreviationMap(void);
...
inline id<JavaUtilMap> OrgApacheCommonsLang3ClassUtils_get_reverseAbbreviationMap(void);
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ClassUtils_Interfaces class]) {
    JreEnum(OrgApacheCommonsLang3ClassUtils_Interfaces, INCLUDE) = new_OrgApacheCommonsLang3ClassUtils_Interfaces_initWithNSString_withInt_(@"", 0);
    JreEnum(OrgApacheCommonsLang3ClassUtils_Interfaces, EXCLUDE) = new_OrgApacheCommonsLang3ClassUtils_Interfaces_initWithNSString_withInt_(@"", 1);
