...
FOUNDATION_EXPORT OrgApacheCommonsLang3TextWordUtils *new_OrgApacheCommonsLang3TextWordUtils_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3TextWordUtils *create_OrgApacheCommonsLang3TextWordUtils_init(void);
