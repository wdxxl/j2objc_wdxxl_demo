...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ArrayUtils class]) {
    OrgApacheCommonsLang3ArrayUtils_EMPTY_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_CLASS_ARRAY = [IOSObjectArray newArrayWithLength:0 type:IOSClass_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_STRING_ARRAY = [IOSObjectArray newArrayWithLength:0 type:NSString_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_LONG_ARRAY = [IOSLongArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_LONG_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangLong_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_INT_ARRAY = [IOSIntArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_INTEGER_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangInteger_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_SHORT_ARRAY = [IOSShortArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_SHORT_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangShort_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_BYTE_ARRAY = [IOSByteArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_BYTE_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangByte_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_DOUBLE_ARRAY = [IOSDoubleArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_DOUBLE_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangDouble_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_FLOAT_ARRAY = [IOSFloatArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_FLOAT_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangFloat_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_BOOLEAN_ARRAY = [IOSBooleanArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_BOOLEAN_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangBoolean_class_()];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_CHAR_ARRAY = [IOSCharArray newArrayWithLength:0];
    OrgApacheCommonsLang3ArrayUtils_EMPTY_CHARACTER_OBJECT_ARRAY = [IOSObjectArray newArrayWithLength:0 type:JavaLangCharacter_class_()];
...
NSString *OrgApacheCommonsLang3ArrayUtils_toStringWithId_withNSString_(id array, NSString *stringIfNull) {
  ...
  return [((OrgApacheCommonsLang3BuilderToStringBuilder *) nil_chk([new_OrgApacheCommonsLang3BuilderToStringBuilder_initWithId_withOrgApacheCommonsLang3BuilderToStringStyle_(array, JreLoadStatic(OrgApacheCommonsLang3BuilderToStringStyle, SIMPLE_STYLE)) appendWithId:array])) description];
}

jint OrgApacheCommonsLang3ArrayUtils_hashCodeWithId_(id array) {
  OrgApacheCommonsLang3ArrayUtils_initialize();
  return [((OrgApacheCommonsLang3BuilderHashCodeBuilder *) nil_chk([new_OrgApacheCommonsLang3BuilderHashCodeBuilder_init() appendWithId:array])) toHashCode];
}

jboolean OrgApacheCommonsLang3ArrayUtils_isEqualsWithId_withId_(id array1, id array2) {
  OrgApacheCommonsLang3ArrayUtils_initialize();
  return [((OrgApacheCommonsLang3BuilderEqualsBuilder *) nil_chk([new_OrgApacheCommonsLang3BuilderEqualsBuilder_init() appendWithId:array1 withId:array2])) isEquals];
}
...
id<JavaUtilMap> OrgApacheCommonsLang3ArrayUtils_toMapWithNSObjectArray_(IOSObjectArray *array) {
  ...
  id<JavaUtilMap> map = new_JavaUtilHashMap_initWithInt_(JreFpToInt((array->size_ * 1.5)));
  for (jint i = 0; i < array->size_; i++) {
    ...
    if ([JavaUtilMap_Entry_class_() isInstance:object]) {
      ...
      (void) [map putWithId:[((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey] withId:[entry_ getValue]];
    }
      ...
      if (((IOSObjectArray *) nil_chk(entry_))->size_ < 2) {
        @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$@$", @"Array element ", i, @", '", object, @"', has a length less than 2"));
      }
      (void) [map putWithId:IOSObjectArray_Get(entry_, 0) withId:IOSObjectArray_Get(entry_, 1)];
    }
    else {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$@$", @"Array element ", i, @", '", object, @"', is neither of type Map.Entry nor an Array"));
    }
  }
  return map;
}
...
IOSLongArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithLongArray_withInt_withInt_(IOSLongArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSLongArray *subarray = [IOSLongArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSIntArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithIntArray_withInt_withInt_(IOSIntArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSIntArray *subarray = [IOSIntArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSShortArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithShortArray_withInt_withInt_(IOSShortArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSShortArray *subarray = [IOSShortArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSCharArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithCharArray_withInt_withInt_(IOSCharArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSCharArray *subarray = [IOSCharArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSByteArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithByteArray_withInt_withInt_(IOSByteArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSByteArray *subarray = [IOSByteArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSDoubleArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithDoubleArray_withInt_withInt_(IOSDoubleArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSDoubleArray *subarray = [IOSDoubleArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSFloatArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithFloatArray_withInt_withInt_(IOSFloatArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSFloatArray *subarray = [IOSFloatArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSBooleanArray *OrgApacheCommonsLang3ArrayUtils_subarrayWithBooleanArray_withInt_withInt_(IOSBooleanArray *array, jint startIndexInclusive, jint endIndexExclusive) {
  ...
  IOSBooleanArray *subarray = [IOSBooleanArray newArrayWithLength:newSize];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array, startIndexInclusive, subarray, 0, newSize);
  return subarray;
}
...
IOSCharArray *OrgApacheCommonsLang3ArrayUtils_toPrimitiveWithJavaLangCharacterArray_(IOSObjectArray *array) {
  ...
  IOSCharArray *result = [IOSCharArray newArrayWithLength:array->size_];
  for (jint i = 0; i < array->size_; i++) {
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithCharArray_(IOSCharArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangCharacter_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, JavaLangCharacter_valueOfWithChar_(IOSCharArray_Get(array, i)));
  }
  return result;
}
...
IOSLongArray *OrgApacheCommonsLang3ArrayUtils_toPrimitiveWithJavaLangLongArray_(IOSObjectArray *array) {
  ...
  IOSLongArray *result = [IOSLongArray newArrayWithLength:array->size_];
  for (jint i = 0; i < array->size_; i++) {
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithLongArray_(IOSLongArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangLong_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, JavaLangLong_valueOfWithLong_(IOSLongArray_Get(array, i)));
  }
  return result;
}
...
IOSIntArray *OrgApacheCommonsLang3ArrayUtils_toPrimitiveWithJavaLangIntegerArray_(IOSObjectArray *array) {
  ...
  IOSIntArray *result = [IOSIntArray newArrayWithLength:array->size_];
  for (jint i = 0; i < array->size_; i++) {
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithIntArray_(IOSIntArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangInteger_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, JavaLangInteger_valueOfWithInt_(IOSIntArray_Get(array, i)));
  }
  return result;
}
...
IOSShortArray *OrgApacheCommonsLang3ArrayUtils_toPrimitiveWithJavaLangShortArray_(IOSObjectArray *array) {
  ...
  IOSShortArray *result = [IOSShortArray newArrayWithLength:array->size_];
  for (jint i = 0; i < array->size_; i++) {
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithShortArray_(IOSShortArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangShort_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, JavaLangShort_valueOfWithShort_(IOSShortArray_Get(array, i)));
  }
  return result;
}
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithByteArray_(IOSByteArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangByte_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, JavaLangByte_valueOfWithByte_(IOSByteArray_Get(array, i)));
  }
  return result;
}
...
IOSDoubleArray *OrgApacheCommonsLang3ArrayUtils_toPrimitiveWithJavaLangDoubleArray_(IOSObjectArray *array) {
  ...
  IOSDoubleArray *result = [IOSDoubleArray newArrayWithLength:array->size_];
  for (jint i = 0; i < array->size_; i++) {
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithDoubleArray_(IOSDoubleArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangDouble_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, JavaLangDouble_valueOfWithDouble_(IOSDoubleArray_Get(array, i)));
  }
  return result;
}
...
IOSFloatArray *OrgApacheCommonsLang3ArrayUtils_toPrimitiveWithJavaLangFloatArray_(IOSObjectArray *array) {
  ...
  IOSFloatArray *result = [IOSFloatArray newArrayWithLength:array->size_];
  for (jint i = 0; i < array->size_; i++) {
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithFloatArray_(IOSFloatArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangFloat_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, JavaLangFloat_valueOfWithFloat_(IOSFloatArray_Get(array, i)));
  }
  return result;
}
...
IOSBooleanArray *OrgApacheCommonsLang3ArrayUtils_toPrimitiveWithJavaLangBooleanArray_(IOSObjectArray *array) {
  ...
  IOSBooleanArray *result = [IOSBooleanArray newArrayWithLength:array->size_];
  for (jint i = 0; i < array->size_; i++) {
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_toObjectWithBooleanArray_(IOSBooleanArray *array) {
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:array->size_ type:JavaLangBoolean_class_()];
  for (jint i = 0; i < array->size_; i++) {
    (void) IOSObjectArray_Set(result, i, (IOSBooleanArray_Get(array, i) ? JreLoadStatic(JavaLangBoolean, TRUE) : JreLoadStatic(JavaLangBoolean, FALSE)));
  }
  return result;
}
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_addAllWithNSObjectArray_withNSObjectArray_(IOSObjectArray *array1, IOSObjectArray *array2) {
  ...
  @catch (JavaLangArrayStoreException *ase) {
    ...
    if (![((IOSClass *) nil_chk(type1)) isAssignableFrom:type2]) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$$$", @"Cannot store ", [((IOSClass *) nil_chk(type2)) getName], @" in an array of ", [type1 getName]), ase);
    }
    @throw ase;
  }
  return joinedArray;
...
IOSBooleanArray *OrgApacheCommonsLang3ArrayUtils_addAllWithBooleanArray_withBooleanArray_(IOSBooleanArray *array1, IOSBooleanArray *array2) {
  ...
  IOSBooleanArray *joinedArray = [IOSBooleanArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSCharArray *OrgApacheCommonsLang3ArrayUtils_addAllWithCharArray_withCharArray_(IOSCharArray *array1, IOSCharArray *array2) {
  ...
  IOSCharArray *joinedArray = [IOSCharArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSByteArray *OrgApacheCommonsLang3ArrayUtils_addAllWithByteArray_withByteArray_(IOSByteArray *array1, IOSByteArray *array2) {
  ...
  IOSByteArray *joinedArray = [IOSByteArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSShortArray *OrgApacheCommonsLang3ArrayUtils_addAllWithShortArray_withShortArray_(IOSShortArray *array1, IOSShortArray *array2) {
  ...
  IOSShortArray *joinedArray = [IOSShortArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSIntArray *OrgApacheCommonsLang3ArrayUtils_addAllWithIntArray_withIntArray_(IOSIntArray *array1, IOSIntArray *array2) {
  ...
  IOSIntArray *joinedArray = [IOSIntArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSLongArray *OrgApacheCommonsLang3ArrayUtils_addAllWithLongArray_withLongArray_(IOSLongArray *array1, IOSLongArray *array2) {
  ...
  IOSLongArray *joinedArray = [IOSLongArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSFloatArray *OrgApacheCommonsLang3ArrayUtils_addAllWithFloatArray_withFloatArray_(IOSFloatArray *array1, IOSFloatArray *array2) {
  ...
  IOSFloatArray *joinedArray = [IOSFloatArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSDoubleArray *OrgApacheCommonsLang3ArrayUtils_addAllWithDoubleArray_withDoubleArray_(IOSDoubleArray *array1, IOSDoubleArray *array2) {
  ...
  IOSDoubleArray *joinedArray = [IOSDoubleArray newArrayWithLength:array1->size_ + array2->size_];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array1, 0, joinedArray, 0, array1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(array2, 0, joinedArray, array1->size_, array2->size_);
  return joinedArray;
}
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_addWithNSObjectArray_withId_(IOSObjectArray *array, id element) {
  ...
  if (array != nil) {
    ...
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Arguments cannot both be null");
  }
  ...
  (void) IOSObjectArray_Set(newArray, ((IOSObjectArray *) nil_chk(newArray))->size_ - 1, element);
  return newArray;
}
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_addWithNSObjectArray_withInt_withId_(IOSObjectArray *array, jint index, id element) {
  ...
  if (array != nil) {
    ...
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Array and element cannot both be null");
  }
...
id OrgApacheCommonsLang3ArrayUtils_addWithId_withInt_withId_withIOSClass_(id array, jint index, id element, IOSClass *clss) {
  ...
  if (array == nil) {
    if (index != 0) {
      @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I$", @"Index: ", index, @", Length: 0"));
    }
  ...
  if (index > length || index < 0) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I$I", @"Index: ", index, @", Length: ", length));
  }
...
IOSObjectArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithNSObjectArray_withNSObjectArray_(IOSObjectArray *array, IOSObjectArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSObjectArray *) nil_chk(values))->size_);
  {
    ...
    while (b__ < e__) {
      ...
      if (count == nil) {
        (void) [occurrences putWithId:v withId:new_OrgApacheCommonsLang3MutableMutableInt_initWithInt_(1)];
      }
      else {
        [count increment];
      }
  ...
  JavaUtilBitSet *toRemove = new_JavaUtilBitSet_init();
...
IOSByteArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithByteArray_withByteArray_(IOSByteArray *array, IOSByteArray *values) {
  ...
  id<JavaUtilMap> occurrences = new_JavaUtilHashMap_initWithInt_(((IOSByteArray *) nil_chk(values))->size_);
  {
    ...
    while (b__ < e__) {
      ...
      if (count == nil) {
        (void) [occurrences putWithId:boxed withId:new_OrgApacheCommonsLang3MutableMutableInt_initWithInt_(1)];
      }
      else {
        [count increment];
      }
...
IOSShortArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithShortArray_withShortArray_(IOSShortArray *array, IOSShortArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSShortArray *) nil_chk(values))->size_);
  {
...
IOSIntArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithIntArray_withIntArray_(IOSIntArray *array, IOSIntArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSIntArray *) nil_chk(values))->size_);
  {
...
IOSCharArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithCharArray_withCharArray_(IOSCharArray *array, IOSCharArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSCharArray *) nil_chk(values))->size_);
  {
...
IOSLongArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithLongArray_withLongArray_(IOSLongArray *array, IOSLongArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSLongArray *) nil_chk(values))->size_);
  {
...
IOSFloatArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithFloatArray_withFloatArray_(IOSFloatArray *array, IOSFloatArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSFloatArray *) nil_chk(values))->size_);
  {
...
IOSDoubleArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithDoubleArray_withDoubleArray_(IOSDoubleArray *array, IOSDoubleArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSDoubleArray *) nil_chk(values))->size_);
  {
...
IOSBooleanArray *OrgApacheCommonsLang3ArrayUtils_removeElementsWithBooleanArray_withBooleanArray_(IOSBooleanArray *array, IOSBooleanArray *values) {
  ...
  JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(2);
  {
...
jboolean OrgApacheCommonsLang3ArrayUtils_isSortedWithJavaLangComparableArray_(IOSObjectArray *array) {
  OrgApacheCommonsLang3ArrayUtils_initialize();
  return OrgApacheCommonsLang3ArrayUtils_isSortedWithNSObjectArray_withJavaUtilComparator_(array, new_OrgApacheCommonsLang3ArrayUtils_1_init());
}
...
jboolean OrgApacheCommonsLang3ArrayUtils_isSortedWithNSObjectArray_withJavaUtilComparator_(IOSObjectArray *array, id<JavaUtilComparator> comparator) {
  OrgApacheCommonsLang3ArrayUtils_initialize();
  if (comparator == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Comparator should not be null.");
  }
