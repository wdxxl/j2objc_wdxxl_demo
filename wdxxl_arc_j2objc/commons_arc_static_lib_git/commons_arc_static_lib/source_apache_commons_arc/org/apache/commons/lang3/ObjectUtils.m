  ...
  if ([NSCopying_class_() isInstance:obj]) {
    ...
    if ([[nil_chk(obj) java_getClass] isArray]) {
      ...
      @catch (JavaLangNoSuchMethodException *e) {
        @throw new_OrgApacheCommonsLang3ExceptionCloneFailedException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$$", @"Cloneable type ", [[obj java_getClass] getName], @" has no clone method"), e);
      }
      @catch (JavaLangIllegalAccessException *e) {
        @throw new_OrgApacheCommonsLang3ExceptionCloneFailedException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"Cannot clone Cloneable type ", [[obj java_getClass] getName]), e);
      }
      @catch (JavaLangReflectInvocationTargetException *e) {
        @throw new_OrgApacheCommonsLang3ExceptionCloneFailedException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"Exception cloning Cloneable type ", [[obj java_getClass] getName]), [e getCause]);
      }
    }
    id checked = result;
    return checked;
