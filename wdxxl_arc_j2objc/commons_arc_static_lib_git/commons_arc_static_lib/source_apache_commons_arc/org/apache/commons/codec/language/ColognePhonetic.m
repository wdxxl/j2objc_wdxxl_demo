...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecLanguageColognePhonetic class]) {
    OrgApacheCommonsCodecLanguageColognePhonetic_AEIJOUY = [IOSCharArray newArrayWithChars:(jchar[]){ 'A', 'E', 'I', 'J', 'O', 'U', 'Y' } count:7];
    OrgApacheCommonsCodecLanguageColognePhonetic_SCZ = [IOSCharArray newArrayWithChars:(jchar[]){ 'S', 'C', 'Z' } count:3];
    OrgApacheCommonsCodecLanguageColognePhonetic_WFPV = [IOSCharArray newArrayWithChars:(jchar[]){ 'W', 'F', 'P', 'V' } count:4];
    OrgApacheCommonsCodecLanguageColognePhonetic_GKQ = [IOSCharArray newArrayWithChars:(jchar[]){ 'G', 'K', 'Q' } count:3];
    OrgApacheCommonsCodecLanguageColognePhonetic_CKQ = [IOSCharArray newArrayWithChars:(jchar[]){ 'C', 'K', 'Q' } count:3];
    OrgApacheCommonsCodecLanguageColognePhonetic_AHKLOQRUX = [IOSCharArray newArrayWithChars:(jchar[]){ 'A', 'H', 'K', 'L', 'O', 'Q', 'R', 'U', 'X' } count:9];
    OrgApacheCommonsCodecLanguageColognePhonetic_SZ = [IOSCharArray newArrayWithChars:(jchar[]){ 'S', 'Z' } count:2];
    OrgApacheCommonsCodecLanguageColognePhonetic_AHOUKQX = [IOSCharArray newArrayWithChars:(jchar[]){ 'A', 'H', 'O', 'U', 'K', 'Q', 'X' } count:7];
    OrgApacheCommonsCodecLanguageColognePhonetic_TDX = [IOSCharArray newArrayWithChars:(jchar[]){ 'T', 'D', 'X' } count:3];
