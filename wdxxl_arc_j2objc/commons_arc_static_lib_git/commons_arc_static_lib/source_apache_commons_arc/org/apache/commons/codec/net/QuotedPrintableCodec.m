...
- (id)encodeWithId:(id)obj {
  if (obj == nil) {
    ...
    @throw new_OrgApacheCommonsCodecEncoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[obj java_getClass] getName], @" cannot be quoted-printable encoded"));
  }
}
...
- (id)decodeWithId:(id)obj {
  if (obj == nil) {
    ...
    @throw new_OrgApacheCommonsCodecDecoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[obj java_getClass] getName], @" cannot be quoted-printable decoded"));
  }
}
