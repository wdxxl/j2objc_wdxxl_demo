...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/IndexReader.java
//
...
inline jint OrgApacheLuceneIndexIndexReader_get_DEFAULT_TERMS_INDEX_DIVISOR(void);
inline jint OrgApacheLuceneIndexIndexReader_set_DEFAULT_TERMS_INDEX_DIVISOR(jint value);
inline jint *OrgApacheLuceneIndexIndexReader_getRef_DEFAULT_TERMS_INDEX_DIVISOR(void);
...
@interface OrgApacheLuceneIndexIndexReader_FieldOption : JavaLangEnum
...
inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_ALL(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, ALL)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_INDEXED(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, INDEXED)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_STORES_PAYLOADS(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, STORES_PAYLOADS)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_OMIT_TERM_FREQ_AND_POSITIONS(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, OMIT_TERM_FREQ_AND_POSITIONS)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_OMIT_POSITIONS(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, OMIT_POSITIONS)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_UNINDEXED(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, UNINDEXED)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_INDEXED_WITH_TERMVECTOR(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, INDEXED_WITH_TERMVECTOR)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_INDEXED_NO_TERMVECTOR(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, INDEXED_NO_TERMVECTOR)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_TERMVECTOR(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, TERMVECTOR)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_TERMVECTOR_WITH_POSITION(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, TERMVECTOR_WITH_POSITION)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_TERMVECTOR_WITH_OFFSET(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, TERMVECTOR_WITH_OFFSET)

inline OrgApacheLuceneIndexIndexReader_FieldOption *OrgApacheLuceneIndexIndexReader_FieldOption_get_TERMVECTOR_WITH_POSITION_OFFSET(void);
J2OBJC_ENUM_CONSTANT(OrgApacheLuceneIndexIndexReader_FieldOption, TERMVECTOR_WITH_POSITION_OFFSET)

FOUNDATION_EXPORT IOSObjectArray *OrgApacheLuceneIndexIndexReader_FieldOption_values(void);
