...
FOUNDATION_EXPORT OrgApacheLuceneIndexSegmentReader *new_OrgApacheLuceneIndexSegmentReader_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneIndexSegmentReader *create_OrgApacheLuceneIndexSegmentReader_init(void);
