...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/SpanQueryFilter.java
//
...
FOUNDATION_EXPORT OrgApacheLuceneSearchSpanQueryFilter *new_OrgApacheLuceneSearchSpanQueryFilter_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneSearchSpanQueryFilter *create_OrgApacheLuceneSearchSpanQueryFilter_init(void);
