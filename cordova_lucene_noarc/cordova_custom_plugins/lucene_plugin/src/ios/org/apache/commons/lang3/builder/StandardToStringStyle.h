...
FOUNDATION_EXPORT OrgApacheCommonsLang3BuilderStandardToStringStyle *new_OrgApacheCommonsLang3BuilderStandardToStringStyle_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3BuilderStandardToStringStyle *create_OrgApacheCommonsLang3BuilderStandardToStringStyle_init(void);
