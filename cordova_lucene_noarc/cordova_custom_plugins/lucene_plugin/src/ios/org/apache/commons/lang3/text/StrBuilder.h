...
inline jint OrgApacheCommonsLang3TextStrBuilder_get_CAPACITY(void);
...
FOUNDATION_EXPORT OrgApacheCommonsLang3TextStrBuilder *new_OrgApacheCommonsLang3TextStrBuilder_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3TextStrBuilder *create_OrgApacheCommonsLang3TextStrBuilder_init(void);
...
- (instancetype)initWithCharArray:(IOSCharArray *)arg0
                         withChar:(jchar)arg1 NS_UNAVAILABLE;

- (instancetype)initWithCharArray:(IOSCharArray *)arg0
                         withChar:(jchar)arg1
                         withChar:(jchar)arg2 NS_UNAVAILABLE;

- (instancetype)initWithCharArray:(IOSCharArray *)arg0
                     withNSString:(NSString *)arg1 NS_UNAVAILABLE;

- (instancetype)initWithCharArray:(IOSCharArray *)arg0
withOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)arg1 NS_UNAVAILABLE;

- (instancetype)initWithCharArray:(IOSCharArray *)arg0
withOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)arg1
withOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)arg2 NS_UNAVAILABLE;
