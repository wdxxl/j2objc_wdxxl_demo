...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { NULL, "LOrgApacheLuceneAnalysisCharStreamAnalysis;", 0x9, 0, 1, -1, -1, -1, -1 },
...
OrgApacheLuceneAnalysisCharStreamAnalysis *OrgApacheLuceneAnalysisCharReader_getWithJavaIoReader_(JavaIoReader *input) {
  OrgApacheLuceneAnalysisCharReader_initialize();
  return [input isKindOfClass:[OrgApacheLuceneAnalysisCharStreamAnalysis class]] ? (OrgApacheLuceneAnalysisCharStreamAnalysis *) cast_chk(input, [OrgApacheLuceneAnalysisCharStreamAnalysis class]) : new_OrgApacheLuceneAnalysisCharReader_initWithJavaIoReader_(input);
}
