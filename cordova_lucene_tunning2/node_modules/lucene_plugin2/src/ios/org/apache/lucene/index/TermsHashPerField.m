...
//  source: jar:file:lucene-core-grouping-3.5.0-sources.jar!org/apache/lucene/index/TermsHashPerField.java
//
...
- (void)initReaderWithOrgApacheLuceneIndexByteSliceReader:(OrgApacheLuceneIndexByteSliceReader *)reader
  ...
  [((OrgApacheLuceneIndexByteSliceReader *) nil_chk(reader)) init__WithOrgApacheLuceneIndexByteBlockPoolIndex:bytePool_ withInt:IOSIntArray_Get(nil_chk(postingsArray_->byteStarts_), termID) + stream * JreLoadStatic(OrgApacheLuceneIndexByteBlockPoolIndex, FIRST_LEVEL_SIZE) withInt:IOSIntArray_Get(nil_chk(ints), upto + stream)];
}
...
- (void)addWithInt:(jint)textStart {
  ...
  if (termID == -1) {
    ...
    *IOSIntArray_GetRef(postingsHash_, hashPos) = termID;
    ...
    if (OrgApacheLuceneIndexDocumentsWriter_BYTE_BLOCK_SIZE - ((OrgApacheLuceneIndexByteBlockPoolIndex *) nil_chk(bytePool_))->byteUpto_ < numPostingInt_ * JreLoadStatic(OrgApacheLuceneIndexByteBlockPoolIndex, FIRST_LEVEL_SIZE)) [bytePool_ nextBuffer];
    ...
    *IOSIntArray_GetRef(nil_chk(((OrgApacheLuceneIndexParallelPostingsArray *) nil_chk(postingsArray_))->intStarts_), termID) = intUptoStart_ + intPool_->intOffset_;
    for (jint i = 0; i < streamCount_; i++) {
      jint upto = [bytePool_ newSliceWithInt:JreLoadStatic(OrgApacheLuceneIndexByteBlockPoolIndex, FIRST_LEVEL_SIZE)];
...
- (void)writeByteWithInt:(jint)stream
  ...
  IOSByteArray *bytes = IOSObjectArray_Get(nil_chk(((OrgApacheLuceneIndexByteBlockPoolIndex *) nil_chk(bytePool_))->buffers_), JreRShift32(upto, OrgApacheLuceneIndexDocumentsWriter_BYTE_BLOCK_SHIFT));
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "bytePool_", "LOrgApacheLuceneIndexByteBlockPoolIndex;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
