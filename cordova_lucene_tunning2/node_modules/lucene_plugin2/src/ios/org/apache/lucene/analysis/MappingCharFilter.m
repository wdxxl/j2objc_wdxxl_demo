...
//  source: jar:file:lucene-core-grouping-3.5.0-sources.jar!org/apache/lucene/analysis/MappingCharFilter.java
//
...
- (instancetype)initWithOrgApacheLuceneAnalysisNormalizeCharMap:(OrgApacheLuceneAnalysisNormalizeCharMap *)normMap
                  withOrgApacheLuceneAnalysisCharStreamAnalysis:(OrgApacheLuceneAnalysisCharStreamAnalysis *)inArg {
  OrgApacheLuceneAnalysisMappingCharFilter_initWithOrgApacheLuceneAnalysisNormalizeCharMap_withOrgApacheLuceneAnalysisCharStreamAnalysis_(self, normMap, inArg);
  return self;
}
...
- (jint)readWithCharArray:(IOSCharArray *)cbuf
  ...
  jint l = [((OrgApacheLuceneAnalysisCharStreamAnalysis *) nil_chk(input_)) readWithCharArray:tmp withInt:0 withInt:len];
  if (l != -1) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgApacheLuceneAnalysisNormalizeCharMap:withOrgApacheLuceneAnalysisCharStreamAnalysis:);
  ...
  static const void *ptrTable[] = { "LOrgApacheLuceneAnalysisNormalizeCharMap;LOrgApacheLuceneAnalysisCharStreamAnalysis;", "LOrgApacheLuceneAnalysisNormalizeCharMap;LJavaIoReader;", "LJavaIoIOException;", "pushChar", "I", "pushLastChar", "match", "LOrgApacheLuceneAnalysisNormalizeCharMap;", "read", "[CII", "Ljava/util/LinkedList<Ljava/lang/Character;>;" };
...
void OrgApacheLuceneAnalysisMappingCharFilter_initWithOrgApacheLuceneAnalysisNormalizeCharMap_withOrgApacheLuceneAnalysisCharStreamAnalysis_(OrgApacheLuceneAnalysisMappingCharFilter *self, OrgApacheLuceneAnalysisNormalizeCharMap *normMap, OrgApacheLuceneAnalysisCharStreamAnalysis *inArg) {
  OrgApacheLuceneAnalysisBaseCharFilter_initWithOrgApacheLuceneAnalysisCharStreamAnalysis_(self, inArg);
  self->normMap_ = normMap;
}

OrgApacheLuceneAnalysisMappingCharFilter *new_OrgApacheLuceneAnalysisMappingCharFilter_initWithOrgApacheLuceneAnalysisNormalizeCharMap_withOrgApacheLuceneAnalysisCharStreamAnalysis_(OrgApacheLuceneAnalysisNormalizeCharMap *normMap, OrgApacheLuceneAnalysisCharStreamAnalysis *inArg) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneAnalysisMappingCharFilter, initWithOrgApacheLuceneAnalysisNormalizeCharMap_withOrgApacheLuceneAnalysisCharStreamAnalysis_, normMap, inArg)
}

OrgApacheLuceneAnalysisMappingCharFilter *create_OrgApacheLuceneAnalysisMappingCharFilter_initWithOrgApacheLuceneAnalysisNormalizeCharMap_withOrgApacheLuceneAnalysisCharStreamAnalysis_(OrgApacheLuceneAnalysisNormalizeCharMap *normMap, OrgApacheLuceneAnalysisCharStreamAnalysis *inArg) {
  J2OBJC_CREATE_IMPL(OrgApacheLuceneAnalysisMappingCharFilter, initWithOrgApacheLuceneAnalysisNormalizeCharMap_withOrgApacheLuceneAnalysisCharStreamAnalysis_, normMap, inArg)
}
...
void OrgApacheLuceneAnalysisMappingCharFilter_initWithOrgApacheLuceneAnalysisNormalizeCharMap_withJavaIoReader_(OrgApacheLuceneAnalysisMappingCharFilter *self, OrgApacheLuceneAnalysisNormalizeCharMap *normMap, JavaIoReader *inArg) {
  OrgApacheLuceneAnalysisBaseCharFilter_initWithOrgApacheLuceneAnalysisCharStreamAnalysis_(self, OrgApacheLuceneAnalysisCharReader_getWithJavaIoReader_(inArg));
  self->normMap_ = normMap;
}
...
jint OrgApacheLuceneAnalysisMappingCharFilter_nextChar(OrgApacheLuceneAnalysisMappingCharFilter *self) {
  ...
  return [((OrgApacheLuceneAnalysisCharStreamAnalysis *) nil_chk(self->input_)) read];
}
