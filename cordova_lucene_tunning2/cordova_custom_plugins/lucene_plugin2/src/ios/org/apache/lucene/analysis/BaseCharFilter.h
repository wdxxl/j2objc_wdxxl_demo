...
FOUNDATION_EXPORT void OrgApacheLuceneAnalysisBaseCharFilter_initWithOrgApacheLuceneAnalysisCharStreamAnalysis_(OrgApacheLuceneAnalysisBaseCharFilter *self, OrgApacheLuceneAnalysisCharStreamAnalysis *inArg);
