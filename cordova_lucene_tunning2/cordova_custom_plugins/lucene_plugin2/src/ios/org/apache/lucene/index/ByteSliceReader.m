...
//  source: jar:file:lucene-core-grouping-3.5.0-sources.jar!org/apache/lucene/index/ByteSliceReader.java
//
...
- (void)init__WithOrgApacheLuceneIndexByteBlockPoolIndex:(OrgApacheLuceneIndexByteBlockPoolIndex *)pool
  ...
  buffer_ = IOSObjectArray_Get(nil_chk(((OrgApacheLuceneIndexByteBlockPoolIndex *) nil_chk(pool))->buffers_), bufferUpto_);
  upto_ = startIndex & OrgApacheLuceneIndexDocumentsWriter_BYTE_BLOCK_MASK;
  jint firstSize = IOSIntArray_Get(nil_chk(JreLoadStatic(OrgApacheLuceneIndexByteBlockPoolIndex, levelSizeArray)), 0);
...
- (void)nextSlice {
  ...
  level_ = IOSIntArray_Get(nil_chk(JreLoadStatic(OrgApacheLuceneIndexByteBlockPoolIndex, nextLevelArray)), level_);
  jint newSize = IOSIntArray_Get(nil_chk(JreLoadStatic(OrgApacheLuceneIndexByteBlockPoolIndex, levelSizeArray)), level_);
  bufferUpto_ = nextIndex / OrgApacheLuceneIndexDocumentsWriter_BYTE_BLOCK_SIZE;
  bufferOffset_ = bufferUpto_ * OrgApacheLuceneIndexDocumentsWriter_BYTE_BLOCK_SIZE;
  buffer_ = IOSObjectArray_Get(nil_chk(((OrgApacheLuceneIndexByteBlockPoolIndex *) nil_chk(pool_))->buffers_), bufferUpto_);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(init__WithOrgApacheLuceneIndexByteBlockPoolIndex:withInt:withInt:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "pool_", "LOrgApacheLuceneIndexByteBlockPoolIndex;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "init", "LOrgApacheLuceneIndexByteBlockPoolIndex;II", "writeTo", "LOrgApacheLuceneStoreIndexOutput;", "LJavaIoIOException;", "readBytes", "[BII", "seek", "J" };
