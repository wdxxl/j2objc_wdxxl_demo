...
//  source: jar:file:lucene-core-grouping-3.5.0-sources.jar!org/apache/lucene/analysis/Tokenizer.java
//
...
- (jint)correctOffsetWithInt:(jint)currentOff {
  return ([input_ isKindOfClass:[OrgApacheLuceneAnalysisCharStreamAnalysis class]]) ? [((OrgApacheLuceneAnalysisCharStreamAnalysis *) nil_chk(((OrgApacheLuceneAnalysisCharStreamAnalysis *) cast_chk(input_, [OrgApacheLuceneAnalysisCharStreamAnalysis class])))) correctOffsetWithInt:currentOff] : currentOff;
}
