...
@interface OrgApacheLuceneIndexTermsHashPerThread : OrgApacheLuceneIndexInvertedDocConsumerPerThread {
 @public
  ...
  OrgApacheLuceneIndexByteBlockPoolIndex *bytePool_;
  jboolean primary_;
...
J2OBJC_FIELD_SETTER(OrgApacheLuceneIndexTermsHashPerThread, bytePool_, OrgApacheLuceneIndexByteBlockPoolIndex *)
