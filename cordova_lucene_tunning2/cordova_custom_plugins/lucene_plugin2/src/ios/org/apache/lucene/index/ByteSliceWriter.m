...
//  source: jar:file:lucene-core-grouping-3.5.0-sources.jar!org/apache/lucene/index/ByteSliceWriter.java
//
...
@interface OrgApacheLuceneIndexByteSliceWriter () {
 @public
  IOSByteArray *slice_;
  jint upto_;
  OrgApacheLuceneIndexByteBlockPoolIndex *pool_;
}

@end

J2OBJC_FIELD_SETTER(OrgApacheLuceneIndexByteSliceWriter, slice_, IOSByteArray *)
J2OBJC_FIELD_SETTER(OrgApacheLuceneIndexByteSliceWriter, pool_, OrgApacheLuceneIndexByteBlockPoolIndex *)

@implementation OrgApacheLuceneIndexByteSliceWriter

- (instancetype)initWithOrgApacheLuceneIndexByteBlockPoolIndex:(OrgApacheLuceneIndexByteBlockPoolIndex *)pool {
  OrgApacheLuceneIndexByteSliceWriter_initWithOrgApacheLuceneIndexByteBlockPoolIndex_(self, pool);
  return self;
}

- (void)init__WithInt:(jint)address {
  slice_ = IOSObjectArray_Get(nil_chk(((OrgApacheLuceneIndexByteBlockPoolIndex *) nil_chk(pool_))->buffers_), JreRShift32(address, OrgApacheLuceneIndexDocumentsWriter_BYTE_BLOCK_SHIFT));
...
- (void)writeByteWithByte:(jbyte)b {
  ...
  if (IOSByteArray_Get(nil_chk(slice_), upto_) != 0) {
    upto_ = [((OrgApacheLuceneIndexByteBlockPoolIndex *) nil_chk(pool_)) allocSliceWithByteArray:slice_ withInt:upto_];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgApacheLuceneIndexByteBlockPoolIndex:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "pool_", "LOrgApacheLuceneIndexByteBlockPoolIndex;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
    { "offset0_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LOrgApacheLuceneIndexByteBlockPoolIndex;", "init", "I", "writeByte", "B", "writeBytes", "[BII", "writeVInt" };
...
void OrgApacheLuceneIndexByteSliceWriter_initWithOrgApacheLuceneIndexByteBlockPoolIndex_(OrgApacheLuceneIndexByteSliceWriter *self, OrgApacheLuceneIndexByteBlockPoolIndex *pool) {
  NSObject_init(self);
  self->pool_ = pool;
}

OrgApacheLuceneIndexByteSliceWriter *new_OrgApacheLuceneIndexByteSliceWriter_initWithOrgApacheLuceneIndexByteBlockPoolIndex_(OrgApacheLuceneIndexByteBlockPoolIndex *pool) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneIndexByteSliceWriter, initWithOrgApacheLuceneIndexByteBlockPoolIndex_, pool)
}

OrgApacheLuceneIndexByteSliceWriter *create_OrgApacheLuceneIndexByteSliceWriter_initWithOrgApacheLuceneIndexByteBlockPoolIndex_(OrgApacheLuceneIndexByteBlockPoolIndex *pool) {
  J2OBJC_CREATE_IMPL(OrgApacheLuceneIndexByteSliceWriter, initWithOrgApacheLuceneIndexByteBlockPoolIndex_, pool)
}
