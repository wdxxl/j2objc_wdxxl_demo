...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/ScoringRewrite.java
//
...
inline OrgApacheLuceneSearchScoringRewrite *OrgApacheLuceneSearchScoringRewrite_get_SCORING_BOOLEAN_QUERY_REWRITE(void);
...
inline OrgApacheLuceneSearchMultiTermQuery_RewriteMethod *OrgApacheLuceneSearchScoringRewrite_get_CONSTANT_SCORE_BOOLEAN_QUERY_REWRITE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
