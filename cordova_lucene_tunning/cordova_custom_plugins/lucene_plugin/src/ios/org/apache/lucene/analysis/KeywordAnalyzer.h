...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/analysis/KeywordAnalyzer.java
//
...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisKeywordAnalyzer *new_OrgApacheLuceneAnalysisKeywordAnalyzer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneAnalysisKeywordAnalyzer *create_OrgApacheLuceneAnalysisKeywordAnalyzer_init(void);
