...
FOUNDATION_EXPORT OrgApacheLuceneUtilAverageGuessMemoryModel *new_OrgApacheLuceneUtilAverageGuessMemoryModel_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneUtilAverageGuessMemoryModel *create_OrgApacheLuceneUtilAverageGuessMemoryModel_init(void);
