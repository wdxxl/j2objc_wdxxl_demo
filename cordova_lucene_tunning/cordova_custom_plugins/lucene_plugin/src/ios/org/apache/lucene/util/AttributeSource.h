...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/util/AttributeSource.java
//
...
inline OrgApacheLuceneUtilAttributeSource_AttributeFactory *OrgApacheLuceneUtilAttributeSource_AttributeFactory_get_DEFAULT_ATTRIBUTE_FACTORY(void);
