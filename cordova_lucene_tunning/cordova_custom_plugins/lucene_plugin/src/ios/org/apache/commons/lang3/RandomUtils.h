...
FOUNDATION_EXPORT OrgApacheCommonsLang3RandomUtils *new_OrgApacheCommonsLang3RandomUtils_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3RandomUtils *create_OrgApacheCommonsLang3RandomUtils_init(void);
