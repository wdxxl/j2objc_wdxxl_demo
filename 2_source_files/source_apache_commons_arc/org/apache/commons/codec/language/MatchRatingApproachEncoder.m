...
inline NSString *OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_SPACE();
...
inline NSString *OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_EMPTY();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_ONE();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_TWO();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_THREE();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_FOUR();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_FIVE();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_SIX();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_SEVEN();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_EIGHT();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_ELEVEN();
...
inline jint OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_TWELVE();
...
inline NSString *OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_PLAIN_ASCII();
...
inline NSString *OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_UNICODE();
...
inline IOSObjectArray *OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_get_DOUBLE_CONSONANT();
...
- (NSString *)cleanNameWithNSString:(NSString *)name {
  ...
  IOSObjectArray *charsToTrim = [IOSObjectArray newArrayWithObjects:(id[]){ @"\\-", @"[&]", @"\\'", @"\\.", @"[\\,]" } count:5 type:NSString_class_()];
  {
...
- (id)encodeWithId:(id)pObject {
  if (!([pObject isKindOfClass:[NSString class]])) {
    @throw new_OrgApacheCommonsCodecEncoderException_initWithNSString_(@"Parameter supplied to Match Rating Approach encoder is not of type java.lang.String");
  }
...
- (NSString *)removeAccentsWithNSString:(NSString *)accentedWord {
  ...
  for (jint i = 0; i < n; i++) {
    ...
    if (pos > -1) {
      (void) [sb appendWithChar:[((NSString *) nil_chk(OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_PLAIN_ASCII)) charAtWithInt:pos]];
    }
    else {
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder class]) {
    OrgApacheCommonsCodecLanguageMatchRatingApproachEncoder_DOUBLE_CONSONANT = [IOSObjectArray newArrayWithObjects:(id[]){ @"BB", @"CC", @"DD", @"FF", @"GG", @"HH", @"JJ", @"KK", @"LL", @"MM", @"NN", @"PP", @"QQ", @"RR", @"SS", @"TT", @"VV", @"WW", @"XX", @"YY", @"ZZ" } count:21 type:NSString_class_()];
