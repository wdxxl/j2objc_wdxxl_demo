...
FOUNDATION_EXPORT OrgApacheCommonsCodecDigestHmacUtils *new_OrgApacheCommonsCodecDigestHmacUtils_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsCodecDigestHmacUtils *create_OrgApacheCommonsCodecDigestHmacUtils_init(void);
