...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ReflectTypeUtils class]) {
    OrgApacheCommonsLang3ReflectTypeUtils_WILDCARD_ALL = [((OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder *) nil_chk([((OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder *) nil_chk(OrgApacheCommonsLang3ReflectTypeUtils_wildcardType())) withUpperBoundsWithJavaLangReflectTypeArray:[IOSObjectArray newArrayWithObjects:(id[]){ NSObject_class_() } count:1 type:JavaLangReflectType_class_()]])) build];
...
jboolean OrgApacheCommonsLang3ReflectTypeUtils_isAssignableWithJavaLangReflectType_withJavaLangReflectType_withJavaUtilMap_(id<JavaLangReflectType> type, id<JavaLangReflectType> toType, id<JavaUtilMap> typeVarAssigns) {
  ...
  @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@", @"found an unhandled type: ", toType));
}
...
jboolean OrgApacheCommonsLang3ReflectTypeUtils_isAssignableWithJavaLangReflectType_withIOSClass_(id<JavaLangReflectType> type, IOSClass *toClass) {
  ...
  @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@", @"found an unhandled type: ", type));
}
...
id<JavaLangReflectType> OrgApacheCommonsLang3ReflectTypeUtils_substituteTypeVariablesWithJavaLangReflectType_withJavaUtilMap_(id<JavaLangReflectType> type, id<JavaUtilMap> typeVarAssigns) {
  ...
  if ([JavaLangReflectTypeVariable_class_() isInstance:type] && typeVarAssigns != nil) {
    ...
    if (replacementType == nil) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"missing assignment type for type variable ", type));
    }
...
id<JavaUtilMap> OrgApacheCommonsLang3ReflectTypeUtils_getTypeArgumentsWithJavaLangReflectParameterizedType_withIOSClass_withJavaUtilMap_(id<JavaLangReflectParameterizedType> parameterizedType, IOSClass *toClass, id<JavaUtilMap> subtypeVarAssigns) {
  ...
  if ([JavaLangReflectParameterizedType_class_() isInstance:ownerType]) {
    ...
    typeVarAssigns = subtypeVarAssigns == nil ? new_JavaUtilHashMap_init() : new_JavaUtilHashMap_initWithJavaUtilMap_(subtypeVarAssigns);
  }
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(typeParams))->size_; i++) {
    ...
    (void) [((id<JavaUtilMap>) nil_chk(typeVarAssigns)) putWithId:IOSObjectArray_Get(typeParams, i) withId:[typeVarAssigns containsKeyWithId:typeArg] ? [typeVarAssigns getWithId:typeArg] : typeArg];
  }
...
id<JavaUtilMap> OrgApacheCommonsLang3ReflectTypeUtils_getTypeArgumentsWithIOSClass_withIOSClass_withJavaUtilMap_(IOSClass *cls, IOSClass *toClass, id<JavaUtilMap> subtypeVarAssigns) {
  ...
  JavaUtilHashMap *typeVarAssigns = subtypeVarAssigns == nil ? new_JavaUtilHashMap_init() : new_JavaUtilHashMap_initWithJavaUtilMap_(subtypeVarAssigns);
  if ([((IOSClass *) nil_chk(toClass)) isEqual:cls]) {
    return typeVarAssigns;
  }
  return OrgApacheCommonsLang3ReflectTypeUtils_getTypeArgumentsWithJavaLangReflectType_withIOSClass_withJavaUtilMap_(OrgApacheCommonsLang3ReflectTypeUtils_getClosestParentTypeWithIOSClass_withIOSClass_(cls, toClass), toClass, typeVarAssigns);
...
id<JavaUtilMap> OrgApacheCommonsLang3ReflectTypeUtils_determineTypeArgumentsWithIOSClass_withJavaLangReflectParameterizedType_(IOSClass *cls, id<JavaLangReflectParameterizedType> superType) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(cls, @"cls is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(superType, @"superType is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
...
void OrgApacheCommonsLang3ReflectTypeUtils_mapTypeVariablesToArgumentsWithIOSClass_withJavaLangReflectParameterizedType_withJavaUtilMap_(IOSClass *cls, id<JavaLangReflectParameterizedType> parameterizedType, id<JavaUtilMap> typeVarAssigns) {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(typeArgs))->size_; i++) {
    ...
    if ([((id<JavaUtilList>) nil_chk(typeVarList)) containsWithId:typeArg] && [((id<JavaUtilMap>) nil_chk(typeVarAssigns)) containsKeyWithId:typeVar]) {
      (void) [((id<JavaUtilMap>) nil_chk(typeVarAssigns)) putWithId:(id<JavaLangReflectTypeVariable>) cast_check(typeArg, JavaLangReflectTypeVariable_class_()) withId:[typeVarAssigns getWithId:typeVar]];
    }
  }
}
    ...
    id<JavaLangReflectType> genericInterface = nil;
    {
      ...
      while (b__ < e__) {
        ...
        if ([JavaLangReflectParameterizedType_class_() isInstance:midType]) {
          ...
          @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@", @"Unexpected generic interface type found: ", midType));
        }
...
IOSObjectArray *OrgApacheCommonsLang3ReflectTypeUtils_normalizeUpperBoundsWithJavaLangReflectTypeArray_(IOSObjectArray *bounds) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(bounds, @"null value specified for bounds array", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  if (((IOSObjectArray *) nil_chk(bounds))->size_ < 2) {
    return bounds;
  }
  id<JavaUtilSet> types = new_JavaUtilHashSet_initWithInt_(bounds->size_);
  {
    IOSObjectArray *a__ = bounds;
  ...
  return [types toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[types size] type:JavaLangReflectType_class_()]];
}
...
IOSObjectArray *OrgApacheCommonsLang3ReflectTypeUtils_getImplicitBoundsWithJavaLangReflectTypeVariable_(id<JavaLangReflectTypeVariable> typeVariable) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(typeVariable, @"typeVariable is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  IOSObjectArray *bounds = [((id<JavaLangReflectTypeVariable>) nil_chk(typeVariable)) getBounds];
  return ((IOSObjectArray *) nil_chk(bounds))->size_ == 0 ? [IOSObjectArray newArrayWithObjects:(id[]){ NSObject_class_() } count:1 type:JavaLangReflectType_class_()] : OrgApacheCommonsLang3ReflectTypeUtils_normalizeUpperBoundsWithJavaLangReflectTypeArray_(bounds);
}
...
IOSObjectArray *OrgApacheCommonsLang3ReflectTypeUtils_getImplicitUpperBoundsWithJavaLangReflectWildcardType_(id<JavaLangReflectWildcardType> wildcardType) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(wildcardType, @"wildcardType is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
...
IOSObjectArray *OrgApacheCommonsLang3ReflectTypeUtils_getImplicitLowerBoundsWithJavaLangReflectWildcardType_(id<JavaLangReflectWildcardType> wildcardType) {
  ...
  return ((IOSObjectArray *) nil_chk(bounds))->size_ == 0 ? [IOSObjectArray newArrayWithObjects:(id[]){ nil } count:1 type:JavaLangReflectType_class_()] : bounds;
}

jboolean OrgApacheCommonsLang3ReflectTypeUtils_typesSatisfyVariablesWithJavaUtilMap_(id<JavaUtilMap> typeVarAssigns) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(typeVarAssigns, @"typeVarAssigns is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
...
IOSClass *OrgApacheCommonsLang3ReflectTypeUtils_getRawTypeWithJavaLangReflectParameterizedType_(id<JavaLangReflectParameterizedType> parameterizedType) {
  ...
  if (!([rawType isKindOfClass:[IOSClass class]])) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@", @"Wait... What!? Type of rawType: ", rawType));
  }
...
IOSClass *OrgApacheCommonsLang3ReflectTypeUtils_getRawTypeWithJavaLangReflectType_withJavaLangReflectType_(id<JavaLangReflectType> type, id<JavaLangReflectType> assigningType) {
  ...
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"unknown type: ", type));
}
  ...
  if (OrgApacheCommonsLang3ReflectTypeUtils_containsTypeVariablesWithJavaLangReflectType_(type)) {
    ...
    if ([JavaLangReflectParameterizedType_class_() isInstance:type]) {
      ...
      if ([((id<JavaLangReflectParameterizedType>) nil_chk(p)) getOwnerType] == nil) {
        ...
        parameterizedTypeArguments = new_JavaUtilHashMap_initWithJavaUtilMap_(typeArguments);
      ...
      for (jint i = 0; i < ((IOSObjectArray *) nil_chk(args))->size_; i++) {
        ...
        if (unrolled != nil) {
          (void) IOSObjectArray_Set(args, i, unrolled);
        }
      }
...
IOSObjectArray *OrgApacheCommonsLang3ReflectTypeUtils_unrollBoundsWithJavaUtilMap_withJavaLangReflectTypeArray_(id<JavaUtilMap> typeArguments, IOSObjectArray *bounds) {
  ...
  for (; i < ((IOSObjectArray *) nil_chk(result))->size_; i++) {
    ...
    if (unrolled == nil) {
      ...
      (void) IOSObjectArray_Set(result, i, unrolled);
    }
  }
  return result;
}
...
id<JavaLangReflectParameterizedType> OrgApacheCommonsLang3ReflectTypeUtils_parameterizeWithIOSClass_withJavaUtilMap_(IOSClass *raw, id<JavaUtilMap> typeArgMappings) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(raw, @"raw class is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(typeArgMappings, @"typeArgMappings is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
...
id<JavaLangReflectParameterizedType> OrgApacheCommonsLang3ReflectTypeUtils_parameterizeWithOwnerWithJavaLangReflectType_withIOSClass_withJavaLangReflectTypeArray_(id<JavaLangReflectType> owner, IOSClass *raw, IOSObjectArray *typeArguments) {
  ...
  if ([((IOSClass *) nil_chk(raw)) getEnclosingClass] == nil) {
    OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(owner == nil, @"no owner allowed for top-level %s", [IOSObjectArray newArrayWithObjects:(id[]){ raw } count:1 type:NSObject_class_()]);
    useOwner = nil;
  }
  else if (owner == nil) {
    ...
    OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(OrgApacheCommonsLang3ReflectTypeUtils_isAssignableWithJavaLangReflectType_withIOSClass_(owner, [raw getEnclosingClass]), @"%s is invalid owner type for parameterized %s", [IOSObjectArray newArrayWithObjects:(id[]){ owner, raw } count:2 type:NSObject_class_()]);
    useOwner = owner;
  }
  (void) OrgApacheCommonsLang3Validate_noNullElementsWithNSObjectArray_withNSString_withNSObjectArray_(typeArguments, @"null type argument at index %s", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(((IOSObjectArray *) nil_chk([raw getTypeParameters]))->size_ == ((IOSObjectArray *) nil_chk(typeArguments))->size_, @"invalid number of type parameters specified: expected %s, got %s", [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(((IOSObjectArray *) nil_chk([raw getTypeParameters]))->size_), JavaLangInteger_valueOfWithInt_(typeArguments->size_) } count:2 type:NSObject_class_()]);
  return new_OrgApacheCommonsLang3ReflectTypeUtils_ParameterizedTypeImpl_initWithIOSClass_withJavaLangReflectType_withJavaLangReflectTypeArray_(raw, useOwner, typeArguments);
}
...
IOSObjectArray *OrgApacheCommonsLang3ReflectTypeUtils_extractTypeArgumentsFromWithJavaUtilMap_withJavaLangReflectTypeVariableArray_(id<JavaUtilMap> mappings, IOSObjectArray *variables) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(variables))->size_ type:JavaLangReflectType_class_()];
  jint index = 0;
  {
    ...
    while (b__ < e__) {
      ...
      OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_([((id<JavaUtilMap>) nil_chk(mappings)) containsKeyWithId:var], @"missing argument mapping for %s", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheCommonsLang3ReflectTypeUtils_toStringWithJavaLangReflectType_(var) } count:1 type:NSObject_class_()]);
      (void) IOSObjectArray_Set(result, index++, [mappings getWithId:var]);
    }
  }
  return result;
}
...
OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder *OrgApacheCommonsLang3ReflectTypeUtils_wildcardType() {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  return new_OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder_init();
}
...
id<JavaLangReflectGenericArrayType> OrgApacheCommonsLang3ReflectTypeUtils_genericArrayTypeWithJavaLangReflectType_(id<JavaLangReflectType> componentType) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  return new_OrgApacheCommonsLang3ReflectTypeUtils_GenericArrayTypeImpl_initWithJavaLangReflectType_(OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(componentType, @"componentType is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]));
}
...
NSString *OrgApacheCommonsLang3ReflectTypeUtils_toStringWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_(type);
  if ([type isKindOfClass:[IOSClass class]]) {
  ...
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(OrgApacheCommonsLang3ObjectUtils_identityToStringWithId_(type));
}
...
NSString *OrgApacheCommonsLang3ReflectTypeUtils_toLongStringWithJavaLangReflectTypeVariable_(id<JavaLangReflectTypeVariable> var) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(var, @"var is null", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  ...
  if ([d isKindOfClass:[IOSClass class]]) {
    ...
    while (true) {
      if ([((IOSClass *) nil_chk(c)) getEnclosingClass] == nil) {
        (void) [buf insertWithInt:0 withNSString:[c getName]];
        break;
      }
      (void) [((JavaLangStringBuilder *) nil_chk([buf insertWithInt:0 withNSString:[c getSimpleName]])) insertWithInt:0 withChar:'.'];
      c = [c getEnclosingClass];
    }
  }
  else if ([JavaLangReflectType_class_() isInstance:d]) {
    (void) [buf appendWithNSString:OrgApacheCommonsLang3ReflectTypeUtils_toStringWithJavaLangReflectType_((id<JavaLangReflectType>) cast_check(d, JavaLangReflectType_class_()))];
  }
  else {
    (void) [buf appendWithId:d];
  }
...
id<OrgApacheCommonsLang3ReflectTyped> OrgApacheCommonsLang3ReflectTypeUtils_wrapWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  return new_OrgApacheCommonsLang3ReflectTypeUtils_1_initWithJavaLangReflectType_(type);
}
...
NSString *OrgApacheCommonsLang3ReflectTypeUtils_classToStringWithIOSClass_(IOSClass *c) {
  ...
  JavaLangStringBuilder *buf = new_JavaLangStringBuilder_init();
  if ([((IOSClass *) nil_chk(c)) getEnclosingClass] != nil) {
    (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([buf appendWithNSString:OrgApacheCommonsLang3ReflectTypeUtils_classToStringWithIOSClass_([c getEnclosingClass])])) appendWithChar:'.'])) appendWithNSString:[c getSimpleName]];
  }
  else {
    (void) [buf appendWithNSString:[c getName]];
  }
  if (((IOSObjectArray *) nil_chk([c getTypeParameters]))->size_ > 0) {
    (void) [buf appendWithChar:'<'];
    (void) OrgApacheCommonsLang3ReflectTypeUtils_appendAllToWithJavaLangStringBuilder_withNSString_withJavaLangReflectTypeArray_(buf, @", ", [c getTypeParameters]);
    (void) [buf appendWithChar:'>'];
  }
...
NSString *OrgApacheCommonsLang3ReflectTypeUtils_typeVariableToStringWithJavaLangReflectTypeVariable_(id<JavaLangReflectTypeVariable> v) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  JavaLangStringBuilder *buf = new_JavaLangStringBuilder_initWithNSString_([((id<JavaLangReflectTypeVariable>) nil_chk(v)) getName]);
  ...
  if (((IOSObjectArray *) nil_chk(bounds))->size_ > 0 && !(bounds->size_ == 1 && [NSObject_class_() isEqual:IOSObjectArray_Get(bounds, 0)])) {
    (void) [buf appendWithNSString:@" extends "];
    (void) OrgApacheCommonsLang3ReflectTypeUtils_appendAllToWithJavaLangStringBuilder_withNSString_withJavaLangReflectTypeArray_(buf, @" & ", [v getBounds]);
  }
  return [buf description];
}
...
NSString *OrgApacheCommonsLang3ReflectTypeUtils_parameterizedTypeToStringWithJavaLangReflectParameterizedType_(id<JavaLangReflectParameterizedType> p) {
  ...
  if (useOwner == nil) {
    (void) [buf appendWithNSString:[((IOSClass *) nil_chk(raw)) getName]];
  }
  else {
    if ([useOwner isKindOfClass:[IOSClass class]]) {
      (void) [buf appendWithNSString:[((IOSClass *) cast_chk(useOwner, [IOSClass class])) getName]];
    }
    else {
      (void) [buf appendWithNSString:[useOwner description]];
    }
    (void) [((JavaLangStringBuilder *) nil_chk([buf appendWithChar:'.'])) appendWithNSString:[((IOSClass *) nil_chk(raw)) getSimpleName]];
  }
  (void) [((JavaLangStringBuilder *) nil_chk(OrgApacheCommonsLang3ReflectTypeUtils_appendAllToWithJavaLangStringBuilder_withNSString_withJavaLangReflectTypeArray_([buf appendWithChar:'<'], @", ", typeArguments))) appendWithChar:'>'];
  return [buf description];
}
...
NSString *OrgApacheCommonsLang3ReflectTypeUtils_wildcardTypeToStringWithJavaLangReflectWildcardType_(id<JavaLangReflectWildcardType> w) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  JavaLangStringBuilder *buf = [new_JavaLangStringBuilder_init() appendWithChar:'?'];
  ...
  if (((IOSObjectArray *) nil_chk(lowerBounds))->size_ > 1 || (lowerBounds->size_ == 1 && IOSObjectArray_Get(lowerBounds, 0) != nil)) {
    (void) OrgApacheCommonsLang3ReflectTypeUtils_appendAllToWithJavaLangStringBuilder_withNSString_withJavaLangReflectTypeArray_([((JavaLangStringBuilder *) nil_chk(buf)) appendWithNSString:@" super "], @" & ", lowerBounds);
  }
    ...
    (void) OrgApacheCommonsLang3ReflectTypeUtils_appendAllToWithJavaLangStringBuilder_withNSString_withJavaLangReflectTypeArray_([((JavaLangStringBuilder *) nil_chk(buf)) appendWithNSString:@" extends "], @" & ", upperBounds);
  }
...
NSString *OrgApacheCommonsLang3ReflectTypeUtils_genericArrayTypeToStringWithJavaLangReflectGenericArrayType_(id<JavaLangReflectGenericArrayType> g) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  return NSString_java_formatWithNSString_withNSObjectArray_(@"%s[]", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheCommonsLang3ReflectTypeUtils_toStringWithJavaLangReflectType_([((id<JavaLangReflectGenericArrayType>) nil_chk(g)) getGenericComponentType]) } count:1 type:NSObject_class_()]);
}
...
JavaLangStringBuilder *OrgApacheCommonsLang3ReflectTypeUtils_appendAllToWithJavaLangStringBuilder_withNSString_withJavaLangReflectTypeArray_(JavaLangStringBuilder *buf, NSString *sep, IOSObjectArray *types) {
  OrgApacheCommonsLang3ReflectTypeUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notEmptyWithNSObjectArray_(OrgApacheCommonsLang3Validate_noNullElementsWithNSObjectArray_(types));
  if (((IOSObjectArray *) nil_chk(types))->size_ > 0) {
    (void) [((JavaLangStringBuilder *) nil_chk(buf)) appendWithNSString:OrgApacheCommonsLang3ReflectTypeUtils_toStringWithJavaLangReflectType_(IOSObjectArray_Get(types, 0))];
    for (jint i = 1; i < types->size_; i++) {
      (void) [((JavaLangStringBuilder *) nil_chk([buf appendWithNSString:sep])) appendWithNSString:OrgApacheCommonsLang3ReflectTypeUtils_toStringWithJavaLangReflectType_(IOSObjectArray_Get(types, i))];
    }
  }
  return buf;
}
...
- (OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder *)withLowerBoundsWithJavaLangReflectTypeArray:(IOSObjectArray *)bounds {
  self->lowerBounds_ = bounds;
  return self;
}

- (id<JavaLangReflectWildcardType>)build {
  return new_OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_(upperBounds_, lowerBounds_);
}
...
void OrgApacheCommonsLang3ReflectTypeUtils_ParameterizedTypeImpl_initWithIOSClass_withJavaLangReflectType_withJavaLangReflectTypeArray_(OrgApacheCommonsLang3ReflectTypeUtils_ParameterizedTypeImpl *self, IOSClass *raw, id<JavaLangReflectType> useOwner, IOSObjectArray *typeArguments) {
  NSObject_init(self);
  self->raw_ = raw;
  self->useOwner_ = useOwner;
  self->typeArguments_ = typeArguments;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl class]) {
    OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl_EMPTY_BOUNDS = [IOSObjectArray newArrayWithLength:0 type:JavaLangReflectType_class_()];
...
void OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_(OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl *self, IOSObjectArray *upperBounds, IOSObjectArray *lowerBounds) {
  NSObject_init(self);
  self->upperBounds_ = OrgApacheCommonsLang3ObjectUtils_defaultIfNullWithId_withId_(upperBounds, OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl_EMPTY_BOUNDS);
  self->lowerBounds_ = OrgApacheCommonsLang3ObjectUtils_defaultIfNullWithId_withId_(lowerBounds, OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl_EMPTY_BOUNDS);
}
