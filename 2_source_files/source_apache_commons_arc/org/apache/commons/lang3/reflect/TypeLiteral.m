...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ReflectTypeLiteral class]) {
    OrgApacheCommonsLang3ReflectTypeLiteral_T = IOSObjectArray_Get(nil_chk([OrgApacheCommonsLang3ReflectTypeLiteral_class_() getTypeParameters]), 0);
...
void OrgApacheCommonsLang3ReflectTypeLiteral_init(OrgApacheCommonsLang3ReflectTypeLiteral *self) {
  NSObject_init(self);
  self->value_ = OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_([((id<JavaUtilMap>) nil_chk(OrgApacheCommonsLang3ReflectTypeUtils_getTypeArgumentsWithJavaLangReflectType_withIOSClass_([self java_getClass], OrgApacheCommonsLang3ReflectTypeLiteral_class_()))) getWithId:OrgApacheCommonsLang3ReflectTypeLiteral_T], @"%s does not assign type parameter %s", [IOSObjectArray newArrayWithObjects:(id[]){ [self java_getClass], OrgApacheCommonsLang3ReflectTypeUtils_toLongStringWithJavaLangReflectTypeVariable_(OrgApacheCommonsLang3ReflectTypeLiteral_T) } count:2 type:NSObject_class_()]);
  self->toString_ = NSString_java_formatWithNSString_withNSObjectArray_(@"%s<%s>", [IOSObjectArray newArrayWithObjects:(id[]){ [OrgApacheCommonsLang3ReflectTypeLiteral_class_() getSimpleName], OrgApacheCommonsLang3ReflectTypeUtils_toStringWithJavaLangReflectType_(self->value_) } count:2 type:NSObject_class_()]);
}
