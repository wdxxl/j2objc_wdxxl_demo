...
- (OrgApacheCommonsLang3ExceptionDefaultExceptionContext *)addContextValueWithNSString:(NSString *)label
                                                                                withId:(id)value {
  [((id<JavaUtilList>) nil_chk(contextValues_)) addWithId:new_OrgApacheCommonsLang3TupleImmutablePair_initWithId_withId_(label, value)];
  return self;
}
...
- (OrgApacheCommonsLang3ExceptionDefaultExceptionContext *)setContextValueWithNSString:(NSString *)label
  ...
  (void) [self addContextValueWithNSString:label withId:value];
  return self;
}
...
- (id<JavaUtilSet>)getContextLabels {
  id<JavaUtilSet> labels = new_JavaUtilHashSet_init();
  for (OrgApacheCommonsLang3TuplePair * __strong pair in nil_chk(contextValues_)) {
...
- (NSString *)getFormattedExceptionMessageWithNSString:(NSString *)baseMessage {
  JavaLangStringBuilder *buffer = new_JavaLangStringBuilder_initWithInt_(256);
  if (baseMessage != nil) {
    (void) [buffer appendWithNSString:baseMessage];
  }
  if ([((id<JavaUtilList>) nil_chk(contextValues_)) size] > 0) {
    if ([buffer java_length] > 0) {
      (void) [buffer appendWithChar:0x000a];
    }
    (void) [buffer appendWithNSString:@"Exception Context:\n"];
    jint i = 0;
    for (OrgApacheCommonsLang3TuplePair * __strong pair in contextValues_) {
      ...
      (void) [buffer appendWithNSString:[((OrgApacheCommonsLang3TuplePair *) nil_chk(pair)) getKey]];
      (void) [buffer appendWithNSString:@"="];
      ...
      if (value == nil) {
        ...
        (void) [buffer appendWithNSString:valueStr];
      }
      (void) [buffer appendWithNSString:@"]\n"];
    }
    (void) [buffer appendWithNSString:@"---------------------------------"];
...
void OrgApacheCommonsLang3ExceptionDefaultExceptionContext_init(OrgApacheCommonsLang3ExceptionDefaultExceptionContext *self) {
  NSObject_init(self);
  self->contextValues_ = new_JavaUtilArrayList_init();
}
