...
void OrgApacheCommonsLang3ObjectUtils_identityToStringWithJavaLangAppendable_withId_(id<JavaLangAppendable> appendable, id object) {
  OrgApacheCommonsLang3ObjectUtils_initialize();
  if (object == nil) {
    @throw new_JavaLangNullPointerException_initWithNSString_(@"Cannot get the toString of a null identity");
  }
  (void) [((id<JavaLangAppendable>) nil_chk([((id<JavaLangAppendable>) nil_chk([((id<JavaLangAppendable>) nil_chk(appendable)) appendWithJavaLangCharSequence:[[object java_getClass] getName]])) appendWithChar:'@'])) appendWithJavaLangCharSequence:JavaLangInteger_toHexStringWithInt_(JavaLangSystem_identityHashCodeWithId_(object))];
}
...
void OrgApacheCommonsLang3ObjectUtils_identityToStringWithOrgApacheCommonsLang3TextStrBuilder_withId_(OrgApacheCommonsLang3TextStrBuilder *builder, id object) {
  ...
  (void) [((OrgApacheCommonsLang3TextStrBuilder *) nil_chk([((OrgApacheCommonsLang3TextStrBuilder *) nil_chk([((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(builder)) appendWithNSString:[[object java_getClass] getName]])) appendWithChar:'@'])) appendWithNSString:JavaLangInteger_toHexStringWithInt_(JavaLangSystem_identityHashCodeWithId_(object))];
}
...
void OrgApacheCommonsLang3ObjectUtils_identityToStringWithJavaLangStringBuffer_withId_(JavaLangStringBuffer *buffer, id object) {
  ...
  (void) [((JavaLangStringBuffer *) nil_chk([((JavaLangStringBuffer *) nil_chk([((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:[[object java_getClass] getName]])) appendWithChar:'@'])) appendWithNSString:JavaLangInteger_toHexStringWithInt_(JavaLangSystem_identityHashCodeWithId_(object))];
}
...
void OrgApacheCommonsLang3ObjectUtils_identityToStringWithJavaLangStringBuilder_withId_(JavaLangStringBuilder *builder, id object) {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(builder)) appendWithNSString:[[object java_getClass] getName]])) appendWithChar:'@'])) appendWithNSString:JavaLangInteger_toHexStringWithInt_(JavaLangSystem_identityHashCodeWithId_(object))];
}
...
id<JavaLangComparable> OrgApacheCommonsLang3ObjectUtils_medianWithJavaLangComparableArray_(IOSObjectArray *items) {
  OrgApacheCommonsLang3ObjectUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notEmptyWithNSObjectArray_(items);
  (void) OrgApacheCommonsLang3Validate_noNullElementsWithNSObjectArray_(items);
  JavaUtilTreeSet *sort = new_JavaUtilTreeSet_init();
...
id OrgApacheCommonsLang3ObjectUtils_medianWithJavaUtilComparator_withNSObjectArray_(id<JavaUtilComparator> comparator, IOSObjectArray *items) {
  OrgApacheCommonsLang3ObjectUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notEmptyWithNSObjectArray_withNSString_withNSObjectArray_(items, @"null/empty items", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  (void) OrgApacheCommonsLang3Validate_noNullElementsWithNSObjectArray_(items);
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(comparator, @"null comparator", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  JavaUtilTreeSet *sort = new_JavaUtilTreeSet_initWithJavaUtilComparator_(comparator);
  JavaUtilCollections_addAllWithJavaUtilCollection_withNSObjectArray_(sort, items);
...
id OrgApacheCommonsLang3ObjectUtils_modeWithNSObjectArray_(IOSObjectArray *items) {
  ...
  if (OrgApacheCommonsLang3ArrayUtils_isNotEmptyWithNSObjectArray_(items)) {
    JavaUtilHashMap *occurrences = new_JavaUtilHashMap_initWithInt_(((IOSObjectArray *) nil_chk(items))->size_);
    {
      ...
      while (b__ < e__) {
        ...
        if (count == nil) {
          (void) [occurrences putWithId:t withId:new_OrgApacheCommonsLang3MutableMutableInt_initWithInt_(1)];
        }
        else {
          [count increment];
        }
...
id OrgApacheCommonsLang3ObjectUtils_cloneWithId_(id obj) {
  ...
  if ([NSCopying_class_() isInstance:obj]) {
    ...
    if ([[nil_chk(obj) java_getClass] isArray]) {
      ...
      @try {
        JavaLangReflectMethod *clone = [[obj java_getClass] getMethod:@"clone" parameterTypes:[IOSObjectArray newArrayWithLength:0 type:IOSClass_class_()]];
        result = [((JavaLangReflectMethod *) nil_chk(clone)) invokeWithId:obj withNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]];
      }
      @catch (JavaLangNoSuchMethodException *e) {
        @throw new_OrgApacheCommonsLang3ExceptionCloneFailedException_initWithNSString_withNSException_(JreStrcat("$$$", @"Cloneable type ", [[obj java_getClass] getName], @" has no clone method"), e);
      }
      @catch (JavaLangIllegalAccessException *e) {
        @throw new_OrgApacheCommonsLang3ExceptionCloneFailedException_initWithNSString_withNSException_(JreStrcat("$$", @"Cannot clone Cloneable type ", [[obj java_getClass] getName]), e);
      }
      @catch (JavaLangReflectInvocationTargetException *e) {
        @throw new_OrgApacheCommonsLang3ExceptionCloneFailedException_initWithNSString_withNSException_(JreStrcat("$$", @"Exception cloning Cloneable type ", [[obj java_getClass] getName]), [e getCause]);
      }
    }
    id checked = result;
    return checked;
...
jbyte OrgApacheCommonsLang3ObjectUtils_CONST_BYTEWithInt_(jint v) {
  ...
  if (v < JavaLangByte_MIN_VALUE || v > JavaLangByte_MAX_VALUE) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$IC", @"Supplied value must be a valid byte literal between -128 and 127: [", v, ']'));
  }
  return (jbyte) v;
}
...
jshort OrgApacheCommonsLang3ObjectUtils_CONST_SHORTWithInt_(jint v) {
  ...
  if (v < JavaLangShort_MIN_VALUE || v > JavaLangShort_MAX_VALUE) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$IC", @"Supplied value must be a valid byte literal between -32768 and 32767: [", v, ']'));
  }
  return (jshort) v;
}
