...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3JavaVersion class]) {
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_0_9) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.5f, @"0.9", @"JAVA_0_9", 0);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_1) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.1f, @"1.1", @"JAVA_1_1", 1);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_2) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.2f, @"1.2", @"JAVA_1_2", 2);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_3) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.3f, @"1.3", @"JAVA_1_3", 3);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_4) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.4f, @"1.4", @"JAVA_1_4", 4);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_5) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.5f, @"1.5", @"JAVA_1_5", 5);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_6) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.6f, @"1.6", @"JAVA_1_6", 6);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_7) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.7f, @"1.7", @"JAVA_1_7", 7);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_8) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.8f, @"1.8", @"JAVA_1_8", 8);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_9) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(1.9f, @"1.9", @"JAVA_1_9", 9);
    JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_RECENT) = new_OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(OrgApacheCommonsLang3JavaVersion_maxVersion(), JavaLangFloat_toStringWithFloat_(OrgApacheCommonsLang3JavaVersion_maxVersion()), @"JAVA_RECENT", 10);
