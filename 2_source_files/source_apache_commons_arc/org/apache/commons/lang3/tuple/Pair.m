...
- (NSString *)description {
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_init() appendWithChar:'('])) appendWithId:[self getLeft]])) appendWithChar:','])) appendWithId:[self getRight]])) appendWithChar:')'])) description];
}

- (NSString *)toStringWithNSString:(NSString *)format {
  return NSString_java_formatWithNSString_withNSObjectArray_(format, [IOSObjectArray newArrayWithObjects:(id[]){ [self getLeft], [self getRight] } count:2 type:NSObject_class_()]);
}
