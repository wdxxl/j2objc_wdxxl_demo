...
- (OrgApacheCommonsLang3TextStrBuilder *)setLengthWithInt:(jint)length {
  if (length < 0) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithInt_(length);
  }
  if (length < size_) {
    size_ = length;
  }
  else if (length > size_) {
    (void) [self ensureCapacityWithInt:length];
    jint oldEnd = size_;
    jint newEnd = length;
    size_ = length;
...
- (OrgApacheCommonsLang3TextStrBuilder *)ensureCapacityWithInt:(jint)capacity {
  if (capacity > ((IOSCharArray *) nil_chk(buffer_))->size_) {
    ...
    buffer_ = [IOSCharArray newArrayWithLength:capacity * 2];
...
- (OrgApacheCommonsLang3TextStrBuilder *)minimizeCapacity {
  if (((IOSCharArray *) nil_chk(buffer_))->size_ > [self java_length]) {
    IOSCharArray *old = buffer_;
    buffer_ = [IOSCharArray newArrayWithLength:[self java_length]];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(old, 0, buffer_, 0, size_);
  }
  return self;
}
...
- (jchar)charAtWithInt:(jint)index {
  if (index < 0 || index >= [self java_length]) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithInt_(index);
  }
...
- (IOSCharArray *)toCharArray {
  ...
  IOSCharArray *chars = [IOSCharArray newArrayWithLength:size_];
...
- (IOSCharArray *)getCharsWithCharArray:(IOSCharArray *)destination {
  ...
  if (destination == nil || destination->size_ < len) {
    destination = [IOSCharArray newArrayWithLength:len];
  }
...
- (void)getCharsWithInt:(jint)startIndex
  ...
  if (startIndex < 0) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithInt_(startIndex);
  }
  if (endIndex < 0 || endIndex > [self java_length]) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithInt_(endIndex);
  }
  if (startIndex > endIndex) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithNSString_(@"end < start");
  }
...
- (jint)readFromWithJavaLangReadable:(id<JavaLangReadable>)readable {
  ...
  if ([readable isKindOfClass:[JavaIoReader class]]) {
    ...
    (void) [self ensureCapacityWithInt:size_ + 1];
    jint read;
    ...
    (void) [self ensureCapacityWithInt:size_ + remaining];
    (void) [cb getWithCharArray:buffer_ withInt:size_ withInt:remaining];
    size_ += remaining;
  }
  else {
    while (true) {
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendNewLine {
  if (newLine_ == nil) {
    (void) [self appendWithNSString:JreLoadStatic(OrgApacheCommonsLang3SystemUtils, LINE_SEPARATOR)];
    return self;
  }
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithNSString:(NSString *)str {
  ...
  if (strLen > 0) {
    jint len = [self java_length];
    (void) [self ensureCapacityWithInt:len + strLen];
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithNSString:(NSString *)str
  ...
  if (startIndex < 0 || startIndex > [str java_length]) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithNSString_(@"startIndex must be valid");
  }
  if (length < 0 || (startIndex + length) > [str java_length]) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithNSString_(@"length must be valid");
  }
  if (length > 0) {
    jint len = [self java_length];
    (void) [self ensureCapacityWithInt:len + length];
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithJavaNioCharBuffer:(JavaNioCharBuffer *)buf {
  ...
  if ([buf hasArray]) {
    ...
    (void) [self appendWithNSString:[buf description]];
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithJavaNioCharBuffer:(JavaNioCharBuffer *)buf
  ...
  if ([buf hasArray]) {
    ...
    (void) [self appendWithNSString:[buf description] withInt:startIndex withInt:length];
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithCharArray:(IOSCharArray *)chars
  ...
  if (startIndex < 0 || startIndex > chars->size_) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I", @"Invalid startIndex: ", length));
  }
  if (length < 0 || (startIndex + length) > chars->size_) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I", @"Invalid length: ", length));
  }
  if (length > 0) {
    jint len = [self java_length];
    (void) [self ensureCapacityWithInt:len + length];
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithBoolean:(jboolean)value {
  if (value) {
    (void) [self ensureCapacityWithInt:size_ + 4];
    ...
    *IOSCharArray_GetRef(buffer_, size_++) = 'e';
    ...
    (void) [self ensureCapacityWithInt:size_ + 5];
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithChar:(jchar)ch {
  jint len = [self java_length];
  (void) [self ensureCapacityWithInt:len + 1];
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendAllWithJavaUtilIterator:(id<JavaUtilIterator>)it {
  if (it != nil) {
    while ([it hasNext]) {
      (void) [self appendWithId:[it next]];
    }
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendWithSeparatorsWithNSObjectArray:(IOSObjectArray *)array
  ...
  if (array != nil && array->size_ > 0) {
    ...
    (void) [self appendWithId:IOSObjectArray_Get(array, 0)];
    for (jint i = 1; i < array->size_; i++) {
      (void) [self appendWithNSString:sep];
      (void) [self appendWithId:IOSObjectArray_Get(array, i)];
    }
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendSeparatorWithNSString:(NSString *)standard
  ...
  if (str != nil) {
    (void) [self appendWithNSString:str];
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendSeparatorWithChar:(jchar)separator {
  if ([self size] > 0) {
    (void) [self appendWithChar:separator];
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendSeparatorWithChar:(jchar)standard
  ...
  if ([self size] > 0) {
    (void) [self appendWithChar:standard];
  }
  else {
    (void) [self appendWithChar:defaultIfEmpty];
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendSeparatorWithNSString:(NSString *)separator
  ...
  if (separator != nil && loopIndex > 0) {
    (void) [self appendWithNSString:separator];
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendPaddingWithInt:(jint)length
  ...
  if (length >= 0) {
    (void) [self ensureCapacityWithInt:size_ + length];
...
- (OrgApacheCommonsLang3TextStrBuilder *)appendFixedWidthPadLeftWithId:(id)obj
                                                              ...
                                                              withChar:(jchar)padChar {
  if (width > 0) {
    (void) [self ensureCapacityWithInt:size_ + width];
...
- (OrgApacheCommonsLang3TextStrBuilder *)insertWithInt:(jint)index
  ...
  if (str != nil) {
    ...
    if (strLen > 0) {
      ...
      (void) [self ensureCapacityWithInt:newSize];
...
- (OrgApacheCommonsLang3TextStrBuilder *)insertWithInt:(jint)index
  ...
  if (len > 0) {
    (void) [self ensureCapacityWithInt:size_ + len];
...
- (OrgApacheCommonsLang3TextStrBuilder *)insertWithInt:(jint)index
  ...
  if (offset < 0 || offset > chars->size_) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I", @"Invalid offset: ", offset));
  }
...
- (OrgApacheCommonsLang3TextStrBuilder *)trim {
  ...
  if (len < size_) {
    (void) [self delete__WithInt:len withInt:size_];
  }
  if (pos > 0) {
    (void) [self delete__WithInt:0 withInt:pos];
  }
  return self;
}
...
- (id<JavaLangCharSequence>)subSequenceFrom:(jint)startIndex
  ...
  if (startIndex > endIndex) {
    @throw new_JavaLangStringIndexOutOfBoundsException_initWithInt_(endIndex - startIndex);
  }
...
- (OrgApacheCommonsLang3TextStrTokenizer *)asTokenizer {
  return new_OrgApacheCommonsLang3TextStrBuilder_StrBuilderTokenizer_initWithOrgApacheCommonsLang3TextStrBuilder_(self);
}

- (JavaIoReader *)asReader {
  return new_OrgApacheCommonsLang3TextStrBuilder_StrBuilderReader_initWithOrgApacheCommonsLang3TextStrBuilder_(self);
}

- (JavaIoWriter *)asWriter {
  return new_OrgApacheCommonsLang3TextStrBuilder_StrBuilderWriter_initWithOrgApacheCommonsLang3TextStrBuilder_(self);
}
...
- (void)appendToWithJavaLangAppendable:(id<JavaLangAppendable>)appendable {
  if ([appendable isKindOfClass:[JavaIoWriter class]]) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(((JavaLangStringBuilder *) cast_chk(appendable, [JavaLangStringBuilder class])))) appendWithCharArray:buffer_ withInt:0 withInt:size_];
  }
  else if ([appendable isKindOfClass:[JavaLangStringBuffer class]]) {
    (void) [((JavaLangStringBuffer *) nil_chk(((JavaLangStringBuffer *) cast_chk(appendable, [JavaLangStringBuffer class])))) appendWithCharArray:buffer_ withInt:0 withInt:size_];
  }
  else if ([appendable isKindOfClass:[JavaNioCharBuffer class]]) {
    (void) [((JavaNioCharBuffer *) nil_chk(((JavaNioCharBuffer *) cast_chk(appendable, [JavaNioCharBuffer class])))) putWithCharArray:buffer_ withInt:0 withInt:size_];
  }
  else {
    (void) [((id<JavaLangAppendable>) nil_chk(appendable)) appendWithJavaLangCharSequence:self];
  }
}
...
- (JavaLangStringBuffer *)toStringBuffer {
  return [new_JavaLangStringBuffer_initWithInt_(size_) appendWithCharArray:buffer_ withInt:0 withInt:size_];
}

- (JavaLangStringBuilder *)toStringBuilder {
  return [new_JavaLangStringBuilder_initWithInt_(size_) appendWithCharArray:buffer_ withInt:0 withInt:size_];
}
...
void OrgApacheCommonsLang3TextStrBuilder_initWithInt_(OrgApacheCommonsLang3TextStrBuilder *self, jint initialCapacity) {
  ...
  self->buffer_ = [IOSCharArray newArrayWithLength:initialCapacity];
}
...
void OrgApacheCommonsLang3TextStrBuilder_initWithNSString_(OrgApacheCommonsLang3TextStrBuilder *self, NSString *str) {
  NSObject_init(self);
  if (str == nil) {
    self->buffer_ = [IOSCharArray newArrayWithLength:OrgApacheCommonsLang3TextStrBuilder_CAPACITY];
  }
  else {
    self->buffer_ = [IOSCharArray newArrayWithLength:[str java_length] + OrgApacheCommonsLang3TextStrBuilder_CAPACITY];
    (void) [self appendWithNSString:str];
  }
}
...
- (void)writeWithInt:(jint)c {
  (void) [this$0_ appendWithChar:(jchar) c];
}

- (void)writeWithCharArray:(IOSCharArray *)cbuf {
  (void) [this$0_ appendWithCharArray:cbuf];
}

- (void)writeWithCharArray:(IOSCharArray *)cbuf
                   withInt:(jint)off
                   withInt:(jint)len {
  (void) [this$0_ appendWithCharArray:cbuf withInt:off withInt:len];
}

- (void)writeWithNSString:(NSString *)str {
  (void) [this$0_ appendWithNSString:str];
}

- (void)writeWithNSString:(NSString *)str
                  withInt:(jint)off
                  withInt:(jint)len {
  (void) [this$0_ appendWithNSString:str withInt:off withInt:len];
}
