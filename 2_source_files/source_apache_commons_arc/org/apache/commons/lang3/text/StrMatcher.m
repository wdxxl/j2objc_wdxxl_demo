...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TextStrMatcher class]) {
    OrgApacheCommonsLang3TextStrMatcher_COMMA_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_(',');
    OrgApacheCommonsLang3TextStrMatcher_TAB_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_(0x0009);
    OrgApacheCommonsLang3TextStrMatcher_SPACE_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_(' ');
    OrgApacheCommonsLang3TextStrMatcher_SPLIT_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_CharSetMatcher_initWithCharArray_([@" \t\n\x0d\x0c" java_toCharArray]);
    OrgApacheCommonsLang3TextStrMatcher_TRIM_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_TrimMatcher_init();
    OrgApacheCommonsLang3TextStrMatcher_SINGLE_QUOTE_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_('\'');
    OrgApacheCommonsLang3TextStrMatcher_DOUBLE_QUOTE_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_('"');
    OrgApacheCommonsLang3TextStrMatcher_QUOTE_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_CharSetMatcher_initWithCharArray_([@"'\"" java_toCharArray]);
    OrgApacheCommonsLang3TextStrMatcher_NONE_MATCHER = new_OrgApacheCommonsLang3TextStrMatcher_NoMatcher_init();
...
OrgApacheCommonsLang3TextStrMatcher *OrgApacheCommonsLang3TextStrMatcher_charMatcherWithChar_(jchar ch) {
  OrgApacheCommonsLang3TextStrMatcher_initialize();
  return new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_(ch);
}
...
OrgApacheCommonsLang3TextStrMatcher *OrgApacheCommonsLang3TextStrMatcher_charSetMatcherWithCharArray_(IOSCharArray *chars) {
  ...
  if (chars->size_ == 1) {
    return new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_(IOSCharArray_Get(chars, 0));
  }
  return new_OrgApacheCommonsLang3TextStrMatcher_CharSetMatcher_initWithCharArray_(chars);
}
...
OrgApacheCommonsLang3TextStrMatcher *OrgApacheCommonsLang3TextStrMatcher_charSetMatcherWithNSString_(NSString *chars) {
  ...
  if ([((NSString *) nil_chk(chars)) java_length] == 1) {
    return new_OrgApacheCommonsLang3TextStrMatcher_CharMatcher_initWithChar_([chars charAtWithInt:0]);
  }
  return new_OrgApacheCommonsLang3TextStrMatcher_CharSetMatcher_initWithCharArray_([chars java_toCharArray]);
}
...
OrgApacheCommonsLang3TextStrMatcher *OrgApacheCommonsLang3TextStrMatcher_stringMatcherWithNSString_(NSString *str) {
  ...
  return new_OrgApacheCommonsLang3TextStrMatcher_StringMatcher_initWithNSString_(str);
}
...
void OrgApacheCommonsLang3TextStrMatcher_CharSetMatcher_initWithCharArray_(OrgApacheCommonsLang3TextStrMatcher_CharSetMatcher *self, IOSCharArray *chars) {
  OrgApacheCommonsLang3TextStrMatcher_init(self);
  self->chars_ = [((IOSCharArray *) nil_chk(chars)) java_clone];
...
void OrgApacheCommonsLang3TextStrMatcher_StringMatcher_initWithNSString_(OrgApacheCommonsLang3TextStrMatcher_StringMatcher *self, NSString *str) {
  OrgApacheCommonsLang3TextStrMatcher_init(self);
  self->chars_ = [((NSString *) nil_chk(str)) java_toCharArray];
}
