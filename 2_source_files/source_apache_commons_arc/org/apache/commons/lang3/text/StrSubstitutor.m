...
- (NSString *)replaceWithNSString:(NSString *)source {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = new_OrgApacheCommonsLang3TextStrBuilder_initWithNSString_(source);
...
- (NSString *)replaceWithNSString:(NSString *)source
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(length) appendWithNSString:source withInt:offset withInt:length];
...
- (NSString *)replaceWithCharArray:(IOSCharArray *)source {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(source->size_) appendWithCharArray:source];
...
- (NSString *)replaceWithCharArray:(IOSCharArray *)source
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(length) appendWithCharArray:source withInt:offset withInt:length];
...
- (NSString *)replaceWithJavaLangStringBuffer:(JavaLangStringBuffer *)source {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_([source java_length]) appendWithJavaLangStringBuffer:source];
...
- (NSString *)replaceWithJavaLangStringBuffer:(JavaLangStringBuffer *)source
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(length) appendWithJavaLangStringBuffer:source withInt:offset withInt:length];
  [self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:length];
  return [((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) description];
}
...
- (NSString *)replaceWithJavaLangCharSequence:(id<JavaLangCharSequence>)source
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(length) appendWithJavaLangCharSequence:source withInt:offset withInt:length];
  [self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:length];
  return [((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) description];
}
...
- (NSString *)replaceWithOrgApacheCommonsLang3TextStrBuilder:(OrgApacheCommonsLang3TextStrBuilder *)source {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_([source java_length]) appendWithOrgApacheCommonsLang3TextStrBuilder:source];
  [self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:[((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) java_length]];
  return [buf description];
}
...
- (NSString *)replaceWithOrgApacheCommonsLang3TextStrBuilder:(OrgApacheCommonsLang3TextStrBuilder *)source
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(length) appendWithOrgApacheCommonsLang3TextStrBuilder:source withInt:offset withInt:length];
  [self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:length];
  return [((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) description];
}
...
- (NSString *)replaceWithId:(id)source {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_init() appendWithId:source];
  [self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:[((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) java_length]];
  return [buf description];
}
...
- (jboolean)replaceInWithJavaLangStringBuffer:(JavaLangStringBuffer *)source
  ...
  (void) [source replaceWithInt:offset withInt:offset + length withNSString:[((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) description]];
  return true;
}
...
- (jboolean)replaceInWithJavaLangStringBuilder:(JavaLangStringBuilder *)source
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(length) appendWithJavaLangStringBuilder:source withInt:offset withInt:length];
  if ([self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:length] == false) {
    return false;
  }
  (void) [source replaceWithInt:offset withInt:offset + length withNSString:[((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) description]];
...
- (OrgApacheCommonsLang3TextStrSubstitutor *)setVariablePrefixMatcherWithOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)prefixMatcher {
  if (prefixMatcher == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Variable prefix matcher must not be null!");
  }
  self->prefixMatcher_ = prefixMatcher;
  return self;
}
...
- (OrgApacheCommonsLang3TextStrSubstitutor *)setVariablePrefixWithNSString:(NSString *)prefix {
  if (prefix == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Variable prefix must not be null!");
  }
...
- (OrgApacheCommonsLang3TextStrSubstitutor *)setVariableSuffixMatcherWithOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)suffixMatcher {
  if (suffixMatcher == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Variable suffix matcher must not be null!");
  }
  self->suffixMatcher_ = suffixMatcher;
  return self;
}
...
- (OrgApacheCommonsLang3TextStrSubstitutor *)setVariableSuffixWithNSString:(NSString *)suffix {
  if (suffix == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Variable suffix must not be null!");
  }
...
- (OrgApacheCommonsLang3TextStrSubstitutor *)setValueDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)valueDelimiterMatcher {
  self->valueDelimiterMatcher_ = valueDelimiterMatcher;
  return self;
}
...
- (OrgApacheCommonsLang3TextStrSubstitutor *)setValueDelimiterWithNSString:(NSString *)valueDelimiter {
  if (OrgApacheCommonsLang3StringUtils_isEmptyWithJavaLangCharSequence_(valueDelimiter)) {
    (void) [self setValueDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:nil];
    return self;
  }
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TextStrSubstitutor class]) {
    OrgApacheCommonsLang3TextStrSubstitutor_DEFAULT_PREFIX = OrgApacheCommonsLang3TextStrMatcher_stringMatcherWithNSString_(@"${");
    OrgApacheCommonsLang3TextStrSubstitutor_DEFAULT_SUFFIX = OrgApacheCommonsLang3TextStrMatcher_stringMatcherWithNSString_(@"}");
    OrgApacheCommonsLang3TextStrSubstitutor_DEFAULT_VALUE_DELIMITER = OrgApacheCommonsLang3TextStrMatcher_stringMatcherWithNSString_(@":-");
...
NSString *OrgApacheCommonsLang3TextStrSubstitutor_replaceWithId_withJavaUtilMap_(id source, id<JavaUtilMap> valueMap) {
  ...
  return [new_OrgApacheCommonsLang3TextStrSubstitutor_initWithJavaUtilMap_(valueMap) replaceWithId:source];
}
...
NSString *OrgApacheCommonsLang3TextStrSubstitutor_replaceWithId_withJavaUtilMap_withNSString_withNSString_(id source, id<JavaUtilMap> valueMap, NSString *prefix, NSString *suffix) {
  OrgApacheCommonsLang3TextStrSubstitutor_initialize();
  return [new_OrgApacheCommonsLang3TextStrSubstitutor_initWithJavaUtilMap_withNSString_withNSString_(valueMap, prefix, suffix) replaceWithId:source];
}
...
NSString *OrgApacheCommonsLang3TextStrSubstitutor_replaceWithId_withJavaUtilProperties_(id source, JavaUtilProperties *valueProperties) {
  ...
  while ([((id<JavaUtilEnumeration>) nil_chk(propNames)) hasMoreElements]) {
    ...
    (void) [valueMap putWithId:propName withId:propValue];
  }
  return OrgApacheCommonsLang3TextStrSubstitutor_replaceWithId_withJavaUtilMap_(source, valueMap);
}
...
NSString *OrgApacheCommonsLang3TextStrSubstitutor_replaceSystemPropertiesWithId_(id source) {
  OrgApacheCommonsLang3TextStrSubstitutor_initialize();
  return [new_OrgApacheCommonsLang3TextStrSubstitutor_initWithOrgApacheCommonsLang3TextStrLookup_(OrgApacheCommonsLang3TextStrLookup_systemPropertiesLookup()) replaceWithId:source];
}
...
void OrgApacheCommonsLang3TextStrSubstitutor_initWithOrgApacheCommonsLang3TextStrLookup_withNSString_withNSString_withChar_(OrgApacheCommonsLang3TextStrSubstitutor *self, OrgApacheCommonsLang3TextStrLookup *variableResolver, NSString *prefix, NSString *suffix, jchar escape) {
  ...
  (void) [self setVariablePrefixWithNSString:prefix];
  (void) [self setVariableSuffixWithNSString:suffix];
  [self setEscapeCharWithChar:escape];
  (void) [self setValueDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrSubstitutor_DEFAULT_VALUE_DELIMITER];
}
...
void OrgApacheCommonsLang3TextStrSubstitutor_initWithOrgApacheCommonsLang3TextStrLookup_withNSString_withNSString_withChar_withNSString_(OrgApacheCommonsLang3TextStrSubstitutor *self, OrgApacheCommonsLang3TextStrLookup *variableResolver, NSString *prefix, NSString *suffix, jchar escape, NSString *valueDelimiter) {
  ...
  (void) [self setVariableSuffixWithNSString:suffix];
  [self setEscapeCharWithChar:escape];
  (void) [self setValueDelimiterWithNSString:valueDelimiter];
}
...
void OrgApacheCommonsLang3TextStrSubstitutor_initWithOrgApacheCommonsLang3TextStrLookup_withOrgApacheCommonsLang3TextStrMatcher_withOrgApacheCommonsLang3TextStrMatcher_withChar_withOrgApacheCommonsLang3TextStrMatcher_(OrgApacheCommonsLang3TextStrSubstitutor *self, OrgApacheCommonsLang3TextStrLookup *variableResolver, OrgApacheCommonsLang3TextStrMatcher *prefixMatcher, OrgApacheCommonsLang3TextStrMatcher *suffixMatcher, jchar escape, OrgApacheCommonsLang3TextStrMatcher *valueDelimiterMatcher) {
  NSObject_init(self);
  [self setVariableResolverWithOrgApacheCommonsLang3TextStrLookup:variableResolver];
  (void) [self setVariablePrefixMatcherWithOrgApacheCommonsLang3TextStrMatcher:prefixMatcher];
  (void) [self setVariableSuffixMatcherWithOrgApacheCommonsLang3TextStrMatcher:suffixMatcher];
  [self setEscapeCharWithChar:escape];
  (void) [self setValueDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:valueDelimiterMatcher];
}
  ...
  while (pos < bufEnd) {
    ...
    if (startMatchLen == 0) {
      ...
      if (pos > offset && IOSCharArray_Get(nil_chk(chars), pos - 1) == escape) {
        (void) [buf deleteCharAtWithInt:pos - 1];
        chars = buf->buffer_;
        lengthChange--;
        altered = true;
        bufEnd--;
          ...
          if (endMatchLen == 0) {
            ...
            if (nestedVarCount == 0) {
              ...
              if (substitutionInVariablesEnabled) {
                OrgApacheCommonsLang3TextStrBuilder *bufName = new_OrgApacheCommonsLang3TextStrBuilder_initWithNSString_(varNameExpr);
              ...
              if (varValue != nil) {
                ...
                (void) [buf replaceWithInt:startPos withInt:endPos withNSString:varValue];
                altered = true;
...
void OrgApacheCommonsLang3TextStrSubstitutor_checkCyclicSubstitutionWithNSString_withJavaUtilList_(OrgApacheCommonsLang3TextStrSubstitutor *self, NSString *varName, id<JavaUtilList> priorVariables) {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = new_OrgApacheCommonsLang3TextStrBuilder_initWithInt_(256);
  (void) [buf appendWithNSString:@"Infinite loop in property interpolation of "];
  (void) [buf appendWithNSString:[priorVariables removeWithInt:0]];
  (void) [buf appendWithNSString:@": "];
  (void) [buf appendWithSeparatorsWithJavaLangIterable:priorVariables withNSString:@"->"];
  @throw new_JavaLangIllegalStateException_initWithNSString_([buf description]);
}
