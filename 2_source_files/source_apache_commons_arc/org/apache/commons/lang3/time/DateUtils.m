...
inline IOSObjectArray *OrgApacheCommonsLang3TimeDateUtils_get_fields(void);
...
@interface OrgApacheCommonsLang3TimeDateUtils_ModifyType : JavaLangEnum
...
inline OrgApacheCommonsLang3TimeDateUtils_ModifyType *OrgApacheCommonsLang3TimeDateUtils_ModifyType_get_TRUNCATE(void);
J2OBJC_ENUM_CONSTANT(OrgApacheCommonsLang3TimeDateUtils_ModifyType, TRUNCATE)

inline OrgApacheCommonsLang3TimeDateUtils_ModifyType *OrgApacheCommonsLang3TimeDateUtils_ModifyType_get_ROUND(void);
J2OBJC_ENUM_CONSTANT(OrgApacheCommonsLang3TimeDateUtils_ModifyType, ROUND)

inline OrgApacheCommonsLang3TimeDateUtils_ModifyType *OrgApacheCommonsLang3TimeDateUtils_ModifyType_get_CEILING(void);
...
__attribute__((unused)) static IOSObjectArray *OrgApacheCommonsLang3TimeDateUtils_ModifyType_values(void);
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeDateUtils_ModifyType class]) {
    JreEnum(OrgApacheCommonsLang3TimeDateUtils_ModifyType, TRUNCATE) = new_OrgApacheCommonsLang3TimeDateUtils_ModifyType_initWithNSString_withInt_(@"", 0);
    JreEnum(OrgApacheCommonsLang3TimeDateUtils_ModifyType, ROUND) = new_OrgApacheCommonsLang3TimeDateUtils_ModifyType_initWithNSString_withInt_(@"", 1);
    JreEnum(OrgApacheCommonsLang3TimeDateUtils_ModifyType, CEILING) = new_OrgApacheCommonsLang3TimeDateUtils_ModifyType_initWithNSString_withInt_(@"", 2);
