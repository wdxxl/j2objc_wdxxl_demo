...
inline JavaUtilRegexPattern *OrgApacheCommonsLang3TimeFastDateParser_get_formatPattern();
...
inline OrgApacheCommonsLang3TimeFastDateParser_Strategy *OrgApacheCommonsLang3TimeFastDateParser_get_ISO_8601_STRATEGY();
...
inline jint OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_get_LONG_STD();
...
inline jint OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_get_SHORT_STD();
...
inline jint OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_get_LONG_DST();
...
inline jint OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_get_SHORT_DST();
...
- (JavaUtilDate *)parseWithNSString:(NSString *)source {
  JavaUtilDate *date = [self parseWithNSString:source withJavaTextParsePosition:new_JavaTextParsePosition_initWithInt_(0)];
  if (date == nil) {
    if ([((JavaUtilLocale *) nil_chk(locale_)) isEqual:OrgApacheCommonsLang3TimeFastDateParser_JAPANESE_IMPERIAL]) {
      @throw new_JavaTextParseException_initWithNSString_withInt_(JreStrcat("$@$$$$", @"(The ", locale_, @" locale does not support dates before 1868 AD)\nUnparseable date: \"", source, @"\" does not match ", [((JavaUtilRegexPattern *) nil_chk(parsePattern_)) pattern]), 0);
    }
    @throw new_JavaTextParseException_initWithNSString_withInt_(JreStrcat("$$$$", @"Unparseable date: \"", source, @"\" does not match ", [((JavaUtilRegexPattern *) nil_chk(parsePattern_)) pattern]), 0);
  }
  return date;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDateParser class]) {
    OrgApacheCommonsLang3TimeFastDateParser_JAPANESE_IMPERIAL = new_JavaUtilLocale_initWithNSString_withNSString_withNSString_(@"ja", @"JP", @"JP");
    OrgApacheCommonsLang3TimeFastDateParser_formatPattern = JavaUtilRegexPattern_compileWithNSString_(@"D+|E+|F+|G+|H+|K+|M+|S+|W+|X+|Z+|a+|d+|h+|k+|m+|s+|w+|y+|z+|''|'[^']++(''[^']*+)*+'|[^'A-Za-z]++");
    OrgApacheCommonsLang3TimeFastDateParser_caches = [IOSObjectArray newArrayWithLength:JavaUtilCalendar_FIELD_COUNT type:JavaUtilConcurrentConcurrentMap_class_()];
    OrgApacheCommonsLang3TimeFastDateParser_ABBREVIATED_YEAR_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_1_initWithInt_(JavaUtilCalendar_YEAR);
    OrgApacheCommonsLang3TimeFastDateParser_NUMBER_MONTH_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_2_initWithInt_(JavaUtilCalendar_MONTH);
    OrgApacheCommonsLang3TimeFastDateParser_LITERAL_YEAR_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_YEAR);
    OrgApacheCommonsLang3TimeFastDateParser_WEEK_OF_YEAR_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_WEEK_OF_YEAR);
    OrgApacheCommonsLang3TimeFastDateParser_WEEK_OF_MONTH_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_WEEK_OF_MONTH);
    OrgApacheCommonsLang3TimeFastDateParser_DAY_OF_YEAR_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_DAY_OF_YEAR);
    OrgApacheCommonsLang3TimeFastDateParser_DAY_OF_MONTH_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_DAY_OF_MONTH);
    OrgApacheCommonsLang3TimeFastDateParser_DAY_OF_WEEK_IN_MONTH_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_DAY_OF_WEEK_IN_MONTH);
    OrgApacheCommonsLang3TimeFastDateParser_HOUR_OF_DAY_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_HOUR_OF_DAY);
    OrgApacheCommonsLang3TimeFastDateParser_HOUR24_OF_DAY_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_3_initWithInt_(JavaUtilCalendar_HOUR_OF_DAY);
    OrgApacheCommonsLang3TimeFastDateParser_HOUR12_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_4_initWithInt_(JavaUtilCalendar_HOUR);
    OrgApacheCommonsLang3TimeFastDateParser_HOUR_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_HOUR);
    OrgApacheCommonsLang3TimeFastDateParser_MINUTE_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_MINUTE);
    OrgApacheCommonsLang3TimeFastDateParser_SECOND_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_SECOND);
    OrgApacheCommonsLang3TimeFastDateParser_MILLISECOND_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_NumberStrategy_initWithInt_(JavaUtilCalendar_MILLISECOND);
    OrgApacheCommonsLang3TimeFastDateParser_ISO_8601_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_initWithNSString_(@"(Z|(?:[+-]\\d{2}(?::?\\d{2})?))");
...
void OrgApacheCommonsLang3TimeFastDateParser_initWithNSString_withJavaUtilTimeZone_withJavaUtilLocale_withJavaUtilDate_(OrgApacheCommonsLang3TimeFastDateParser *self, NSString *pattern, JavaUtilTimeZone *timeZone, JavaUtilLocale *locale, JavaUtilDate *centuryStart) {
  ...
  if (centuryStart != nil) {
    ...
    [((JavaUtilCalendar *) nil_chk(definingCalendar)) setTimeWithJavaUtilDate:new_JavaUtilDate_init()];
...
void OrgApacheCommonsLang3TimeFastDateParser_init__WithJavaUtilCalendar_(OrgApacheCommonsLang3TimeFastDateParser *self, JavaUtilCalendar *definingCalendar) {
  ...
  id<JavaUtilList> collector = new_JavaUtilArrayList_init();
  ...
  if (![((JavaUtilRegexMatcher *) nil_chk(patternMatcher)) lookingAt]) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$CC", @"Illegal pattern character '", [((NSString *) nil_chk(self->pattern_)) charAtWithInt:[patternMatcher regionStart]], '\''));
  }
  self->currentFormatField_ = [patternMatcher group];
  ...
  for (; ; ) {
    (void) [patternMatcher regionWithInt:[patternMatcher end] withInt:[patternMatcher regionEnd]];
    if (![patternMatcher lookingAt]) {
      self->nextStrategy_ = nil;
      break;
    }
    NSString *nextFormatField = [patternMatcher group];
    self->nextStrategy_ = OrgApacheCommonsLang3TimeFastDateParser_getStrategyWithNSString_withJavaUtilCalendar_(self, nextFormatField, definingCalendar);
    ...
    self->currentFormatField_ = nextFormatField;
    currentStrategy = self->nextStrategy_;
  }
  if ([patternMatcher regionStart] != [patternMatcher regionEnd]) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$I", @"Failed to parse \"", self->pattern_, @"\" ; gave up at index ", [patternMatcher regionStart]));
  }
  if ([((OrgApacheCommonsLang3TimeFastDateParser_Strategy *) nil_chk(currentStrategy)) addRegexWithOrgApacheCommonsLang3TimeFastDateParser:self withJavaLangStringBuilder:regex]) {
    [collector addWithId:currentStrategy];
  }
  self->currentFormatField_ = nil;
  self->strategies_ = [collector toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[collector size] type:OrgApacheCommonsLang3TimeFastDateParser_Strategy_class_()]];
  self->parsePattern_ = JavaUtilRegexPattern_compileWithNSString_([regex description]);
}
...
JavaLangStringBuilder *OrgApacheCommonsLang3TimeFastDateParser_escapeRegexWithJavaLangStringBuilder_withNSString_withBoolean_(JavaLangStringBuilder *regex, NSString *value, jboolean unquote) {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(regex)) appendWithNSString:@"\\Q"];
  for (jint i = 0; i < [((NSString *) nil_chk(value)) java_length]; ++i) {
    ...
    switch (c) {
      ...
      (void) [regex appendWithChar:c];
      c = [value charAtWithInt:i];
      if (c == 'E') {
        (void) [regex appendWithNSString:@"E\\\\E\\"];
        c = 'Q';
      }
      break;
      default:
  ...
  (void) [regex appendWithNSString:@"\\E"];
  return regex;
}
...
OrgApacheCommonsLang3TimeFastDateParser_Strategy *OrgApacheCommonsLang3TimeFastDateParser_getStrategyWithNSString_withJavaUtilCalendar_(OrgApacheCommonsLang3TimeFastDateParser *self, NSString *formatField, JavaUtilCalendar *definingCalendar) {
  switch ([((NSString *) nil_chk(formatField)) charAtWithInt:0]) {
    ...
    if ([formatField java_length] > 2) {
      return new_OrgApacheCommonsLang3TimeFastDateParser_CopyQuotedStrategy_initWithNSString_([formatField java_substring:1 endIndex:[formatField java_length] - 1]);
    }
    default:
    return new_OrgApacheCommonsLang3TimeFastDateParser_CopyQuotedStrategy_initWithNSString_(formatField);
    case 'D':
...
id<JavaUtilConcurrentConcurrentMap> OrgApacheCommonsLang3TimeFastDateParser_getCacheWithInt_(jint field) {
  ...
  @synchronized(OrgApacheCommonsLang3TimeFastDateParser_caches) {
    if (IOSObjectArray_Get(nil_chk(OrgApacheCommonsLang3TimeFastDateParser_caches), field) == nil) {
      (void) IOSObjectArray_SetAndConsume(OrgApacheCommonsLang3TimeFastDateParser_caches, field, new_JavaUtilConcurrentConcurrentHashMap_initWithInt_(3));
    }
...
OrgApacheCommonsLang3TimeFastDateParser_Strategy *OrgApacheCommonsLang3TimeFastDateParser_getLocaleSpecificStrategyWithInt_withJavaUtilCalendar_(OrgApacheCommonsLang3TimeFastDateParser *self, jint field, JavaUtilCalendar *definingCalendar) {
  ...
  if (strategy == nil) {
    strategy = field == JavaUtilCalendar_ZONE_OFFSET ? new_OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_initWithJavaUtilLocale_(self->locale_) : (id) new_OrgApacheCommonsLang3TimeFastDateParser_CaseInsensitiveTextStrategy_initWithInt_withJavaUtilCalendar_withJavaUtilLocale_(field, definingCalendar, self->locale_);
...
- (jboolean)addRegexWithOrgApacheCommonsLang3TimeFastDateParser:(OrgApacheCommonsLang3TimeFastDateParser *)parser
                                      withJavaLangStringBuilder:(JavaLangStringBuilder *)regex {
  (void) OrgApacheCommonsLang3TimeFastDateParser_escapeRegexWithJavaLangStringBuilder_withNSString_withBoolean_(regex, formatField_, true);
  return false;
}
...
- (jboolean)addRegexWithOrgApacheCommonsLang3TimeFastDateParser:(OrgApacheCommonsLang3TimeFastDateParser *)parser
                                      withJavaLangStringBuilder:(JavaLangStringBuilder *)regex {
  (void) [((JavaLangStringBuilder *) nil_chk(regex)) appendWithNSString:@"((?iu)"];
  for (NSString * __strong textKeyValue in nil_chk([((id<JavaUtilMap>) nil_chk(lKeyValues_)) keySet])) {
    (void) [((JavaLangStringBuilder *) nil_chk(OrgApacheCommonsLang3TimeFastDateParser_escapeRegexWithJavaLangStringBuilder_withNSString_withBoolean_(regex, textKeyValue, false))) appendWithChar:'|'];
  }
...
- (void)setCalendarWithOrgApacheCommonsLang3TimeFastDateParser:(OrgApacheCommonsLang3TimeFastDateParser *)parser
  ...
  if (iVal == nil) {
    JavaLangStringBuilder *sb = new_JavaLangStringBuilder_initWithNSString_(value);
    (void) [sb appendWithNSString:@" not in ("];
    for (NSString * __strong textKeyValue in nil_chk([lKeyValues_ keySet])) {
      (void) [((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:textKeyValue])) appendWithChar:' '];
    }
...
void OrgApacheCommonsLang3TimeFastDateParser_CaseInsensitiveTextStrategy_initWithInt_withJavaUtilCalendar_withJavaUtilLocale_(OrgApacheCommonsLang3TimeFastDateParser_CaseInsensitiveTextStrategy *self, jint field, JavaUtilCalendar *definingCalendar, JavaUtilLocale *locale) {
  ...
  self->lKeyValues_ = new_JavaUtilHashMap_init();
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(keyValues)) entrySet])) {
    (void) [self->lKeyValues_ putWithId:[((NSString *) nil_chk([((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey])) java_lowercaseStringWithJRELocale:locale] withId:[entry_ getValue]];
  }
}
...
- (jboolean)addRegexWithOrgApacheCommonsLang3TimeFastDateParser:(OrgApacheCommonsLang3TimeFastDateParser *)parser
  ...
  if ([((OrgApacheCommonsLang3TimeFastDateParser *) nil_chk(parser)) isNextNumber]) {
    (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(regex)) appendWithNSString:@"(\\p{Nd}{"])) appendWithInt:[parser getFieldWidth]])) appendWithNSString:@"}+)"];
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(regex)) appendWithNSString:@"(\\p{Nd}++)"];
  }
  return true;
}
...
- (jboolean)addRegexWithOrgApacheCommonsLang3TimeFastDateParser:(OrgApacheCommonsLang3TimeFastDateParser *)parser
                                      withJavaLangStringBuilder:(JavaLangStringBuilder *)regex {
  (void) [((JavaLangStringBuilder *) nil_chk(regex)) appendWithNSString:validTimeZoneChars_];
  return true;
}
...
- (void)setCalendarWithOrgApacheCommonsLang3TimeFastDateParser:(OrgApacheCommonsLang3TimeFastDateParser *)parser
  ...
  if ([((NSString *) nil_chk(value)) charAtWithInt:0] == '+' || [value charAtWithInt:0] == '-') {
    ...
    if (tz == nil) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", value, @" is not a supported timezone name"));
    }
  }
...
void OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_initWithJavaUtilLocale_(OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy *self, JavaUtilLocale *locale) {
  OrgApacheCommonsLang3TimeFastDateParser_Strategy_init(self);
  self->tzNames_ = new_JavaUtilTreeMap_initWithJavaUtilComparator_(JreLoadStatic(NSString, CASE_INSENSITIVE_ORDER));
  IOSObjectArray *zones = [((JavaTextDateFormatSymbols *) nil_chk(JavaTextDateFormatSymbols_getInstanceWithJavaUtilLocale_(locale))) getZoneStrings];
  {
    ...
    while (b__ < e__) {
      ...
      if (![self->tzNames_ containsKeyWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_LONG_STD)]) {
        (void) [self->tzNames_ putWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_LONG_STD) withId:tz];
      }
      if (![self->tzNames_ containsKeyWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_SHORT_STD)]) {
        (void) [self->tzNames_ putWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_SHORT_STD) withId:tz];
      }
      if ([((JavaUtilTimeZone *) nil_chk(tz)) useDaylightTime]) {
        if (![self->tzNames_ containsKeyWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_LONG_DST)]) {
          (void) [self->tzNames_ putWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_LONG_DST) withId:tz];
        }
        if (![self->tzNames_ containsKeyWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_SHORT_DST)]) {
          (void) [self->tzNames_ putWithId:IOSObjectArray_Get(zone, OrgApacheCommonsLang3TimeFastDateParser_TimeZoneStrategy_SHORT_DST) withId:tz];
        }
      }
    }
  }
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"(GMT[+-]\\d{1,2}:\\d{2}"])) appendWithChar:'|'];
  (void) [((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"[+-]\\d{4}"])) appendWithChar:'|'];
  for (NSString * __strong id_ in nil_chk([self->tzNames_ keySet])) {
    (void) [((JavaLangStringBuilder *) nil_chk(OrgApacheCommonsLang3TimeFastDateParser_escapeRegexWithJavaLangStringBuilder_withNSString_withBoolean_(sb, id_, false))) appendWithChar:'|'];
  }
  [sb setCharAtWithInt:[sb java_length] - 1 withChar:')'];
  self->validTimeZoneChars_ = [sb description];
}
...
- (jboolean)addRegexWithOrgApacheCommonsLang3TimeFastDateParser:(OrgApacheCommonsLang3TimeFastDateParser *)parser
                                      withJavaLangStringBuilder:(JavaLangStringBuilder *)regex {
  (void) [((JavaLangStringBuilder *) nil_chk(regex)) appendWithNSString:pattern_];
  return true;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy class]) {
    OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_ISO_8601_1_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_initWithNSString_(@"(Z|(?:[+-]\\d{2}))");
    OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_ISO_8601_2_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_initWithNSString_(@"(Z|(?:[+-]\\d{2}\\d{2}))");
    OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_ISO_8601_3_STRATEGY = new_OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_initWithNSString_(@"(Z|(?:[+-]\\d{2}(?::)\\d{2}))");
...
OrgApacheCommonsLang3TimeFastDateParser_Strategy *OrgApacheCommonsLang3TimeFastDateParser_ISO8601TimeZoneStrategy_getStrategyWithInt_(jint tokenLen) {
  ...
  switch (tokenLen) {
    ...
    default:
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"invalid number of X");
  }
}
