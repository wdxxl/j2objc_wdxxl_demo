...
inline jint OrgApacheCommonsLang3TimeFastDatePrinter_get_FULL(void);
...
inline jint OrgApacheCommonsLang3TimeFastDatePrinter_get_LONG(void);
...
inline jint OrgApacheCommonsLang3TimeFastDatePrinter_get_MEDIUM(void);
...
inline jint OrgApacheCommonsLang3TimeFastDatePrinter_get_SHORT(void);
