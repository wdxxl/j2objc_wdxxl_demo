...
inline OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule *OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule_get_INSTANCE_ISO_8601();
...
- (id<JavaUtilList>)parsePattern {
  JavaTextDateFormatSymbols *symbols = new_JavaTextDateFormatSymbols_initWithJavaUtilLocale_(mLocale_);
  ...
  for (jint i = 0; i < length; i++) {
    *IOSIntArray_GetRef(indexRef, 0) = i;
    ...
    jchar c = [token charAtWithInt:0];
    {
      ...
      switch (c) {
        case 'G':
        rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TextField_initWithInt_withNSStringArray_(JavaUtilCalendar_ERA, ERAs);
        break;
        case 'y':
        if (tokenLen == 2) {
        ...
        case 'M':
        if (tokenLen >= 4) {
          rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TextField_initWithInt_withNSStringArray_(JavaUtilCalendar_MONTH, months);
        }
        else if (tokenLen == 3) {
          rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TextField_initWithInt_withNSStringArray_(JavaUtilCalendar_MONTH, shortMonths);
        }
        else if (tokenLen == 2) {
        ...
        break;
        case 'h':
        rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TwelveHourField_initWithOrgApacheCommonsLang3TimeFastDatePrinter_NumberRule_([self selectNumberRuleWithInt:JavaUtilCalendar_HOUR withInt:tokenLen]);
        break;
        case 'H':
        ...
        break;
        case 'E':
        rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TextField_initWithInt_withNSStringArray_(JavaUtilCalendar_DAY_OF_WEEK, tokenLen < 4 ? shortWeekdays : weekdays);
        break;
        case 'D':
        ...
        break;
        case 'a':
        rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TextField_initWithInt_withNSStringArray_(JavaUtilCalendar_AM_PM, AmPmStrings);
        break;
        case 'k':
        rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TwentyFourHourField_initWithOrgApacheCommonsLang3TimeFastDatePrinter_NumberRule_([self selectNumberRuleWithInt:JavaUtilCalendar_HOUR_OF_DAY withInt:tokenLen]);
        break;
        case 'K':
        ...
        case 'z':
        if (tokenLen >= 4) {
          rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNameRule_initWithJavaUtilTimeZone_withJavaUtilLocale_withInt_(mTimeZone_, mLocale_, JavaUtilTimeZone_LONG);
        }
        else {
          rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNameRule_initWithJavaUtilTimeZone_withJavaUtilLocale_withInt_(mTimeZone_, mLocale_, JavaUtilTimeZone_SHORT);
        }
        break;
        case 'Z':
        if (tokenLen == 1) {
        ...
        if ([((NSString *) nil_chk(sub)) java_length] == 1) {
          rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_CharacterLiteral_initWithChar_([sub charAtWithInt:0]);
        }
        else {
          rule = new_OrgApacheCommonsLang3TimeFastDatePrinter_StringLiteral_initWithNSString_(sub);
        }
        break;
        default:
...
- (id<OrgApacheCommonsLang3TimeFastDatePrinter_NumberRule>)selectNumberRuleWithInt:(jint)field
  ...
  switch (padding) {
    case 1:
    return new_OrgApacheCommonsLang3TimeFastDatePrinter_UnpaddedNumberField_initWithInt_(field);
    case 2:
    return new_OrgApacheCommonsLang3TimeFastDatePrinter_TwoDigitNumberField_initWithInt_(field);
    default:
    return new_OrgApacheCommonsLang3TimeFastDatePrinter_PaddedNumberField_initWithInt_withInt_(field, padding);
  }
}
...
- (JavaLangStringBuffer *)formatWithId:(id)obj
  ...
  if ([obj isKindOfClass:[JavaUtilDate class]]) {
    ...
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Unknown class: ", (obj == nil ? @"<null>" : [[obj java_getClass] getName])));
  }
}
...
- (NSString *)formatWithJavaUtilCalendar:(JavaUtilCalendar *)calendar {
  return [((JavaLangStringBuffer *) nil_chk([self formatWithJavaUtilCalendar:calendar withJavaLangStringBuffer:new_JavaLangStringBuffer_initWithInt_(mMaxLengthEstimate_)])) description];
}

- (JavaLangStringBuffer *)formatWithLong:(jlong)millis
                withJavaLangStringBuffer:(JavaLangStringBuffer *)buf {
  return [self formatWithJavaUtilDate:new_JavaUtilDate_initWithLong_(millis) withJavaLangStringBuffer:buf];
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDatePrinter class]) {
    OrgApacheCommonsLang3TimeFastDatePrinter_cTimeZoneDisplayCache = new_JavaUtilConcurrentConcurrentHashMap_initWithInt_(7);
...
void OrgApacheCommonsLang3TimeFastDatePrinter_initWithNSString_withJavaUtilTimeZone_withJavaUtilLocale_(OrgApacheCommonsLang3TimeFastDatePrinter *self, NSString *pattern, JavaUtilTimeZone *timeZone, JavaUtilLocale *locale) {
  NSObject_init(self);
  self->mPattern_ = pattern;
  self->mTimeZone_ = timeZone;
...
void OrgApacheCommonsLang3TimeFastDatePrinter_init__(OrgApacheCommonsLang3TimeFastDatePrinter *self) {
  ...
  self->mRules_ = [((id<JavaUtilList>) nil_chk(rulesList)) toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[rulesList size] type:OrgApacheCommonsLang3TimeFastDatePrinter_Rule_class_()]];
  jint len = 0;
...
NSString *OrgApacheCommonsLang3TimeFastDatePrinter_applyRulesToStringWithJavaUtilCalendar_(OrgApacheCommonsLang3TimeFastDatePrinter *self, JavaUtilCalendar *c) {
  return [((JavaLangStringBuffer *) nil_chk([self applyRulesWithJavaUtilCalendar:c withJavaLangStringBuffer:new_JavaLangStringBuffer_initWithInt_(self->mMaxLengthEstimate_)])) description];
}
...
JavaUtilGregorianCalendar *OrgApacheCommonsLang3TimeFastDatePrinter_newCalendar(OrgApacheCommonsLang3TimeFastDatePrinter *self) {
  return new_JavaUtilGregorianCalendar_initWithJavaUtilTimeZone_withJavaUtilLocale_(self->mTimeZone_, self->mLocale_);
}
...
void OrgApacheCommonsLang3TimeFastDatePrinter_appendDigitsWithJavaLangStringBuffer_withInt_(JavaLangStringBuffer *buffer, jint value) {
  ...
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithChar:(jchar) (value / 10 + '0')];
  (void) [buffer appendWithChar:(jchar) (value % 10 + '0')];
}
...
NSString *OrgApacheCommonsLang3TimeFastDatePrinter_getTimeZoneDisplayWithJavaUtilTimeZone_withBoolean_withInt_withJavaUtilLocale_(JavaUtilTimeZone *tz, jboolean daylight_, jint style, JavaUtilLocale *locale) {
  OrgApacheCommonsLang3TimeFastDatePrinter_initialize();
  OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneDisplayKey *key = new_OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneDisplayKey_initWithJavaUtilTimeZone_withBoolean_withInt_withJavaUtilLocale_(tz, daylight_, style, locale);
...
- (void)appendToWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                    withJavaUtilCalendar:(JavaUtilCalendar *)calendar {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithChar:mValue_];
}
...
- (void)appendToWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                    withJavaUtilCalendar:(JavaUtilCalendar *)calendar {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:mValue_];
}
...
- (void)appendToWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                    withJavaUtilCalendar:(JavaUtilCalendar *)calendar {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:IOSObjectArray_Get(nil_chk(mValues_), [((JavaUtilCalendar *) nil_chk(calendar)) getWithInt:mField_])];
}
...
void OrgApacheCommonsLang3TimeFastDatePrinter_UnpaddedNumberField_appendToWithJavaLangStringBuffer_withInt_(OrgApacheCommonsLang3TimeFastDatePrinter_UnpaddedNumberField *self, JavaLangStringBuffer *buffer, jint value) {
  if (value < 10) {
    (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithChar:(jchar) (value + '0')];
  }
  else if (value < 100) {
    OrgApacheCommonsLang3TimeFastDatePrinter_appendDigitsWithJavaLangStringBuffer_withInt_(buffer, value);
  }
  else {
    (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithInt:value];
  }
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDatePrinter_UnpaddedMonthField class]) {
    OrgApacheCommonsLang3TimeFastDatePrinter_UnpaddedMonthField_INSTANCE = new_OrgApacheCommonsLang3TimeFastDatePrinter_UnpaddedMonthField_init();
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDatePrinter_TwoDigitYearField class]) {
    OrgApacheCommonsLang3TimeFastDatePrinter_TwoDigitYearField_INSTANCE = new_OrgApacheCommonsLang3TimeFastDatePrinter_TwoDigitYearField_init();
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDatePrinter_TwoDigitMonthField class]) {
    OrgApacheCommonsLang3TimeFastDatePrinter_TwoDigitMonthField_INSTANCE = new_OrgApacheCommonsLang3TimeFastDatePrinter_TwoDigitMonthField_init();
...
- (void)appendToWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
  ...
  if ([calendar getWithInt:JavaUtilCalendar_DST_OFFSET] != 0) {
    (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:OrgApacheCommonsLang3TimeFastDatePrinter_getTimeZoneDisplayWithJavaUtilTimeZone_withBoolean_withInt_withJavaUtilLocale_(zone, true, mStyle_, mLocale_)];
  }
  else {
    (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:OrgApacheCommonsLang3TimeFastDatePrinter_getTimeZoneDisplayWithJavaUtilTimeZone_withBoolean_withInt_withJavaUtilLocale_(zone, false, mStyle_, mLocale_)];
  }
}
...
void OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNameRule_initWithJavaUtilTimeZone_withJavaUtilLocale_withInt_(OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNameRule *self, JavaUtilTimeZone *timeZone, JavaUtilLocale *locale, jint style) {
  ...
  self->mLocale_ = locale;
  self->mStyle_ = style;
  self->mStandard_ = OrgApacheCommonsLang3TimeFastDatePrinter_getTimeZoneDisplayWithJavaUtilTimeZone_withBoolean_withInt_withJavaUtilLocale_(timeZone, false, style, locale);
  self->mDaylight_ = OrgApacheCommonsLang3TimeFastDatePrinter_getTimeZoneDisplayWithJavaUtilTimeZone_withBoolean_withInt_withJavaUtilLocale_(timeZone, true, style, locale);
}
...
- (void)appendToWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
  ...
  if (mISO8601_ && [((NSString *) nil_chk([((JavaUtilTimeZone *) nil_chk([((JavaUtilCalendar *) nil_chk(calendar)) getTimeZone])) getID])) isEqual:@"UTC"]) {
    (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:@"Z"];
    return;
  }
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule class]) {
    OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule_INSTANCE_COLON = new_OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule_initWithBoolean_withBoolean_(true, false);
    OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule_INSTANCE_NO_COLON = new_OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule_initWithBoolean_withBoolean_(false, false);
    OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule_INSTANCE_ISO_8601 = new_OrgApacheCommonsLang3TimeFastDatePrinter_TimeZoneNumberRule_initWithBoolean_withBoolean_(true, true);
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFastDatePrinter_Iso8601_Rule class]) {
    OrgApacheCommonsLang3TimeFastDatePrinter_Iso8601_Rule_ISO8601_HOURS = new_OrgApacheCommonsLang3TimeFastDatePrinter_Iso8601_Rule_initWithInt_(3);
    OrgApacheCommonsLang3TimeFastDatePrinter_Iso8601_Rule_ISO8601_HOURS_MINUTES = new_OrgApacheCommonsLang3TimeFastDatePrinter_Iso8601_Rule_initWithInt_(5);
    OrgApacheCommonsLang3TimeFastDatePrinter_Iso8601_Rule_ISO8601_HOURS_COLON_MINUTES = new_OrgApacheCommonsLang3TimeFastDatePrinter_Iso8601_Rule_initWithInt_(6);
