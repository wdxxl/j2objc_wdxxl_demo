...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3AnnotationUtils class]) {
    OrgApacheCommonsLang3AnnotationUtils_TO_STRING_STYLE = new_OrgApacheCommonsLang3AnnotationUtils_1_init();
...
jboolean OrgApacheCommonsLang3AnnotationUtils_equalsWithJavaLangAnnotationAnnotation_withJavaLangAnnotationAnnotation_(id<JavaLangAnnotationAnnotation> a1, id<JavaLangAnnotationAnnotation> a2) {
  ...
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(type, @"Annotation %s with null annotationType()", [IOSObjectArray newArrayWithObjects:(id[]){ a1 } count:1 type:NSObject_class_()]);
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(type2, @"Annotation %s with null annotationType()", [IOSObjectArray newArrayWithObjects:(id[]){ a2 } count:1 type:NSObject_class_()]);
  ...
  @try {
    {
      ...
      while (b__ < e__) {
        ...
        if (((IOSObjectArray *) nil_chk([((JavaLangReflectMethod *) nil_chk(m)) getParameterTypes]))->size_ == 0 && OrgApacheCommonsLang3AnnotationUtils_isValidAnnotationMemberTypeWithIOSClass_([m getReturnType])) {
          id v1 = [m invokeWithId:a1 withNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]];
          id v2 = [m invokeWithId:a2 withNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]];
...
jint OrgApacheCommonsLang3AnnotationUtils_hashCodeWithJavaLangAnnotationAnnotation_(id<JavaLangAnnotationAnnotation> a) {
  ...
  IOSClass *type = [((id<JavaLangAnnotationAnnotation>) nil_chk(a)) annotationType];
  {
    ...
    while (b__ < e__) {
      JavaLangReflectMethod *m = *b__++;
      @try {
        id value = [((JavaLangReflectMethod *) nil_chk(m)) invokeWithId:a withNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]];
        if (value == nil) {
          @throw new_JavaLangIllegalStateException_initWithNSString_(NSString_java_formatWithNSString_withNSObjectArray_(@"Annotation method %s returned null", [IOSObjectArray newArrayWithObjects:(id[]){ m } count:1 type:NSObject_class_()]));
        }
...
NSString *OrgApacheCommonsLang3AnnotationUtils_toStringWithJavaLangAnnotationAnnotation_(id<JavaLangAnnotationAnnotation> a) {
  OrgApacheCommonsLang3AnnotationUtils_initialize();
  OrgApacheCommonsLang3BuilderToStringBuilder *builder = new_OrgApacheCommonsLang3BuilderToStringBuilder_initWithId_withOrgApacheCommonsLang3BuilderToStringStyle_(a, OrgApacheCommonsLang3AnnotationUtils_TO_STRING_STYLE);
  {
    ...
    while (b__ < e__) {
      ...
      @try {
        (void) [builder appendWithNSString:[m getName] withId:[m invokeWithId:a withNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]]];
      }
      @catch (JavaLangRuntimeException *ex) {
        @throw ex;
      }
...
- (NSString *)getShortClassNameWithIOSClass:(IOSClass *)cls {
  ...
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(annotationType == nil ? @"" : [annotationType getName]) insertWithInt:0 withChar:'@'])) description];
}
