...
id<JavaIoSerializable> OrgApacheCommonsLang3SerializationUtils_cloneWithJavaIoSerializable_(id<JavaIoSerializable> object) {
  ...
  @catch (JavaLangClassNotFoundException *ex) {
    @throw new_OrgApacheCommonsLang3SerializationException_initWithNSString_withJavaLangThrowable_(@"ClassNotFoundException while reading cloned object data", ex);
  }
  @catch (JavaIoIOException *ex) {
    @throw new_OrgApacheCommonsLang3SerializationException_initWithNSString_withJavaLangThrowable_(@"IOException while reading cloned object data", ex);
  }
  @finally {
    @try {
      if (in != nil) {
    ...
    @catch (JavaIoIOException *ex) {
      @throw new_OrgApacheCommonsLang3SerializationException_initWithNSString_withJavaLangThrowable_(@"IOException on closing cloned object data InputStream.", ex);
    }
  }
}
...
void OrgApacheCommonsLang3SerializationUtils_serializeWithJavaIoSerializable_withJavaIoOutputStream_(id<JavaIoSerializable> obj, JavaIoOutputStream *outputStream) {
  ...
  @catch (JavaIoIOException *ex) {
    @throw new_OrgApacheCommonsLang3SerializationException_initWithJavaLangThrowable_(ex);
  }
  @finally {
    @try {
      if (out != nil) {
