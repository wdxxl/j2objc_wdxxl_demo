...
id<JavaIoSerializable> OrgApacheCommonsLang3SerializationUtils_cloneWithJavaIoSerializable_(id<JavaIoSerializable> object) {
  ...
  JavaIoByteArrayInputStream *bais = new_JavaIoByteArrayInputStream_initWithByteArray_(objectData);
  OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream *in = nil;
  @try {
    in = new_OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_initWithJavaIoInputStream_withJavaLangClassLoader_(bais, [[object java_getClass] getClassLoader]);
  ...
  @catch (JavaLangClassNotFoundException *ex) {
    @throw new_OrgApacheCommonsLang3SerializationException_initWithNSString_withNSException_(@"ClassNotFoundException while reading cloned object data", ex);
  }
  @catch (JavaIoIOException *ex) {
    @throw new_OrgApacheCommonsLang3SerializationException_initWithNSString_withNSException_(@"IOException while reading cloned object data", ex);
  }
  @finally {
    @try {
      if (in != nil) {
    ...
    @catch (JavaIoIOException *ex) {
      @throw new_OrgApacheCommonsLang3SerializationException_initWithNSString_withNSException_(@"IOException on closing cloned object data InputStream.", ex);
    }
  }
}
...
void OrgApacheCommonsLang3SerializationUtils_serializeWithJavaIoSerializable_withJavaIoOutputStream_(id<JavaIoSerializable> obj, JavaIoOutputStream *outputStream) {
  OrgApacheCommonsLang3SerializationUtils_initialize();
  if (outputStream == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"The OutputStream must not be null");
  }
  JavaIoObjectOutputStream *out = nil;
  @try {
    out = new_JavaIoObjectOutputStream_initWithJavaIoOutputStream_(outputStream);
    [out writeObjectWithId:obj];
  }
  @catch (JavaIoIOException *ex) {
    @throw new_OrgApacheCommonsLang3SerializationException_initWithNSException_(ex);
  }
  @finally {
    @try {
      if (out != nil) {
...
id OrgApacheCommonsLang3SerializationUtils_deserializeWithJavaIoInputStream_(JavaIoInputStream *inputStream) {
  OrgApacheCommonsLang3SerializationUtils_initialize();
  if (inputStream == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"The InputStream must not be null");
  }
  JavaIoObjectInputStream *in = nil;
  @try {
    in = new_JavaIoObjectInputStream_initWithJavaIoInputStream_(inputStream);
...
id OrgApacheCommonsLang3SerializationUtils_deserializeWithByteArray_(IOSByteArray *objectData) {
  OrgApacheCommonsLang3SerializationUtils_initialize();
  if (objectData == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"The byte[] must not be null");
  }
  return OrgApacheCommonsLang3SerializationUtils_deserializeWithJavaIoInputStream_(new_JavaIoByteArrayInputStream_initWithByteArray_(objectData));
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream class]) {
    OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes = new_JavaUtilHashMap_init();
...
void OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_initWithJavaIoInputStream_withJavaLangClassLoader_(OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream *self, JavaIoInputStream *inArg, JavaLangClassLoader *classLoader) {
  ...
  (void) [((id<JavaUtilMap>) nil_chk(OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes)) putWithId:@"byte" withId:[IOSClass byteClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"short" withId:[IOSClass shortClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"int" withId:[IOSClass intClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"long" withId:[IOSClass longClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"float" withId:[IOSClass floatClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"double" withId:[IOSClass doubleClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"boolean" withId:[IOSClass booleanClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"char" withId:[IOSClass charClass]];
  (void) [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"void" withId:[IOSClass voidClass]];
}
