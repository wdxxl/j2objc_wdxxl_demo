...
- (void)appendToStringWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
  ...
  if (toString != nil) {
    ...
    if (pos1 != pos2 && pos1 >= 0 && pos2 >= 0) {
      ...
      (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:data];
...
- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                                      withId:(id)value {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithId:value];
}

- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                      withJavaUtilCollection:(id<JavaUtilCollection>)coll {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithId:coll];
}

- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                             withJavaUtilMap:(id<JavaUtilMap>)map {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithId:map];
}

- (void)appendSummaryWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                 withNSString:(NSString *)fieldName
                                       withId:(id)value {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:summaryObjectStartText_];
  (void) [buffer appendWithNSString:[self getShortClassNameWithIOSClass:[nil_chk(value) java_getClass]]];
  (void) [buffer appendWithNSString:summaryObjectEndText_];
}
...
- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                                    withLong:(jlong)value {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithLong:value];
}
...
- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                                    withChar:(jchar)value {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithChar:value];
}
...
- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                                  withDouble:(jdouble)value {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithDouble:value];
}
...
- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                                   withFloat:(jfloat)value {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithFloat:value];
}
...
- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                                 withBoolean:(jboolean)value {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithBoolean:value];
}
...
- (void)appendDetailWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                withNSString:(NSString *)fieldName
                           withNSObjectArray:(IOSObjectArray *)array {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:arrayStart_];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(array))->size_; i++) {
    id item = IOSObjectArray_Get(array, i);
    if (i > 0) {
      (void) [buffer appendWithNSString:arraySeparator_];
    }
    if (item == nil) {
      [self appendNullTextWithJavaLangStringBuffer:buffer withNSString:fieldName];
    }
  ...
  (void) [buffer appendWithNSString:arrayEnd_];
}
...
- (void)appendClassNameWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
  ...
  if (useClassName_ && object != nil) {
    ...
    if (useShortClassName_) {
      (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:[self getShortClassNameWithIOSClass:[object java_getClass]]];
    }
    else {
      (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:[[object java_getClass] getName]];
    }
  }
}
...
- (void)appendIdentityHashCodeWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
  ...
  if ([self isUseIdentityHashCode] && object != nil) {
    ...
    (void) [buffer appendWithNSString:JavaLangInteger_toHexStringWithInt_(JavaLangSystem_identityHashCodeWithId_(object))];
  }
}

- (void)appendContentStartWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:contentStart_];
}

- (void)appendContentEndWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:contentEnd_];
}

- (void)appendNullTextWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                  withNSString:(NSString *)fieldName {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:nullText_];
}

- (void)appendFieldSeparatorWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:fieldSeparator_];
}

- (void)appendFieldStartWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                    withNSString:(NSString *)fieldName {
  if (useFieldNames_ && fieldName != nil) {
    (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:fieldName];
    (void) [buffer appendWithNSString:fieldNameValueSeparator_];
  }
}
...
- (void)appendSummarySizeWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                                     withNSString:(NSString *)fieldName
                                          withInt:(jint)size {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:sizeStartText_];
  (void) [buffer appendWithInt:size];
  (void) [buffer appendWithNSString:sizeEndText_];
}
...
- (void)setArraySeparatorWithNSString:(NSString *)arraySeparator {
  ...
  self->arraySeparator_ = arraySeparator;
}
...
- (void)setContentStartWithNSString:(NSString *)contentStart {
  ...
  self->contentStart_ = contentStart;
}
...
- (void)setFieldNameValueSeparatorWithNSString:(NSString *)fieldNameValueSeparator {
  ...
  self->fieldNameValueSeparator_ = fieldNameValueSeparator;
}
...
- (void)setFieldSeparatorWithNSString:(NSString *)fieldSeparator {
  ...
  self->fieldSeparator_ = fieldSeparator;
}
...
- (void)setSizeStartTextWithNSString:(NSString *)sizeStartText {
  ...
  self->sizeStartText_ = sizeStartText;
}
...
- (void)setSummaryObjectStartTextWithNSString:(NSString *)summaryObjectStartText {
  ...
  self->summaryObjectStartText_ = summaryObjectStartText;
}
...
- (void)setSummaryObjectEndTextWithNSString:(NSString *)summaryObjectEndText {
  ...
  self->summaryObjectEndText_ = summaryObjectEndText;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3BuilderToStringStyle class]) {
    OrgApacheCommonsLang3BuilderToStringStyle_DEFAULT_STYLE = new_OrgApacheCommonsLang3BuilderToStringStyle_DefaultToStringStyle_init();
    OrgApacheCommonsLang3BuilderToStringStyle_MULTI_LINE_STYLE = new_OrgApacheCommonsLang3BuilderToStringStyle_MultiLineToStringStyle_init();
    OrgApacheCommonsLang3BuilderToStringStyle_NO_FIELD_NAMES_STYLE = new_OrgApacheCommonsLang3BuilderToStringStyle_NoFieldNameToStringStyle_init();
    OrgApacheCommonsLang3BuilderToStringStyle_SHORT_PREFIX_STYLE = new_OrgApacheCommonsLang3BuilderToStringStyle_ShortPrefixToStringStyle_init();
    OrgApacheCommonsLang3BuilderToStringStyle_SIMPLE_STYLE = new_OrgApacheCommonsLang3BuilderToStringStyle_SimpleToStringStyle_init();
    OrgApacheCommonsLang3BuilderToStringStyle_NO_CLASS_NAME_STYLE = new_OrgApacheCommonsLang3BuilderToStringStyle_NoClassNameToStringStyle_init();
    OrgApacheCommonsLang3BuilderToStringStyle_JSON_STYLE = new_OrgApacheCommonsLang3BuilderToStringStyle_JsonToStringStyle_init();
    OrgApacheCommonsLang3BuilderToStringStyle_REGISTRY = new_JavaLangThreadLocal_init();
...
void OrgApacheCommonsLang3BuilderToStringStyle_register__WithId_(id value) {
  ...
  if (value != nil) {
    id<JavaUtilMap> m = OrgApacheCommonsLang3BuilderToStringStyle_getRegistry();
    if (m == nil) {
      [((JavaLangThreadLocal *) nil_chk(OrgApacheCommonsLang3BuilderToStringStyle_REGISTRY)) setWithId:new_JavaUtilWeakHashMap_init()];
    }
    (void) [((id<JavaUtilMap>) nil_chk(OrgApacheCommonsLang3BuilderToStringStyle_getRegistry())) putWithId:value withId:nil];
  }
}
...
void OrgApacheCommonsLang3BuilderToStringStyle_init(OrgApacheCommonsLang3BuilderToStringStyle *self) {
  ...
  self->contentStart_ = @"[";
  self->contentEnd_ = @"]";
  self->fieldNameValueSeparator_ = @"=";
  self->fieldSeparatorAtStart_ = false;
  self->fieldSeparatorAtEnd_ = false;
  self->fieldSeparator_ = @",";
  self->arrayStart_ = @"{";
  self->arraySeparator_ = @",";
  self->arrayContentDetail_ = true;
  self->arrayEnd_ = @"}";
  self->defaultFullDetail_ = true;
  self->nullText_ = @"<null>";
  self->sizeStartText_ = @"<size=";
  self->sizeEndText_ = @">";
  self->summaryObjectStartText_ = @"<";
  self->summaryObjectEndText_ = @">";
}
...
- (void)appendWithJavaLangStringBuffer:(JavaLangStringBuffer *)buffer
                   ...
                   withJavaLangBoolean:(JavaLangBoolean *)fullDetail {
  if (fieldName == nil) {
    @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"Field names are mandatory when using JsonToStringStyle");
  }
  if (![self isFullDetailWithJavaLangBoolean:fullDetail]) {
    @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"FullDetail must be true when using JsonToStringStyle");
  }
...
void OrgApacheCommonsLang3BuilderToStringStyle_JsonToStringStyle_appendValueAsStringWithJavaLangStringBuffer_withNSString_(OrgApacheCommonsLang3BuilderToStringStyle_JsonToStringStyle *self, JavaLangStringBuffer *buffer, NSString *value) {
  (void) [((JavaLangStringBuffer *) nil_chk(buffer)) appendWithNSString:JreStrcat("C$C", '"', value, '"')];
}
