...
- (OrgApacheCommonsLang3MathFraction *)invert {
  if (numerator_ == 0) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"Unable to invert zero.");
  }
  if (numerator_ == JavaLangInteger_MIN_VALUE) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: can't negate numerator");
  }
  if (numerator_ < 0) {
    return new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(-denominator_, -numerator_);
  }
  return new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(denominator_, numerator_);
}
...
- (OrgApacheCommonsLang3MathFraction *)negate {
  if (numerator_ == JavaLangInteger_MIN_VALUE) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: too large to negate");
  }
  return new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(-numerator_, denominator_);
}
...
- (OrgApacheCommonsLang3MathFraction *)multiplyByWithOrgApacheCommonsLang3MathFraction:(OrgApacheCommonsLang3MathFraction *)fraction {
  if (fraction == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"The fraction must not be null");
  }
...
- (OrgApacheCommonsLang3MathFraction *)divideByWithOrgApacheCommonsLang3MathFraction:(OrgApacheCommonsLang3MathFraction *)fraction {
  ...
  if (fraction->numerator_ == 0) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"The fraction to divide by must not be zero");
  }
...
- (jint)compareToWithId:(OrgApacheCommonsLang3MathFraction *)other {
  (void) cast_chk(other, [OrgApacheCommonsLang3MathFraction class]);
  if (self == other) {
    return 0;
  }
...
- (NSString *)description {
  if (toString_ == nil) {
    toString_ = [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithInt_(32) appendWithInt:[self getNumerator]])) appendWithChar:'/'])) appendWithInt:[self getDenominator]])) description];
  }
  return toString_;
}
  ...
  if (toProperString_ == nil) {
    if (numerator_ == 0) {
      ...
      if (properNumerator == 0) {
        toProperString_ = JavaLangInteger_toStringWithInt_([self getProperWhole]);
      }
      else {
        toProperString_ = [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithInt_(32) appendWithInt:[self getProperWhole]])) appendWithChar:' '])) appendWithInt:properNumerator])) appendWithChar:'/'])) appendWithInt:[self getDenominator]])) description];
      }
    }
    else {
      toProperString_ = [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithInt_(32) appendWithInt:[self getNumerator]])) appendWithChar:'/'])) appendWithInt:[self getDenominator]])) description];
    }
  }
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3MathFraction class]) {
    OrgApacheCommonsLang3MathFraction_ZERO = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(0, 1);
    OrgApacheCommonsLang3MathFraction_ONE = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(1, 1);
    OrgApacheCommonsLang3MathFraction_ONE_HALF = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(1, 2);
    OrgApacheCommonsLang3MathFraction_ONE_THIRD = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(1, 3);
    OrgApacheCommonsLang3MathFraction_TWO_THIRDS = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(2, 3);
    OrgApacheCommonsLang3MathFraction_ONE_QUARTER = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(1, 4);
    OrgApacheCommonsLang3MathFraction_TWO_QUARTERS = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(2, 4);
    OrgApacheCommonsLang3MathFraction_THREE_QUARTERS = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(3, 4);
    OrgApacheCommonsLang3MathFraction_ONE_FIFTH = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(1, 5);
    OrgApacheCommonsLang3MathFraction_TWO_FIFTHS = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(2, 5);
    OrgApacheCommonsLang3MathFraction_THREE_FIFTHS = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(3, 5);
    OrgApacheCommonsLang3MathFraction_FOUR_FIFTHS = new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(4, 5);
...
OrgApacheCommonsLang3MathFraction *OrgApacheCommonsLang3MathFraction_getFractionWithInt_withInt_(jint numerator, jint denominator) {
  ...
  if (denominator == 0) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"The denominator must not be zero");
  }
  if (denominator < 0) {
    if (numerator == JavaLangInteger_MIN_VALUE || denominator == JavaLangInteger_MIN_VALUE) {
      @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: can't negate");
    }
    numerator = -numerator;
    denominator = -denominator;
  }
  return new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(numerator, denominator);
}
...
OrgApacheCommonsLang3MathFraction *OrgApacheCommonsLang3MathFraction_getFractionWithInt_withInt_withInt_(jint whole, jint numerator, jint denominator) {
  ...
  if (denominator < 0) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"The denominator must not be negative");
  }
  if (numerator < 0) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"The numerator must not be negative");
  }
  ...
  if (numeratorValue < JavaLangInteger_MIN_VALUE || numeratorValue > JavaLangInteger_MAX_VALUE) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"Numerator too large to represent as an Integer.");
  }
  return new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_((jint) numeratorValue, denominator);
}
...
OrgApacheCommonsLang3MathFraction *OrgApacheCommonsLang3MathFraction_getFractionWithDouble_(jdouble value) {
  ...
  if (value > JavaLangInteger_MAX_VALUE || JavaLangDouble_isNaNWithDouble_(value)) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"The value must not be greater than Integer.MAX_VALUE or NaN");
  }
  ...
  if (i == 25) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"Unable to convert double to fraction");
  }
...
OrgApacheCommonsLang3MathFraction *OrgApacheCommonsLang3MathFraction_getFractionWithNSString_(NSString *str) {
  OrgApacheCommonsLang3MathFraction_initialize();
  if (str == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"The string must not be null");
  }
  ...
  if (pos > 0) {
    ...
    if (pos < 0) {
      @throw new_JavaLangNumberFormatException_initWithNSString_(@"The fraction could not be parsed as the format X Y/Z");
    }
...
jint OrgApacheCommonsLang3MathFraction_greatestCommonDivisorWithInt_withInt_(jint u, jint v) {
  ...
  if (u == 0 || v == 0) {
    if (u == JavaLangInteger_MIN_VALUE || v == JavaLangInteger_MIN_VALUE) {
      @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: gcd is 2^31");
    }
...
jint OrgApacheCommonsLang3MathFraction_mulPosAndCheckWithInt_withInt_(jint x, jint y) {
  ...
  if (m > JavaLangInteger_MAX_VALUE) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: mulPos");
  }
  return (jint) m;
}
...
jint OrgApacheCommonsLang3MathFraction_addAndCheckWithInt_withInt_(jint x, jint y) {
  ...
  if (s < JavaLangInteger_MIN_VALUE || s > JavaLangInteger_MAX_VALUE) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: add");
  }
  return (jint) s;
}
...
OrgApacheCommonsLang3MathFraction *OrgApacheCommonsLang3MathFraction_addSubWithOrgApacheCommonsLang3MathFraction_withBoolean_(OrgApacheCommonsLang3MathFraction *self, OrgApacheCommonsLang3MathFraction *fraction, jboolean isAdd) {
  ...
  if (d1 == 1) {
    ...
    return new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_(isAdd ? OrgApacheCommonsLang3MathFraction_addAndCheckWithInt_withInt_(uvp, upv) : OrgApacheCommonsLang3MathFraction_subAndCheckWithInt_withInt_(uvp, upv), OrgApacheCommonsLang3MathFraction_mulPosAndCheckWithInt_withInt_(self->denominator_, fraction->denominator_));
  }
  ...
  if ([((JavaMathBigInteger *) nil_chk(w)) bitLength] > 31) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: numerator too large after multiply");
  }
  return new_OrgApacheCommonsLang3MathFraction_initWithInt_withInt_([w intValue], OrgApacheCommonsLang3MathFraction_mulPosAndCheckWithInt_withInt_(self->denominator_ / d1, fraction->denominator_ / d2));
}
