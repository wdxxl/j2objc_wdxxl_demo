...
id<JavaUtilMap> OrgApacheCommonsLang3EnumUtils_getEnumMapWithIOSClass_(IOSClass *enumClass) {
  ...
  id<JavaUtilMap> map = new_JavaUtilLinkedHashMap_init();
  {
    ...
    while (b__ < e__) {
      JavaLangEnum *e = *b__++;
      (void) [map putWithId:[((JavaLangEnum *) nil_chk(e)) name] withId:e];
    }
  }
  return map;
}
...
id<JavaUtilList> OrgApacheCommonsLang3EnumUtils_getEnumListWithIOSClass_(IOSClass *enumClass) {
  OrgApacheCommonsLang3EnumUtils_initialize();
  return new_JavaUtilArrayList_initWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_([((IOSClass *) nil_chk(enumClass)) getEnumConstants]));
}
...
jboolean OrgApacheCommonsLang3EnumUtils_isValidEnumWithIOSClass_withNSString_(IOSClass *enumClass, NSString *enumName) {
  ...
  @try {
    (void) JavaLangEnum_valueOfWithIOSClass_withNSString_(enumClass, enumName);
    return true;
  }
...
jlong OrgApacheCommonsLang3EnumUtils_generateBitVectorWithIOSClass_withJavaLangIterable_(IOSClass *enumClass, id<JavaLangIterable> values) {
  OrgApacheCommonsLang3EnumUtils_initialize();
  (void) OrgApacheCommonsLang3EnumUtils_checkBitVectorableWithIOSClass_(enumClass);
  (void) OrgApacheCommonsLang3Validate_notNullWithId_(values);
  jlong total = 0;
  for (JavaLangEnum * __strong constant in nil_chk(values)) {
    OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(constant != nil, OrgApacheCommonsLang3EnumUtils_NULL_ELEMENTS_NOT_PERMITTED, [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
...
IOSLongArray *OrgApacheCommonsLang3EnumUtils_generateBitVectorsWithIOSClass_withJavaLangIterable_(IOSClass *enumClass, id<JavaLangIterable> values) {
  OrgApacheCommonsLang3EnumUtils_initialize();
  (void) OrgApacheCommonsLang3EnumUtils_asEnumWithIOSClass_(enumClass);
  (void) OrgApacheCommonsLang3Validate_notNullWithId_(values);
  ...
  IOSLongArray *result = [IOSLongArray newArrayWithLength:(((IOSObjectArray *) nil_chk([((IOSClass *) nil_chk(enumClass)) getEnumConstants]))->size_ - 1) / JavaLangLong_SIZE + 1];
...
jlong OrgApacheCommonsLang3EnumUtils_generateBitVectorWithIOSClass_withJavaLangEnumArray_(IOSClass *enumClass, IOSObjectArray *values) {
  OrgApacheCommonsLang3EnumUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_noNullElementsWithNSObjectArray_(values);
...
JavaUtilEnumSet *OrgApacheCommonsLang3EnumUtils_processBitVectorWithIOSClass_withLong_(IOSClass *enumClass, jlong value) {
  OrgApacheCommonsLang3EnumUtils_initialize();
  (void) [((IOSClass *) nil_chk(OrgApacheCommonsLang3EnumUtils_checkBitVectorableWithIOSClass_(enumClass))) getEnumConstants];
  return OrgApacheCommonsLang3EnumUtils_processBitVectorsWithIOSClass_withLongArray_(enumClass, [IOSLongArray newArrayWithLongs:(jlong[]){ value } count:1]);
}
...
IOSClass *OrgApacheCommonsLang3EnumUtils_checkBitVectorableWithIOSClass_(IOSClass *enumClass) {
  ...
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(((IOSObjectArray *) nil_chk(constants))->size_ <= JavaLangLong_SIZE, OrgApacheCommonsLang3EnumUtils_CANNOT_STORE_S_S_VALUES_IN_S_BITS, [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(constants->size_), [((IOSClass *) nil_chk(enumClass)) getSimpleName], JavaLangInteger_valueOfWithInt_(JavaLangLong_SIZE) } count:3 type:NSObject_class_()]);
  return enumClass;
}

IOSClass *OrgApacheCommonsLang3EnumUtils_asEnumWithIOSClass_(IOSClass *enumClass) {
  OrgApacheCommonsLang3EnumUtils_initialize();
  (void) OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(enumClass, OrgApacheCommonsLang3EnumUtils_ENUM_CLASS_MUST_BE_DEFINED, [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_([((IOSClass *) nil_chk(enumClass)) isEnum], OrgApacheCommonsLang3EnumUtils_S_DOES_NOT_SEEM_TO_BE_AN_ENUM_TYPE, [IOSObjectArray newArrayWithObjects:(id[]){ enumClass } count:1 type:NSObject_class_()]);
  return enumClass;
}
