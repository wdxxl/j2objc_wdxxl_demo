...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3RandomUtils class]) {
    OrgApacheCommonsLang3RandomUtils_RANDOM = new_JavaUtilRandom_init();
...
IOSByteArray *OrgApacheCommonsLang3RandomUtils_nextBytesWithInt_(jint count) {
  ...
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(count >= 0, @"Count cannot be negative.", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  IOSByteArray *result = [IOSByteArray newArrayWithLength:count];
...
jint OrgApacheCommonsLang3RandomUtils_nextIntWithInt_withInt_(jint startInclusive, jint endExclusive) {
  OrgApacheCommonsLang3RandomUtils_initialize();
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(endExclusive >= startInclusive, @"Start value must be smaller or equal to end value.", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(startInclusive >= 0, @"Both range values must be non-negative.", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
...
jdouble OrgApacheCommonsLang3RandomUtils_nextDoubleWithDouble_withDouble_(jdouble startInclusive, jdouble endInclusive) {
  OrgApacheCommonsLang3RandomUtils_initialize();
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(endInclusive >= startInclusive, @"Start value must be smaller or equal to end value.", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(startInclusive >= 0, @"Both range values must be non-negative.", [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
