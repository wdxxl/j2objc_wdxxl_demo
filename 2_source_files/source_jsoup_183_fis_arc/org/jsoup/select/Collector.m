...
OrgJsoupSelectElements *OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(OrgJsoupSelectEvaluator *eval, OrgJsoupNodesElement *root) {
  ...
  OrgJsoupSelectElements *elements = new_OrgJsoupSelectElements_init();
  [new_OrgJsoupSelectNodeTraversor_initWithOrgJsoupSelectNodeVisitor_(new_OrgJsoupSelectCollector_Accumulator_initWithOrgJsoupNodesElement_withOrgJsoupSelectElements_withOrgJsoupSelectEvaluator_(root, elements, eval)) traverseWithOrgJsoupNodesNode:root];
  return elements;
}
