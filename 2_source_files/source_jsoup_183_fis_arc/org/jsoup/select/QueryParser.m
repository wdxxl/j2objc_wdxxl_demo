...
- (OrgJsoupSelectEvaluator *)parse {
  ...
  if ([((OrgJsoupParserTokenQueue *) nil_chk(tq_)) matchesAnyWithNSStringArray:OrgJsoupSelectQueryParser_combinators]) {
    [((id<JavaUtilList>) nil_chk(evals_)) addWithId:new_OrgJsoupSelectStructuralEvaluator_Root_init()];
  ...
  return new_OrgJsoupSelectCombiningEvaluator_And_initWithJavaUtilCollection_(evals_);
}
...
+ (void)initialize {
  if (self == [OrgJsoupSelectQueryParser class]) {
    OrgJsoupSelectQueryParser_combinators = [IOSObjectArray newArrayWithObjects:(id[]){ @",", @">", @"+", @"~", @" " } count:5 type:NSString_class_()];
    OrgJsoupSelectQueryParser_AttributeEvals = [IOSObjectArray newArrayWithObjects:(id[]){ @"=", @"!=", @"^=", @"$=", @"*=", @"~=" } count:6 type:NSString_class_()];
    OrgJsoupSelectQueryParser_NTH_AB = JavaUtilRegexPattern_compileWithNSString_withInt_(@"((\\+|-)?(\\d+)?)n(\\s*(\\+|-)?\\s*\\d+)?", JavaUtilRegexPattern_CASE_INSENSITIVE);
    OrgJsoupSelectQueryParser_NTH_B = JavaUtilRegexPattern_compileWithNSString_(@"(\\+|-)?(\\d+)");
...
void OrgJsoupSelectQueryParser_initWithNSString_(OrgJsoupSelectQueryParser *self, NSString *query) {
  ...
  self->query_ = query;
  self->tq_ = new_OrgJsoupParserTokenQueue_initWithNSString_(query);
}
...
OrgJsoupSelectEvaluator *OrgJsoupSelectQueryParser_parseWithNSString_(NSString *query) {
  ...
  OrgJsoupSelectQueryParser *p = new_OrgJsoupSelectQueryParser_initWithNSString_(query);
  return [p parse];
}
...
void OrgJsoupSelectQueryParser_combinatorWithChar_(OrgJsoupSelectQueryParser *self, jchar combinator) {
  ...
  if ([((id<JavaUtilList>) nil_chk(self->evals_)) size] == 1) {
    ...
    rootEval = currentEval = new_OrgJsoupSelectCombiningEvaluator_And_initWithJavaUtilCollection_(self->evals_);
  }
  [((id<JavaUtilList>) nil_chk(self->evals_)) clear];
  if (combinator == '>') currentEval = new_OrgJsoupSelectCombiningEvaluator_And_initWithOrgJsoupSelectEvaluatorArray_([IOSObjectArray newArrayWithObjects:(id[]){ newEval, create_OrgJsoupSelectStructuralEvaluator_ImmediateParent_initWithOrgJsoupSelectEvaluator_(currentEval) } count:2 type:OrgJsoupSelectEvaluator_class_()]);
  else if (combinator == ' ') currentEval = new_OrgJsoupSelectCombiningEvaluator_And_initWithOrgJsoupSelectEvaluatorArray_([IOSObjectArray newArrayWithObjects:(id[]){ newEval, create_OrgJsoupSelectStructuralEvaluator_Parent_initWithOrgJsoupSelectEvaluator_(currentEval) } count:2 type:OrgJsoupSelectEvaluator_class_()]);
  else if (combinator == '+') currentEval = new_OrgJsoupSelectCombiningEvaluator_And_initWithOrgJsoupSelectEvaluatorArray_([IOSObjectArray newArrayWithObjects:(id[]){ newEval, create_OrgJsoupSelectStructuralEvaluator_ImmediatePreviousSibling_initWithOrgJsoupSelectEvaluator_(currentEval) } count:2 type:OrgJsoupSelectEvaluator_class_()]);
    ...
    if ([currentEval isKindOfClass:[OrgJsoupSelectCombiningEvaluator_Or class]]) {
      ...
      or_ = new_OrgJsoupSelectCombiningEvaluator_Or_init();
      [or_ addWithOrgJsoupSelectEvaluator:currentEval];
      [or_ addWithOrgJsoupSelectEvaluator:newEval];
    }
    currentEval = or_;
  }
  else @throw new_OrgJsoupSelectSelector_SelectorParseException_initWithNSString_withNSObjectArray_(JreStrcat("$C", @"Unknown combinator: ", combinator), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
...
NSString *OrgJsoupSelectQueryParser_consumeSubQuery(OrgJsoupSelectQueryParser *self) {
  JavaLangStringBuilder *sq = new_JavaLangStringBuilder_init();
  while (![((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) isEmpty]) {
    if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchesWithNSString:@"("]) (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sq appendWithNSString:@"("])) appendWithNSString:[((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) chompBalancedWithChar:'(' withChar:')']])) appendWithNSString:@")"];
    else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchesWithNSString:@"["]) (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sq appendWithNSString:@"["])) appendWithNSString:[((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) chompBalancedWithChar:'[' withChar:']']])) appendWithNSString:@"]"];
    ...
    else (void) [sq appendWithChar:[((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) consume]];
  }
...
void OrgJsoupSelectQueryParser_findElements(OrgJsoupSelectQueryParser *self) {
  ...
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":first-child"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsFirstChild_init()];
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":last-child"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsLastChild_init()];
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":first-of-type"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsFirstOfType_init()];
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":last-of-type"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsLastOfType_init()];
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":only-child"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsOnlyChild_init()];
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":only-of-type"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsOnlyOfType_init()];
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":empty"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsEmpty_init()];
  else if ([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) matchChompWithNSString:@":root"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsRoot_init()];
  else @throw new_OrgJsoupSelectSelector_SelectorParseException_initWithNSString_withNSObjectArray_(@"Could not parse query '%s': unexpected token at '%s'", [IOSObjectArray newArrayWithObjects:(id[]){ self->query_, [((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) remainder] } count:2 type:NSObject_class_()]);
}
...
void OrgJsoupSelectQueryParser_byId(OrgJsoupSelectQueryParser *self) {
  ...
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_Id_initWithNSString_(id_)];
}
...
void OrgJsoupSelectQueryParser_byClass(OrgJsoupSelectQueryParser *self) {
  ...
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_Class_initWithNSString_([((NSString *) nil_chk([((NSString *) nil_chk(className_)) java_trim])) lowercaseString])];
}
...
void OrgJsoupSelectQueryParser_byTag(OrgJsoupSelectQueryParser *self) {
  ...
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_Tag_initWithNSString_([((NSString *) nil_chk([((NSString *) nil_chk(tagName)) java_trim])) lowercaseString])];
}

void OrgJsoupSelectQueryParser_byAttribute(OrgJsoupSelectQueryParser *self) {
  OrgJsoupParserTokenQueue *cq = new_OrgJsoupParserTokenQueue_initWithNSString_([((OrgJsoupParserTokenQueue *) nil_chk(self->tq_)) chompBalancedWithChar:'[' withChar:']']);
  ...
  if ([cq isEmpty]) {
    if ([((NSString *) nil_chk(key)) java_hasPrefix:@"^"]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AttributeStarting_initWithNSString_([key java_substring:1])];
    else [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_Attribute_initWithNSString_(key)];
  }
  else {
    if ([cq matchChompWithNSString:@"="]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AttributeWithValue_initWithNSString_withNSString_(key, [cq remainder])];
    else if ([cq matchChompWithNSString:@"!="]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AttributeWithValueNot_initWithNSString_withNSString_(key, [cq remainder])];
    else if ([cq matchChompWithNSString:@"^="]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AttributeWithValueStarting_initWithNSString_withNSString_(key, [cq remainder])];
    else if ([cq matchChompWithNSString:@"$="]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AttributeWithValueEnding_initWithNSString_withNSString_(key, [cq remainder])];
    else if ([cq matchChompWithNSString:@"*="]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AttributeWithValueContaining_initWithNSString_withNSString_(key, [cq remainder])];
    else if ([cq matchChompWithNSString:@"~="]) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AttributeWithValueMatching_initWithNSString_withJavaUtilRegexPattern_(key, JavaUtilRegexPattern_compileWithNSString_([cq remainder]))];
    else @throw new_OrgJsoupSelectSelector_SelectorParseException_initWithNSString_withNSObjectArray_(@"Could not parse attribute query '%s': unexpected token at '%s'", [IOSObjectArray newArrayWithObjects:(id[]){ self->query_, [cq remainder] } count:2 type:NSObject_class_()]);
  }
}

void OrgJsoupSelectQueryParser_allElements(OrgJsoupSelectQueryParser *self) {
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_AllElements_init()];
}

void OrgJsoupSelectQueryParser_indexLessThan(OrgJsoupSelectQueryParser *self) {
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IndexLessThan_initWithInt_(OrgJsoupSelectQueryParser_consumeIndex(self))];
}

void OrgJsoupSelectQueryParser_indexGreaterThan(OrgJsoupSelectQueryParser *self) {
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IndexGreaterThan_initWithInt_(OrgJsoupSelectQueryParser_consumeIndex(self))];
}

void OrgJsoupSelectQueryParser_indexEquals(OrgJsoupSelectQueryParser *self) {
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IndexEquals_initWithInt_(OrgJsoupSelectQueryParser_consumeIndex(self))];
}
...
void OrgJsoupSelectQueryParser_cssNthChildWithBoolean_withBoolean_(OrgJsoupSelectQueryParser *self, jboolean backwards, jboolean ofType) {
  ...
  if ([@"odd" isEqual:argS]) {
    ...
    @throw new_OrgJsoupSelectSelector_SelectorParseException_initWithNSString_withNSObjectArray_(@"Could not parse nth-index '%s': unexpected format", [IOSObjectArray newArrayWithObjects:(id[]){ argS } count:1 type:NSObject_class_()]);
  }
  if (ofType) if (backwards) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsNthLastOfType_initWithInt_withInt_(a, b)];
  else [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsNthOfType_initWithInt_withInt_(a, b)];
  else {
    if (backwards) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsNthLastChild_initWithInt_withInt_(a, b)];
    else [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_IsNthChild_initWithInt_withInt_(a, b)];
  }
}
...
void OrgJsoupSelectQueryParser_has(OrgJsoupSelectQueryParser *self) {
  ...
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectStructuralEvaluator_Has_initWithOrgJsoupSelectEvaluator_(OrgJsoupSelectQueryParser_parseWithNSString_(subQuery))];
}
...
void OrgJsoupSelectQueryParser_containsWithBoolean_(OrgJsoupSelectQueryParser *self, jboolean own) {
  ...
  if (own) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_ContainsOwnText_initWithNSString_(searchText)];
  else [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_ContainsText_initWithNSString_(searchText)];
}
...
void OrgJsoupSelectQueryParser_matchesWithBoolean_(OrgJsoupSelectQueryParser *self, jboolean own) {
  ...
  if (own) [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_MatchesOwn_initWithJavaUtilRegexPattern_(JavaUtilRegexPattern_compileWithNSString_(regex))];
  else [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectEvaluator_Matches_initWithJavaUtilRegexPattern_(JavaUtilRegexPattern_compileWithNSString_(regex))];
}
...
void OrgJsoupSelectQueryParser_not__(OrgJsoupSelectQueryParser *self) {
  ...
  [((id<JavaUtilList>) nil_chk(self->evals_)) addWithId:new_OrgJsoupSelectStructuralEvaluator_Not_initWithOrgJsoupSelectEvaluator_(OrgJsoupSelectQueryParser_parseWithNSString_(subQuery))];
}
