...
- (void)replaceRightMostEvaluatorWithOrgJsoupSelectEvaluator:(OrgJsoupSelectEvaluator *)replacement {
  (void) [((JavaUtilArrayList *) nil_chk(evaluators_)) setWithInt:num_ - 1 withId:replacement];
}
...
void OrgJsoupSelectCombiningEvaluator_init(OrgJsoupSelectCombiningEvaluator *self) {
  ...
  self->num_ = 0;
  self->evaluators_ = new_JavaUtilArrayList_init();
}
...
- (NSString *)description {
  return NSString_java_formatWithNSString_withNSObjectArray_(@":or%s", [IOSObjectArray newArrayWithObjects:(id[]){ evaluators_ } count:1 type:NSObject_class_()]);
}
...
void OrgJsoupSelectCombiningEvaluator_Or_initWithJavaUtilCollection_(OrgJsoupSelectCombiningEvaluator_Or *self, id<JavaUtilCollection> evaluators) {
  OrgJsoupSelectCombiningEvaluator_init(self);
  if (self->num_ > 1) [((JavaUtilArrayList *) nil_chk(self->evaluators_)) addWithId:new_OrgJsoupSelectCombiningEvaluator_And_initWithJavaUtilCollection_(evaluators)];
