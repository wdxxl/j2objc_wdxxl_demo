...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/SortField.java
//
...
void OrgApacheLuceneSearchSortField_readObjectWithJavaIoObjectInputStream_(OrgApacheLuceneSearchSortField *self, JavaIoObjectInputStream *inArg) {
  ...
  if (self->field_ != nil) JreStrongAssign(&self->field_, OrgApacheLuceneUtilStringHelper_internWithNSString_(self->field_));
}
