...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/CachingWrapperFilter.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode class]) {
    ...
    for (jint i = 0; i < 3; i++) {
      ...
      OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode_class_(), i), i);
    }
