...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/FilterManager.java
//
...
- (OrgApacheLuceneSearchFilter *)getFilterWithOrgApacheLuceneSearchFilter:(OrgApacheLuceneSearchFilter *)filter {
  @synchronized(cache_) {
    ...
    if (fi != nil) {
      ...
      return JreRetainedLocalValue(fi->filter_);
    }
    ...
    return JreRetainedLocalValue(filter);
  }
}
...
OrgApacheLuceneSearchFilterManager *OrgApacheLuceneSearchFilterManager_getInstance() {
  ...
  @synchronized(OrgApacheLuceneSearchFilterManager_class_()) {
    ...
    return JreRetainedLocalValue(OrgApacheLuceneSearchFilterManager_manager);
  }
}
