...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/NumericRangeQuery.java
//
...
void OrgApacheLuceneSearchNumericRangeQuery_readObjectWithJavaIoObjectInputStream_(OrgApacheLuceneSearchNumericRangeQuery *self, JavaIoObjectInputStream *inArg) {
  ...
  JreStrongAssign(&self->field_, OrgApacheLuceneUtilStringHelper_internWithNSString_(self->field_));
}
