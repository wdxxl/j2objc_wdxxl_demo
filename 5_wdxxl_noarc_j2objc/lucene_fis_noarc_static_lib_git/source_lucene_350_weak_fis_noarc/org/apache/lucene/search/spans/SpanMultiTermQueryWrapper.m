...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/spans/SpanMultiTermQueryWrapper.java
//
...
- (NSString *)getField {
  ...
  @catch (JavaLangException *e) {
    @throw create_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_(@"Cannot invoke getField() or getTerm() on wrapped query.", e);
  }
}
