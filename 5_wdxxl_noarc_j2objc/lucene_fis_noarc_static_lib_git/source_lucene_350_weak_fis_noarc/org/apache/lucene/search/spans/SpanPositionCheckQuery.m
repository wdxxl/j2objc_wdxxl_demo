...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/spans/SpanPositionCheckQuery.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneSearchSpansSpanPositionCheckQuery_AcceptStatus class]) {
    ...
    for (jint i = 0; i < 3; i++) {
      ...
      OrgApacheLuceneSearchSpansSpanPositionCheckQuery_AcceptStatus_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheLuceneSearchSpansSpanPositionCheckQuery_AcceptStatus_class_(), i), i);
    }
