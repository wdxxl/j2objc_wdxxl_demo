...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/store/NRTCachingDirectory.java
//
...
- (OrgApacheLuceneStoreIndexInput *)openInputWithNSString:(NSString *)name {
  @synchronized(self) {
    if ([((OrgApacheLuceneStoreRAMDirectory *) nil_chk(cache_)) fileExistsWithNSString:name]) {
      return JreRetainedLocalValue([cache_ openInputWithNSString:name]);
    }
    else {
      return JreRetainedLocalValue([((OrgApacheLuceneStoreDirectory *) nil_chk(delegate_)) openInputWithNSString:name]);
    }
  }
}
...
- (OrgApacheLuceneStoreIndexInput *)openInputWithNSString:(NSString *)name
  ...
  @synchronized(self) {
    if ([((OrgApacheLuceneStoreRAMDirectory *) nil_chk(cache_)) fileExistsWithNSString:name]) {
      return JreRetainedLocalValue([cache_ openInputWithNSString:name withInt:bufferSize]);
    }
    else {
      return JreRetainedLocalValue([((OrgApacheLuceneStoreDirectory *) nil_chk(delegate_)) openInputWithNSString:name withInt:bufferSize]);
    }
  }
}
...
void OrgApacheLuceneStoreNRTCachingDirectory_unCacheWithNSString_(OrgApacheLuceneStoreNRTCachingDirectory *self, NSString *fileName) {
  ...
  @synchronized(self) {
    if (![((OrgApacheLuceneStoreDirectory *) nil_chk(self->delegate_)) fileExistsWithNSString:fileName]) {
      ...
      out = JreRetainedLocalValue([self->delegate_ createOutputWithNSString:fileName]);
    }
    else {
      out = JreRetainedLocalValue(nil);
    }
  }
  if (out != nil) {
