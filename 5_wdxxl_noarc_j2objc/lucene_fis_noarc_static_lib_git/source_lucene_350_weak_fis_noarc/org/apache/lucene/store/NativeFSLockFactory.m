...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/store/NativeFSLockFactory.java
//
...
- (OrgApacheLuceneStoreLock *)makeLockWithNSString:(NSString *)lockName {
  @synchronized(self) {
    if (lockPrefix_ != nil) lockName = JreRetainedLocalValue(JreStrcat("$C$", lockPrefix_, '-', lockName));
    return JreRetainedLocalValue(create_OrgApacheLuceneStoreNativeFSLock_initWithJavaIoFile_withNSString_(lockDir_, lockName));
  }
}
