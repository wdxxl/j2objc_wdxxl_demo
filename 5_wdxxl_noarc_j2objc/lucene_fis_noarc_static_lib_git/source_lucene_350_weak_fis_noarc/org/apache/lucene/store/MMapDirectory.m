...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/store/MMapDirectory.java
//
...
void OrgApacheLuceneStoreMMapDirectory_cleanMappingWithJavaNioByteBuffer_(OrgApacheLuceneStoreMMapDirectory *self, JavaNioByteBuffer *buffer) {
  if (self->useUnmapHack_) {
    ...
    @catch (JavaSecurityPrivilegedActionException *e) {
      ...
      [ioe initCauseWithJavaLangThrowable:[e getCause]];
      @throw ioe;
    }
  }
}
...
- (id)java_clone {
  ...
  @catch (JavaIoIOException *ioe) {
    @throw create_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_(JreStrcat("$@", @"Should never happen: ", self), ioe);
  }
  return clone;
}
