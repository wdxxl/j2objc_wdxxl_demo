...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/FieldInfo.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexFieldInfo_IndexOptions class]) {
    ...
    for (jint i = 0; i < 3; i++) {
      ...
      OrgApacheLuceneIndexFieldInfo_IndexOptions_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheLuceneIndexFieldInfo_IndexOptions_class_(), i), i);
    }
