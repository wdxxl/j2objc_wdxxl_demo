...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/MultiReader.java
//
...
- (OrgApacheLuceneIndexIndexReader *)doOpenIfChanged {
  @synchronized(self) {
    return JreRetainedLocalValue([self doOpenIfChangedWithBoolean:false]);
  }
}
...
- (id)java_clone {
  @synchronized(self) {
    @try {
      return JreRetainedLocalValue([self doOpenIfChangedWithBoolean:true]);
    }
