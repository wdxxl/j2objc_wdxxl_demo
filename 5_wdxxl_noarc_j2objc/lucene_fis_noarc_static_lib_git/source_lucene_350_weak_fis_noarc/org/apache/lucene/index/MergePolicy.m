...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/MergePolicy.java
//
  ...
  @synchronized(self) {
    ...
    while (paused_) {
      ...
      @catch (JavaLangInterruptedException *ie) {
        @throw create_JavaLangRuntimeException_initWithJavaLangThrowable_(ie);
      }
      if (aborted_) {
        @throw create_OrgApacheLuceneIndexMergePolicy_MergeAbortedException_initWithNSString_(JreStrcat("$$", @"merge is aborted: ", [self segStringWithOrgApacheLuceneStoreDirectory:dir]));
      }
