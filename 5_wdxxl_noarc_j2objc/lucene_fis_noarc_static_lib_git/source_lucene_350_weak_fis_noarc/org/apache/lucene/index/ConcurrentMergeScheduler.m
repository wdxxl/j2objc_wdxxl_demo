...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/ConcurrentMergeScheduler.java
//
...
- (void)handleMergeExceptionWithJavaLangThrowable:(JavaLangThrowable *)exc {
  ...
  @throw create_OrgApacheLuceneIndexMergePolicy_MergeException_initWithJavaLangThrowable_withOrgApacheLuceneStoreDirectory_(exc, dir_);
}
...
- (OrgApacheLuceneIndexMergePolicy_OneMerge *)getRunningMerge {
  @synchronized(self) {
    return JreRetainedLocalValue(runningMerge_);
  }
}
...
- (OrgApacheLuceneIndexMergePolicy_OneMerge *)getCurrentMerge {
  @synchronized(self) {
    if (JreLoadVolatileBoolean(&done_)) {
      ...
      return JreRetainedLocalValue(startMerge_);
    }
  }
}
