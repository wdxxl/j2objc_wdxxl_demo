...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/BufferedDeletesStream.java
//
...
- (OrgApacheLuceneIndexBufferedDeletesStream_ApplyDeletesResult *)applyDeletesWithOrgApacheLuceneIndexIndexWriter_ReaderPool:(OrgApacheLuceneIndexIndexWriter_ReaderPool *)readerPool
  ...
  @synchronized(self) {
    ...
    if ([((id<JavaUtilList>) nil_chk(infos)) size] == 0) {
      return JreRetainedLocalValue(create_OrgApacheLuceneIndexBufferedDeletesStream_ApplyDeletesResult_initWithBoolean_withLong_withJavaUtilList_(false, nextGen_++, nil));
    }
    ...
    return JreRetainedLocalValue(create_OrgApacheLuceneIndexBufferedDeletesStream_ApplyDeletesResult_initWithBoolean_withLong_withJavaUtilList_(anyNewDeletes, nextGen_++, allDeleted));
  }
}
