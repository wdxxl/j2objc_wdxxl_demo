...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/PersistentSnapshotDeletionPolicy.java
//
...
- (OrgApacheLuceneIndexIndexCommit *)snapshotWithNSString:(NSString *)id_ {
  @synchronized(self) {
    ...
    return JreRetainedLocalValue([super snapshotWithNSString:id_]);
  }
}
