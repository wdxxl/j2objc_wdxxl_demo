...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/TermVectorsTermsWriter.java
//
...
- (OrgApacheLuceneIndexTermVectorsTermsWriter_PerDoc *)getPerDoc {
  @synchronized(self) {
    if (freeCount_ == 0) {
      ...
      return JreRetainedLocalValue(create_OrgApacheLuceneIndexTermVectorsTermsWriter_PerDoc_initWithOrgApacheLuceneIndexTermVectorsTermsWriter_(self));
    }
    else {
