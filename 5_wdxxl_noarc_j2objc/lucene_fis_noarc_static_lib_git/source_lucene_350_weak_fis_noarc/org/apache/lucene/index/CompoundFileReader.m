...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/CompoundFileReader.java
//
...
- (OrgApacheLuceneStoreIndexInput *)openInputWithNSString:(NSString *)id_ {
  @synchronized(self) {
    return JreRetainedLocalValue([self openInputWithNSString:id_ withInt:readBufferSize_]);
  }
}
...
- (OrgApacheLuceneStoreIndexInput *)openInputWithNSString:(NSString *)id_
  ...
  @synchronized(self) {
    ...
    id_ = JreRetainedLocalValue(OrgApacheLuceneIndexIndexFileNames_stripSegmentNameWithNSString_(id_));
    ...
    return JreRetainedLocalValue(create_OrgApacheLuceneIndexCompoundFileReader_CSIndexInput_initWithOrgApacheLuceneStoreIndexInput_withLong_withLong_withInt_(stream_, entry_->offset_, entry_->length_, readBufferSize));
  }
}
