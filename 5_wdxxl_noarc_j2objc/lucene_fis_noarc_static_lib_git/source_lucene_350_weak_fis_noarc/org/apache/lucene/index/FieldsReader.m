...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/FieldsReader.java
//
...
IOSByteArray *OrgApacheLuceneIndexFieldsReader_uncompressWithByteArray_(OrgApacheLuceneIndexFieldsReader *self, IOSByteArray *b) {
  ...
  @catch (JavaUtilZipDataFormatException *e) {
    ...
    [newException initCauseWithJavaLangThrowable:e];
    @throw newException;
  }
}
  ...
  if (isBinary_) return nil;
    ...
    if (fieldsData_ == nil) {
      ...
      @catch (JavaIoIOException *e) {
        @throw create_OrgApacheLuceneIndexFieldReaderException_initWithJavaLangThrowable_(e);
      }
      if (cacheResult_) {
