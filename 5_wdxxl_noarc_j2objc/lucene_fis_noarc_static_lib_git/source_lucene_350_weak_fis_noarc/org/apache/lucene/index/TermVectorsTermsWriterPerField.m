...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/TermVectorsTermsWriterPerField.java
//
...
- (jboolean)startWithOrgApacheLuceneDocumentFieldableArray:(IOSObjectArray *)fields
  ...
  if (doVectors_) {
    if (((OrgApacheLuceneIndexTermVectorsTermsWriterPerThread *) nil_chk(perThread_))->doc_ == nil) {
      ...
      JreAssert(perThread_->doc_->numVectorFields_ == 0, @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:81 condition failed: assert perThread.doc.numVectorFields == 0;");
      JreAssert(0 == [((OrgApacheLuceneStoreRAMOutputStream *) nil_chk(perThread_->doc_->perDocTvf_)) length], @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:82 condition failed: assert 0 == perThread.doc.perDocTvf.length();");
      JreAssert(0 == [((OrgApacheLuceneStoreRAMOutputStream *) nil_chk(((OrgApacheLuceneIndexTermVectorsTermsWriter_PerDoc *) nil_chk(perThread_->doc_))->perDocTvf_)) getFilePointer], @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:83 condition failed: assert 0 == perThread.doc.perDocTvf.getFilePointer();");
    }
    JreAssert(((OrgApacheLuceneIndexTermVectorsTermsWriter_PerDoc *) nil_chk(perThread_->doc_))->docID_ == ((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(docState_))->docID_, @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:86 condition failed: assert perThread.doc.docID == docState.docID;");
...
- (void)finish {
  JreAssert([((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(docState_)) testPointWithNSString:@"TermVectorsTermsWriterPerField.finish start"], @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:112 condition failed: assert docState.testPoint(\"TermVectorsTermsWriterPerField.finish start\");");
  jint numPostings = ((OrgApacheLuceneIndexTermsHashPerField *) nil_chk(termsHashPerField_))->numPostings_;
  JreAssert(numPostings >= 0, @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:116 condition failed: assert numPostings >= 0;");
  ...
  JreAssert(((OrgApacheLuceneIndexFieldInfo *) nil_chk(fieldInfo_))->storeTermVector_, @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:130 condition failed: assert fieldInfo.storeTermVector;");
  JreAssert([perThread_ vectorFieldsInOrderWithOrgApacheLuceneIndexFieldInfo:fieldInfo_], @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:131 condition failed: assert perThread.vectorFieldsInOrder(fieldInfo);");
...
- (void)newTermWithInt:(jint)termID {
  JreAssert([((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(docState_)) testPointWithNSString:@"TermVectorsTermsWriterPerField.newTerm start"], @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:226 condition failed: assert docState.testPoint(\"TermVectorsTermsWriterPerField.newTerm start\");");
...
- (void)addTermWithInt:(jint)termID {
  JreAssert([((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(docState_)) testPointWithNSString:@"TermVectorsTermsWriterPerField.addTerm start"], @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:250 condition failed: assert docState.testPoint(\"TermVectorsTermsWriterPerField.addTerm start\");");
  OrgApacheLuceneIndexTermVectorsTermsWriterPerField_TermVectorsPostingsArray *postings = (OrgApacheLuceneIndexTermVectorsTermsWriterPerField_TermVectorsPostingsArray *) cast_chk(((OrgApacheLuceneIndexTermsHashPerField *) nil_chk(termsHashPerField_))->postingsArray_, [OrgApacheLuceneIndexTermVectorsTermsWriterPerField_TermVectorsPostingsArray class]);
...
- (void)__javaClone:(OrgApacheLuceneIndexTermVectorsTermsWriterPerField *)original {
  [super __javaClone:original];
  [termsHashPerField_ release];
}
...
- (void)copyToWithOrgApacheLuceneIndexParallelPostingsArray:(OrgApacheLuceneIndexParallelPostingsArray *)toArray
  ...
  JreAssert([toArray isKindOfClass:[OrgApacheLuceneIndexTermVectorsTermsWriterPerField_TermVectorsPostingsArray class]], @"org/apache/lucene/index/TermVectorsTermsWriterPerField.java:298 condition failed: assert toArray instanceof TermVectorsPostingsArray;");
