...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/DirectoryReader.java
//
...
- (id)java_clone {
  @synchronized(self) {
    @try {
      return JreRetainedLocalValue(OrgApacheLuceneIndexDirectoryReader_cloneWithBoolean_(self, readOnly_));
    }
...
- (IOSByteArray *)normsWithNSString:(NSString *)field {
  @synchronized(self) {
    ...
    if (bytes != nil) return JreRetainedLocalValue(bytes);
    if (![self hasNormsWithNSString:field]) return JreRetainedLocalValue(nil);
    ...
    return JreRetainedLocalValue(bytes);
  }
}
...
OrgApacheLuceneIndexIndexReader *OrgApacheLuceneIndexDirectoryReader_cloneWithBoolean_(OrgApacheLuceneIndexDirectoryReader *self, jboolean openReadOnly) {
  @synchronized(self) {
    ...
    return JreRetainedLocalValue(newReader);
  }
}
  ...
  @synchronized(self) {
    if (commit == nil) {
      if (self->hasChanges_) {
        ...
        if (openReadOnly) {
          return JreRetainedLocalValue(OrgApacheLuceneIndexDirectoryReader_cloneWithBoolean_(self, openReadOnly));
        }
        else {
    ...
    return JreRetainedLocalValue((OrgApacheLuceneIndexIndexReader *) cast_chk([create_OrgApacheLuceneIndexDirectoryReader_2_initWithOrgApacheLuceneIndexDirectoryReader_withBoolean_withOrgApacheLuceneStoreDirectory_(self, openReadOnly, self->directory_) runWithOrgApacheLuceneIndexIndexCommit:commit], [OrgApacheLuceneIndexIndexReader class]));
  }
}
