...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/FieldInfos.java
//
...
- (id)java_clone {
  @synchronized(self) {
    ...
    return JreRetainedLocalValue(fis);
  }
}
...
- (OrgApacheLuceneIndexFieldInfo *)addWithNSString:(NSString *)name
  ...
  @synchronized(self) {
    ...
    if (fi == nil) {
      return JreRetainedLocalValue(OrgApacheLuceneIndexFieldInfos_addInternalWithNSString_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withOrgApacheLuceneIndexFieldInfo_IndexOptions_(self, name, isIndexed, storeTermVector, storePositionWithTermVector, storeOffsetWithTermVector, omitNorms, storePayloads, indexOptions));
    }
    else {
