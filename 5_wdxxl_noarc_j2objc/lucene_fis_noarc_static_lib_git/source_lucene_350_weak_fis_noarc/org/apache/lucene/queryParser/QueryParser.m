...
+ (void)initialize {
  if (self == [OrgApacheLuceneQueryParserQueryParser_Operator class]) {
    ...
    for (jint i = 0; i < 2; i++) {
      ...
      OrgApacheLuceneQueryParserQueryParser_Operator_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheLuceneQueryParserQueryParser_Operator_class_(), i), i);
    }
