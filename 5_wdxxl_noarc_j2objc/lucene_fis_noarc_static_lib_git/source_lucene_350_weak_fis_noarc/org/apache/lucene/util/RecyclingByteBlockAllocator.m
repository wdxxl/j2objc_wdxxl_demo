...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/util/RecyclingByteBlockAllocator.java
//
...
- (IOSByteArray *)getByteBlock {
  @synchronized(self) {
    if (freeBlocks_ == 0) {
      ...
      return JreRetainedLocalValue([IOSByteArray arrayWithLength:blockSize_]);
    }
