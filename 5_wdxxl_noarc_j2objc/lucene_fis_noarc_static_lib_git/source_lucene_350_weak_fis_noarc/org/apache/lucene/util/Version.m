...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/util/Version.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilVersion class]) {
    ...
    for (jint i = 0; i < 13; i++) {
      ...
      OrgApacheLuceneUtilVersion_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheLuceneUtilVersion_class_(), i), i);
    }
