...
void OrgApacheLuceneUtilTwoPhaseCommitTool_executeWithOrgApacheLuceneUtilTwoPhaseCommitArray_(IOSObjectArray *objects) {
  ...
  @catch (JavaLangThrowable *t) {
    OrgApacheLuceneUtilTwoPhaseCommitTool_rollbackWithOrgApacheLuceneUtilTwoPhaseCommitArray_(objects);
    @throw create_OrgApacheLuceneUtilTwoPhaseCommitTool_PrepareCommitFailException_initWithJavaLangThrowable_withOrgApacheLuceneUtilTwoPhaseCommit_(t, tpc);
  }
  @try {
  ...
  @catch (JavaLangThrowable *t) {
    OrgApacheLuceneUtilTwoPhaseCommitTool_rollbackWithOrgApacheLuceneUtilTwoPhaseCommitArray_(objects);
    @throw create_OrgApacheLuceneUtilTwoPhaseCommitTool_CommitFailException_initWithJavaLangThrowable_withOrgApacheLuceneUtilTwoPhaseCommit_(t, tpc);
  }
}
