...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/util/BytesRef.java
//
...
- (NSString *)utf8ToString {
  ...
  @catch (JavaIoUnsupportedEncodingException *uee) {
    @throw create_JavaLangRuntimeException_initWithJavaLangThrowable_(uee);
  }
}
