...
inline JavaUtilTimeZone *OrgApacheCommonsLang3TimeDateFormatUtils_get_UTC_TIME_ZONE(void);
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeDateFormatUtils class]) {
    ...
    JreStrongAssign(&OrgApacheCommonsLang3TimeDateFormatUtils_ISO_DATETIME_FORMAT, OrgApacheCommonsLang3TimeFastDateFormat_getInstanceWithNSString_(@"yyyy-MM-dd'T'HH:mm:ss"));
    JreStrongAssign(&OrgApacheCommonsLang3TimeDateFormatUtils_ISO_DATETIME_TIME_ZONE_FORMAT, OrgApacheCommonsLang3TimeFastDateFormat_getInstanceWithNSString_(@"yyyy-MM-dd'T'HH:mm:ssZZ"));
    JreStrongAssign(&OrgApacheCommonsLang3TimeDateFormatUtils_ISO_DATE_FORMAT, OrgApacheCommonsLang3TimeFastDateFormat_getInstanceWithNSString_(@"yyyy-MM-dd"));
    ...
    JreStrongAssign(&OrgApacheCommonsLang3TimeDateFormatUtils_ISO_TIME_NO_T_FORMAT, OrgApacheCommonsLang3TimeFastDateFormat_getInstanceWithNSString_(@"HH:mm:ss"));
    JreStrongAssign(&OrgApacheCommonsLang3TimeDateFormatUtils_ISO_TIME_NO_T_TIME_ZONE_FORMAT, OrgApacheCommonsLang3TimeFastDateFormat_getInstanceWithNSString_(@"HH:mm:ssZZ"));
