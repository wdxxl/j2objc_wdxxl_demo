...
void OrgApacheCommonsLang3BuilderHashCodeBuilder_register__WithId_(id value) {
  ...
  @synchronized(OrgApacheCommonsLang3BuilderHashCodeBuilder_class_()) {
    if (OrgApacheCommonsLang3BuilderHashCodeBuilder_getRegistry() == nil) {
      [((JavaLangThreadLocal *) nil_chk(OrgApacheCommonsLang3BuilderHashCodeBuilder_REGISTRY)) setWithId:create_JavaUtilHashSet_init()];
    }
  }
  [((id<JavaUtilSet>) nil_chk(OrgApacheCommonsLang3BuilderHashCodeBuilder_getRegistry())) addWithId:create_OrgApacheCommonsLang3BuilderIDKey_initWithId_(value)];
}
...
void OrgApacheCommonsLang3BuilderHashCodeBuilder_unregisterWithId_(id value) {
  ...
  if (registry != nil) {
    ...
    @synchronized(OrgApacheCommonsLang3BuilderHashCodeBuilder_class_()) {
      registry = JreRetainedLocalValue(OrgApacheCommonsLang3BuilderHashCodeBuilder_getRegistry());
