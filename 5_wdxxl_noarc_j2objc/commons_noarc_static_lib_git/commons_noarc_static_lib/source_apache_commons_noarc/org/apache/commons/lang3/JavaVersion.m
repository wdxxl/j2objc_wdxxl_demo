...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3JavaVersion class]) {
    ...
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.9f, @"1.9", @"JAVA_1_9", 9);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_RECENT) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, OrgApacheCommonsLang3JavaVersion_maxVersion(), JavaLangFloat_toStringWithFloat_(OrgApacheCommonsLang3JavaVersion_maxVersion()), @"JAVA_RECENT", 10);
