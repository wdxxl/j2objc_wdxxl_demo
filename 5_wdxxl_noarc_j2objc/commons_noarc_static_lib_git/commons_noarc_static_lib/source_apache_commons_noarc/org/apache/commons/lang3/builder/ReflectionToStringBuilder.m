...
//  source: jar:file:commons-lang3-3.4-fis-sources.jar!org/apache/commons/lang3/builder/ReflectionToStringBuilder.java
//
    ...
    while (b__ < e__) {
      ...
      if ([self acceptWithJavaLangReflectField:field]) {
        ...
        @catch (JavaLangIllegalAccessException *ex) {
          @throw create_JavaLangInternalError_initWithNSString_(JreStrcat("$$", @"Unexpected IllegalAccessException: ", [ex getMessage]));
        }
      }
    }
  }
