...
inline jlong OrgApacheCommonsLang3Range_get_serialVersionUID(void);
...
@interface OrgApacheCommonsLang3Range_ComparableComparator : JavaLangEnum < JavaUtilComparator >
...
inline OrgApacheCommonsLang3Range_ComparableComparator *OrgApacheCommonsLang3Range_ComparableComparator_get_INSTANCE(void);
...
__attribute__((unused)) static IOSObjectArray *OrgApacheCommonsLang3Range_ComparableComparator_values(void);
...
- (NSString *)description {
  ...
  if (result == nil) {
    ...
    [buf appendWithChar:'['];
    [buf appendWithId:minimum_];
    [buf appendWithNSString:@".."];
    [buf appendWithId:maximum_];
    [buf appendWithChar:']'];
    result = [buf description];
    JreStrongAssign(&toString_, result);
  }
  return result;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3Range_ComparableComparator class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      ...
      OrgApacheCommonsLang3Range_ComparableComparator_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheCommonsLang3Range_ComparableComparator_class_(), i), i);
    }
