...
JavaUtilDate *OrgApacheCommonsLang3TimeDateUtils_parseDateWithLeniencyWithNSString_withJavaUtilLocale_withNSStringArray_withBoolean_(NSString *str, JavaUtilLocale *locale, IOSObjectArray *parsePatterns, jboolean lenient) {
  ...
  if (locale == nil) {
    parser = create_JavaTextSimpleDateFormat_init();
  }
  else {
    parser = create_JavaTextSimpleDateFormat_initWithNSString_withJavaUtilLocale_(@"", locale);
  }
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeDateUtils_ModifyType class]) {
    ...
    for (jint i = 0; i < 3; i++) {
      ...
      OrgApacheCommonsLang3TimeDateUtils_ModifyType_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheCommonsLang3TimeDateUtils_ModifyType_class_(), i), i);
    }
