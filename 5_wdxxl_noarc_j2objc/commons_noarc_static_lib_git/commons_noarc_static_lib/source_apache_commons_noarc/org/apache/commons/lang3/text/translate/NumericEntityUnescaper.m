...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION class]) {
    ...
    for (jint i = 0; i < 3; i++) {
      ...
      OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION_class_(), i), i);
    }
