...
FOUNDATION_EXPORT OrgApacheCommonsLang3TextTranslateEntityArrays *new_OrgApacheCommonsLang3TextTranslateEntityArrays_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3TextTranslateEntityArrays *create_OrgApacheCommonsLang3TextTranslateEntityArrays_init(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_ISO8859_1_ESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_ISO8859_1_UNESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_HTML40_EXTENDED_ESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_HTML40_EXTENDED_UNESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_BASIC_ESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_BASIC_UNESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_APOS_ESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_APOS_UNESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_JAVA_CTRL_CHARS_ESCAPE(void);

FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3TextTranslateEntityArrays_JAVA_CTRL_CHARS_UNESCAPE(void);
