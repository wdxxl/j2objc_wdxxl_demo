...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ClassUtils_Interfaces class]) {
    ...
    for (jint i = 0; i < 2; i++) {
      ...
      OrgApacheCommonsLang3ClassUtils_Interfaces_initWithNSString_withInt_(e, JreEnumConstantName(OrgApacheCommonsLang3ClassUtils_Interfaces_class_(), i), i);
    }
