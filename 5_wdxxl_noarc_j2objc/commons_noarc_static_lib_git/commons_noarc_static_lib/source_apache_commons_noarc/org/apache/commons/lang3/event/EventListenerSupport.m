...
inline jlong OrgApacheCommonsLang3EventEventListenerSupport_get_serialVersionUID(void);
...
__attribute__((unused)) static OrgApacheCommonsLang3EventEventListenerSupport *new_OrgApacheCommonsLang3EventEventListenerSupport_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgApacheCommonsLang3EventEventListenerSupport *create_OrgApacheCommonsLang3EventEventListenerSupport_init(void);

__attribute__((unused)) static void OrgApacheCommonsLang3EventEventListenerSupport_writeObjectWithJavaIoObjectOutputStream_(OrgApacheCommonsLang3EventEventListenerSupport *self, JavaIoObjectOutputStream *objectOutputStream);

__attribute__((unused)) static void OrgApacheCommonsLang3EventEventListenerSupport_readObjectWithJavaIoObjectInputStream_(OrgApacheCommonsLang3EventEventListenerSupport *self, JavaIoObjectInputStream *objectInputStream);
...
- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)objectOutputStream {
  OrgApacheCommonsLang3EventEventListenerSupport_writeObjectWithJavaIoObjectOutputStream_(self, objectOutputStream);
}

- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)objectInputStream {
  OrgApacheCommonsLang3EventEventListenerSupport_readObjectWithJavaIoObjectInputStream_(self, objectInputStream);
}
...
void OrgApacheCommonsLang3EventEventListenerSupport_writeObjectWithJavaIoObjectOutputStream_(OrgApacheCommonsLang3EventEventListenerSupport *self, JavaIoObjectOutputStream *objectOutputStream) {
  ...
  for (id __strong listener in nil_chk(self->listeners_)) {
    @try {
  ...
  [((JavaIoObjectOutputStream *) nil_chk(objectOutputStream)) writeObjectWithId:[serializableListeners toArrayWithNSObjectArray:self->prototypeArray_]];
}

void OrgApacheCommonsLang3EventEventListenerSupport_readObjectWithJavaIoObjectInputStream_(OrgApacheCommonsLang3EventEventListenerSupport *self, JavaIoObjectInputStream *objectInputStream) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "invoke", "LNSObject;LJavaLangReflectMethod;[LNSObject;", "LJavaLangThrowable;", "Lorg/apache/commons/lang3/event/EventListenerSupport<TL;>;", "LOrgApacheCommonsLang3EventEventListenerSupport;" };
