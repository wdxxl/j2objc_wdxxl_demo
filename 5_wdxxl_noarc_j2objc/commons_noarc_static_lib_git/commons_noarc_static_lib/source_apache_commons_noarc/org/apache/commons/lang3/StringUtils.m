...
NSString *OrgApacheCommonsLang3StringUtils_replaceWithNSString_withNSString_withNSString_withInt_(NSString *text, NSString *searchString, NSString *replacement, jint max) {
  ...
  JavaLangStringBuilder *buf = create_JavaLangStringBuilder_initWithInt_([text java_length] + increase);
...
NSString *OrgApacheCommonsLang3StringUtils_overlayWithNSString_withNSString_withInt_withInt_(NSString *str, NSString *overlay, jint start, jint end) {
  ...
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_initWithInt_(len + start - end + [((NSString *) nil_chk(overlay)) java_length] + 1) appendWithNSString:[str java_substring:0 endIndex:start]])) appendWithNSString:overlay])) appendWithNSString:[str java_substring:end]])) description];
}
...
NSString *OrgApacheCommonsLang3StringUtils_capitalizeWithNSString_(NSString *str) {
  ...
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_initWithInt_(strLen) appendWithChar:JavaLangCharacter_toTitleCaseWithChar_(firstChar)])) appendWithNSString:[str java_substring:1]])) description];
}
...
NSString *OrgApacheCommonsLang3StringUtils_uncapitalizeWithNSString_(NSString *str) {
  ...
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_initWithInt_(strLen) appendWithChar:JavaLangCharacter_toLowerCaseWithChar_(firstChar)])) appendWithNSString:[str java_substring:1]])) description];
}
...
NSString *OrgApacheCommonsLang3StringUtils_getSetOfMatchingCharacterWithinWithJavaLangCharSequence_withJavaLangCharSequence_withInt_(id<JavaLangCharSequence> first, id<JavaLangCharSequence> second, jint limit) {
  OrgApacheCommonsLang3StringUtils_initialize();
  JavaLangStringBuilder *common = create_JavaLangStringBuilder_init();
  JavaLangStringBuilder *copy_ = create_JavaLangStringBuilder_initWithJavaLangCharSequence_(second);
...
jint OrgApacheCommonsLang3StringUtils_commonPrefixLengthWithJavaLangCharSequence_withJavaLangCharSequence_(id<JavaLangCharSequence> first, id<JavaLangCharSequence> second) {
  OrgApacheCommonsLang3StringUtils_initialize();
  jint result = [((NSString *) nil_chk(OrgApacheCommonsLang3StringUtils_getCommonPrefixWithNSStringArray_([IOSObjectArray arrayWithObjects:(id[]){ [((id<JavaLangCharSequence>) nil_chk(first)) description], [((id<JavaLangCharSequence>) nil_chk(second)) description] } count:2 type:NSString_class_()]))) java_length];
