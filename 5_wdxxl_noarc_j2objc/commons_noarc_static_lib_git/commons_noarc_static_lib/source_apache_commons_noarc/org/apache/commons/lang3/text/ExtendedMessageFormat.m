...
//  source: jar:file:commons-lang3-3.4-fis-sources.jar!org/apache/commons/lang3/text/ExtendedMessageFormat.java
//
...
inline jlong OrgApacheCommonsLang3TextExtendedMessageFormat_get_serialVersionUID(void);
...
inline jint OrgApacheCommonsLang3TextExtendedMessageFormat_get_HASH_SEED(void);
...
inline NSString *OrgApacheCommonsLang3TextExtendedMessageFormat_get_DUMMY_PATTERN(void);
...
inline jchar OrgApacheCommonsLang3TextExtendedMessageFormat_get_START_FMT(void);
...
inline jchar OrgApacheCommonsLang3TextExtendedMessageFormat_get_END_FE(void);
...
inline jchar OrgApacheCommonsLang3TextExtendedMessageFormat_get_START_FE(void);
...
inline jchar OrgApacheCommonsLang3TextExtendedMessageFormat_get_QUOTE(void);
...
- (void)applyPatternWithNSString:(NSString *)pattern {
  ...
  JavaLangStringBuilder *stripCustom = create_JavaLangStringBuilder_initWithInt_([((NSString *) nil_chk(pattern)) java_length]);
...
NSString *OrgApacheCommonsLang3TextExtendedMessageFormat_insertFormatsWithNSString_withJavaUtilArrayList_(OrgApacheCommonsLang3TextExtendedMessageFormat *self, NSString *pattern, JavaUtilArrayList *customPatterns) {
  ...
  JavaLangStringBuilder *sb = create_JavaLangStringBuilder_initWithInt_([((NSString *) nil_chk(pattern)) java_length] * 2);
  JavaTextParsePosition *pos = create_JavaTextParsePosition_initWithInt_(0);
  jint fe = -1;
  jint depth = 0;
  while ([pos getIndex] < [pattern java_length]) {
