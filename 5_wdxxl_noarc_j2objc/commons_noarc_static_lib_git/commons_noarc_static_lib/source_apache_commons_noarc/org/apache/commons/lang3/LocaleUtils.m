...
JavaUtilLocale *OrgApacheCommonsLang3LocaleUtils_toLocaleWithNSString_(NSString *str) {
  ...
  if ([str java_isEmpty]) {
    return create_JavaUtilLocale_initWithNSString_withNSString_(@"", @"");
  }
  ...
  if (ch0 == '_') {
    ...
    if (len == 3) {
      return create_JavaUtilLocale_initWithNSString_withNSString_(@"", [str java_substring:1 endIndex:3]);
    }
    if (len < 5) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Invalid locale format: ", str));
    }
    ...
    return create_JavaUtilLocale_initWithNSString_withNSString_withNSString_(@"", [str java_substring:1 endIndex:3], [str java_substring:4]);
  }
...
id<JavaUtilList> OrgApacheCommonsLang3LocaleUtils_localeLookupListWithJavaUtilLocale_withJavaUtilLocale_(JavaUtilLocale *locale, JavaUtilLocale *defaultLocale) {
  ...
  if (locale != nil) {
    ...
    if ([((NSString *) nil_chk([locale getCountry])) java_length] > 0) {
      [list addWithId:create_JavaUtilLocale_initWithNSString_withNSString_([locale getLanguage], @"")];
    }
