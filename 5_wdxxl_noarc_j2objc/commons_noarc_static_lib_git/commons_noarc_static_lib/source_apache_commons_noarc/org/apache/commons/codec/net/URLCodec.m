...
- (NSString *)encodeWithNSString:(NSString *)str {
  ...
  @catch (JavaIoUnsupportedEncodingException *e) {
    @throw create_OrgApacheCommonsCodecEncoderException_initWithNSString_withJavaLangThrowable_([e getMessage], e);
  }
}
...
- (NSString *)decodeWithNSString:(NSString *)str {
  ...
  @catch (JavaIoUnsupportedEncodingException *e) {
    @throw create_OrgApacheCommonsCodecDecoderException_initWithNSString_withJavaLangThrowable_([e getMessage], e);
  }
}
...
- (id)encodeWithId:(id)obj {
  if (obj == nil) {
    ...
    @throw create_OrgApacheCommonsCodecEncoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[obj java_getClass] getName], @" cannot be URL encoded"));
  }
}
...
- (id)decodeWithId:(id)obj {
  if (obj == nil) {
    ...
    @throw create_OrgApacheCommonsCodecDecoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[obj java_getClass] getName], @" cannot be URL decoded"));
  }
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecNetURLCodec class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecNetURLCodec_WWW_FORM_URL, new_JavaUtilBitSet_initWithInt_(256));
    {
      for (jint i = 'a'; i <= 'z'; i++) {
  ...
  for (jint i = 0; i < bytes->size_; i++) {
    ...
    if (b == '+') {
      ...
      @catch (JavaLangArrayIndexOutOfBoundsException *e) {
        @throw create_OrgApacheCommonsCodecDecoderException_initWithNSString_withJavaLangThrowable_(@"Invalid URL encoding: ", e);
      }
    }
    else {
      [buffer writeWithInt:b];
