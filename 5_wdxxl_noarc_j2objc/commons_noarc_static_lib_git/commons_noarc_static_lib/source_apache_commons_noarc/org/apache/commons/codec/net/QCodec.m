...
- (IOSByteArray *)doDecodingWithByteArray:(IOSByteArray *)bytes {
  ...
  if (hasUnderscores) {
    IOSByteArray *tmp = [IOSByteArray arrayWithLength:bytes->size_];
...
- (id)encodeWithId:(id)obj {
  if (obj == nil) {
    ...
    @throw create_OrgApacheCommonsCodecEncoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[obj java_getClass] getName], @" cannot be encoded using Q codec"));
  }
}
...
- (id)decodeWithId:(id)obj {
  if (obj == nil) {
    ...
    @throw create_OrgApacheCommonsCodecDecoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[obj java_getClass] getName], @" cannot be decoded using Q codec"));
  }
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecNetQCodec class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecNetQCodec_PRINTABLE_CHARS, new_JavaUtilBitSet_initWithInt_(256));
    {
