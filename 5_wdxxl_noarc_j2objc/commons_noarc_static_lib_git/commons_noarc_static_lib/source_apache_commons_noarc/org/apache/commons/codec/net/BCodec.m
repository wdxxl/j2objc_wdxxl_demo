...
- (id)encodeWithId:(id)value {
  if (value == nil) {
    ...
    @throw create_OrgApacheCommonsCodecEncoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[value java_getClass] getName], @" cannot be encoded using BCodec"));
  }
}
...
- (id)decodeWithId:(id)value {
  if (value == nil) {
    ...
    @throw create_OrgApacheCommonsCodecDecoderException_initWithNSString_(JreStrcat("$$$", @"Objects of type ", [[value java_getClass] getName], @" cannot be decoded using BCodec"));
  }
}
