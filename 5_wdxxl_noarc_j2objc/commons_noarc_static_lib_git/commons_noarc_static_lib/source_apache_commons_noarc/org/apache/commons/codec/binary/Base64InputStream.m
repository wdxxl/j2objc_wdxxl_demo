...
void OrgApacheCommonsCodecBinaryBase64InputStream_initWithJavaIoInputStream_withBoolean_(OrgApacheCommonsCodecBinaryBase64InputStream *self, JavaIoInputStream *inArg, jboolean doEncode) {
  OrgApacheCommonsCodecBinaryBaseNCodecInputStream_initWithJavaIoInputStream_withOrgApacheCommonsCodecBinaryBaseNCodec_withBoolean_(self, inArg, create_OrgApacheCommonsCodecBinaryBase64_initWithBoolean_(false), doEncode);
}
...
void OrgApacheCommonsCodecBinaryBase64InputStream_initWithJavaIoInputStream_withBoolean_withInt_withByteArray_(OrgApacheCommonsCodecBinaryBase64InputStream *self, JavaIoInputStream *inArg, jboolean doEncode, jint lineLength, IOSByteArray *lineSeparator) {
  OrgApacheCommonsCodecBinaryBaseNCodecInputStream_initWithJavaIoInputStream_withOrgApacheCommonsCodecBinaryBaseNCodec_withBoolean_(self, inArg, create_OrgApacheCommonsCodecBinaryBase64_initWithInt_withByteArray_(lineLength, lineSeparator), doEncode);
}
