...
void OrgApacheCommonsCodecBinaryBase32InputStream_initWithJavaIoInputStream_withBoolean_(OrgApacheCommonsCodecBinaryBase32InputStream *self, JavaIoInputStream *inArg, jboolean doEncode) {
  OrgApacheCommonsCodecBinaryBaseNCodecInputStream_initWithJavaIoInputStream_withOrgApacheCommonsCodecBinaryBaseNCodec_withBoolean_(self, inArg, create_OrgApacheCommonsCodecBinaryBase32_initWithBoolean_(false), doEncode);
}
...
void OrgApacheCommonsCodecBinaryBase32InputStream_initWithJavaIoInputStream_withBoolean_withInt_withByteArray_(OrgApacheCommonsCodecBinaryBase32InputStream *self, JavaIoInputStream *inArg, jboolean doEncode, jint lineLength, IOSByteArray *lineSeparator) {
  OrgApacheCommonsCodecBinaryBaseNCodecInputStream_initWithJavaIoInputStream_withOrgApacheCommonsCodecBinaryBaseNCodec_withBoolean_(self, inArg, create_OrgApacheCommonsCodecBinaryBase32_initWithInt_withByteArray_(lineLength, lineSeparator), doEncode);
}
