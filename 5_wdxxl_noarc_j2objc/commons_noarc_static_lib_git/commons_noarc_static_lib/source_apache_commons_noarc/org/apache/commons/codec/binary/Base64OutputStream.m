...
void OrgApacheCommonsCodecBinaryBase64OutputStream_initWithJavaIoOutputStream_withBoolean_(OrgApacheCommonsCodecBinaryBase64OutputStream *self, JavaIoOutputStream *outArg, jboolean doEncode) {
  OrgApacheCommonsCodecBinaryBaseNCodecOutputStream_initWithJavaIoOutputStream_withOrgApacheCommonsCodecBinaryBaseNCodec_withBoolean_(self, outArg, create_OrgApacheCommonsCodecBinaryBase64_initWithBoolean_(false), doEncode);
}
...
void OrgApacheCommonsCodecBinaryBase64OutputStream_initWithJavaIoOutputStream_withBoolean_withInt_withByteArray_(OrgApacheCommonsCodecBinaryBase64OutputStream *self, JavaIoOutputStream *outArg, jboolean doEncode, jint lineLength, IOSByteArray *lineSeparator) {
  OrgApacheCommonsCodecBinaryBaseNCodecOutputStream_initWithJavaIoOutputStream_withOrgApacheCommonsCodecBinaryBaseNCodec_withBoolean_(self, outArg, create_OrgApacheCommonsCodecBinaryBase64_initWithInt_withByteArray_(lineLength, lineSeparator), doEncode);
}
