...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecCharsets class]) {
    JreStrongAssign(&OrgApacheCommonsCodecCharsets_ISO_8859_1, JavaNioCharsetCharset_forNameWithNSString_(OrgApacheCommonsCodecCharEncoding_ISO_8859_1));
    JreStrongAssign(&OrgApacheCommonsCodecCharsets_US_ASCII, JavaNioCharsetCharset_forNameWithNSString_(OrgApacheCommonsCodecCharEncoding_US_ASCII));
    JreStrongAssign(&OrgApacheCommonsCodecCharsets_UTF_16, JavaNioCharsetCharset_forNameWithNSString_(OrgApacheCommonsCodecCharEncoding_UTF_16));
    JreStrongAssign(&OrgApacheCommonsCodecCharsets_UTF_16BE, JavaNioCharsetCharset_forNameWithNSString_(OrgApacheCommonsCodecCharEncoding_UTF_16BE));
    JreStrongAssign(&OrgApacheCommonsCodecCharsets_UTF_16LE, JavaNioCharsetCharset_forNameWithNSString_(OrgApacheCommonsCodecCharEncoding_UTF_16LE));
    JreStrongAssign(&OrgApacheCommonsCodecCharsets_UTF_8, JavaNioCharsetCharset_forNameWithNSString_(OrgApacheCommonsCodecCharEncoding_UTF_8));
