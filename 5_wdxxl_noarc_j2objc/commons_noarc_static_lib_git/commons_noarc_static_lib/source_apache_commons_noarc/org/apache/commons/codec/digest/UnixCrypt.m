...
NSString *OrgApacheCommonsCodecDigestUnixCrypt_cryptWithByteArray_withNSString_(IOSByteArray *original, NSString *salt) {
  OrgApacheCommonsCodecDigestUnixCrypt_initialize();
  if (salt == nil) {
    JavaUtilRandom *randomGenerator = create_JavaUtilRandom_init();
    ...
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Invalid salt value: ", salt));
  }
  JavaLangStringBuilder *buffer = create_JavaLangStringBuilder_initWithNSString_(@"             ");
  ...
  IOSByteArray *key = [IOSByteArray arrayWithLength:8];
  ...
  IOSByteArray *b = [IOSByteArray arrayWithLength:9];
...
IOSIntArray *OrgApacheCommonsCodecDigestUnixCrypt_bodyWithIntArray_withInt_withInt_(IOSIntArray *schedule, jint eSwap0, jint eSwap1) {
  ...
  IOSIntArray *results = [IOSIntArray arrayWithLength:2];
  ...
  right = IOSIntArray_Get(results, 0);
  left = IOSIntArray_Get(results, 1);
  IOSIntArray *out = [IOSIntArray arrayWithLength:2];
...
IOSIntArray *OrgApacheCommonsCodecDigestUnixCrypt_desSetKeyWithByteArray_(IOSByteArray *key) {
  OrgApacheCommonsCodecDigestUnixCrypt_initialize();
  IOSIntArray *schedule = [IOSIntArray arrayWithLength:32];
