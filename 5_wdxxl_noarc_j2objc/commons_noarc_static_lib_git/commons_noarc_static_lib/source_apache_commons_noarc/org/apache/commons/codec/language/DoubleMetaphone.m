...
- (NSString *)doubleMetaphoneWithNSString:(NSString *)value
  ...
  OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result = create_OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_initWithOrgApacheCommonsCodecLanguageDoubleMetaphone_withInt_(self, [self getMaxCodeLen]);
...
- (id)encodeWithId:(id)obj {
  if (!([obj isKindOfClass:[NSString class]])) {
    @throw create_OrgApacheCommonsCodecEncoderException_initWithNSString_(@"DoubleMetaphone encode parameter is not of type String");
  }
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecLanguageDoubleMetaphone class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecLanguageDoubleMetaphone_SILENT_START, [IOSObjectArray newArrayWithObjects:(id[]){ @"GN", @"KN", @"PN", @"WR", @"PS" } count:5 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecLanguageDoubleMetaphone_L_R_N_M_B_H_F_V_W_SPACE, [IOSObjectArray newArrayWithObjects:(id[]){ @"L", @"R", @"N", @"M", @"B", @"H", @"F", @"V", @"W", @" " } count:10 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecLanguageDoubleMetaphone_ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER, [IOSObjectArray newArrayWithObjects:(id[]){ @"ES", @"EP", @"EB", @"EL", @"EY", @"IB", @"IL", @"IN", @"IE", @"EI", @"ER" } count:11 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecLanguageDoubleMetaphone_L_T_K_S_N_M_B_Z, [IOSObjectArray newArrayWithObjects:(id[]){ @"L", @"T", @"K", @"S", @"N", @"M", @"B", @"Z" } count:8 type:NSString_class_()]);
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleCWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_conditionC0WithNSString_withInt_(self, value, index)) {
  ...
  else if (index == 0 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 6, [IOSObjectArray arrayWithObjects:(id[]){ @"CAESAR" } count:1 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S'];
    index += 2;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"CH" } count:1 type:NSString_class_()])) {
  ...
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"CZ" } count:1 type:NSString_class_()]) && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 2, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"WICZ" } count:1 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S' withChar:'X'];
    index += 2;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"CIA" } count:1 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'X'];
    index += 3;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"CC" } count:1 type:NSString_class_()]) && !(index == 1 && [self charAtWithNSString:value withInt:0] == 'M')) {
    return OrgApacheCommonsCodecLanguageDoubleMetaphone_handleCCWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(self, value, result, index);
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"CK", @"CG", @"CQ" } count:3 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'K'];
    index += 2;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"CI", @"CE", @"CY" } count:3 type:NSString_class_()])) {
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"CIO", @"CIE", @"CIA" } count:3 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S' withChar:'X'];
    }
    else {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S'];
    ...
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'K'];
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 2, [IOSObjectArray arrayWithObjects:(id[]){ @" C", @" Q", @" G" } count:3 type:NSString_class_()])) {
      index += 3;
    }
    else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"C", @"K", @"Q" } count:3 type:NSString_class_()]) && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"CE", @"CI" } count:2 type:NSString_class_()])) {
      index += 2;
    }
    else {
      index++;
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleCCWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"I", @"E", @"H" } count:3 type:NSString_class_()]) && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"HU" } count:1 type:NSString_class_()])) {
    if ((index == 1 && [self charAtWithNSString:value withInt:index - 1] == 'A') || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 5, [IOSObjectArray arrayWithObjects:(id[]){ @"UCCEE", @"UCCES" } count:2 type:NSString_class_()])) {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleCHWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if (index > 0 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"CHAE" } count:1 type:NSString_class_()])) {
    ...
    if (index > 0) {
      if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"MC" } count:1 type:NSString_class_()])) {
        [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'K'];
      }
      else {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleDWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"DG" } count:1 type:NSString_class_()])) {
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"I", @"E", @"Y" } count:3 type:NSString_class_()])) {
  ...
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"DT", @"DD" } count:2 type:NSString_class_()])) {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleGWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_withBoolean_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index, jboolean slavoGermanic) {
  if ([self charAtWithNSString:value withInt:index + 1] == 'H') {
    ...
    else if (!OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"EY" } count:1 type:NSString_class_()]) && [self charAtWithNSString:value withInt:index + 1] != 'Y' && !slavoGermanic) {
  ...
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"LI" } count:1 type:NSString_class_()]) && !slavoGermanic) {
  ...
  else if ((OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"ER" } count:1 type:NSString_class_()]) || [self charAtWithNSString:value withInt:index + 1] == 'Y') && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 6, [IOSObjectArray arrayWithObjects:(id[]){ @"DANGER", @"RANGER", @"MANGER" } count:3 type:NSString_class_()]) && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"E", @"I" } count:2 type:NSString_class_()]) && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"RGY", @"OGY" } count:2 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'K' withChar:'J'];
    index += 2;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"E", @"I", @"Y" } count:3 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"AGGI", @"OGGI" } count:2 type:NSString_class_()])) {
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"VAN ", @"VON " } count:2 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"SCH" } count:1 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"ET" } count:1 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'K'];
    }
    else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"IER" } count:1 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'J'];
    }
    else {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleGHWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  ...
  else if ((index > 1 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 2, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"B", @"H", @"D" } count:3 type:NSString_class_()])) || (index > 2 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 3, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"B", @"H", @"D" } count:3 type:NSString_class_()])) || (index > 3 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 4, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"B", @"H" } count:2 type:NSString_class_()]))) {
    index += 2;
  }
  else {
    if (index > 2 && [self charAtWithNSString:value withInt:index - 1] == 'U' && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 3, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"C", @"G", @"L", @"R", @"T" } count:5 type:NSString_class_()])) {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleJWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_withBoolean_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index, jboolean slavoGermanic) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"JOSE" } count:1 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"SAN " } count:1 type:NSString_class_()])) {
    if (((index == 0 && ([self charAtWithNSString:value withInt:index + 4] == ' ')) || [((NSString *) nil_chk(value)) java_length] == 4) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"SAN " } count:1 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'H'];
    }
    else {
    ...
    if (index == 0 && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"JOSE" } count:1 type:NSString_class_()])) {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handlePWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if ([self charAtWithNSString:value withInt:index + 1] == 'H') {
    ...
    index = OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"P", @"B" } count:2 type:NSString_class_()]) ? index + 2 : index + 1;
  }
  return index;
}

jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleRWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_withBoolean_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index, jboolean slavoGermanic) {
  if (index == [((NSString *) nil_chk(value)) java_length] - 1 && !slavoGermanic && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"IE" } count:1 type:NSString_class_()]) && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 4, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"ME", @"MA" } count:2 type:NSString_class_()])) {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleSWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_withBoolean_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index, jboolean slavoGermanic) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"ISL", @"YSL" } count:2 type:NSString_class_()])) {
    index++;
  }
  else if (index == 0 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 5, [IOSObjectArray arrayWithObjects:(id[]){ @"SUGAR" } count:1 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'X' withChar:'S'];
    index++;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"SH" } count:1 type:NSString_class_()])) {
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"HEIM", @"HOEK", @"HOLM", @"HOLZ" } count:4 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S'];
    }
    else {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'X'];
  ...
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"SIO", @"SIA" } count:2 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"SIAN" } count:1 type:NSString_class_()])) {
    if (slavoGermanic) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S'];
    }
    else {
  ...
  else if ((index == 0 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"M", @"N", @"L", @"W" } count:4 type:NSString_class_()])) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"Z" } count:1 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S' withChar:'X'];
    index = OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"Z" } count:1 type:NSString_class_()]) ? index + 2 : index + 1;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"SC" } count:1 type:NSString_class_()])) {
    ...
    if (index == [((NSString *) nil_chk(value)) java_length] - 1 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"AI", @"OI" } count:2 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendAlternateWithChar:'S'];
    }
    else {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S'];
    }
    index = OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"S", @"Z" } count:2 type:NSString_class_()]) ? index + 2 : index + 1;
  }
  return index;
}
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleSCWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if ([self charAtWithNSString:value withInt:index + 2] == 'H') {
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 3, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"OO", @"ER", @"EN", @"UY", @"ED", @"EM" } count:6 type:NSString_class_()])) {
      if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 3, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"ER", @"EN" } count:2 type:NSString_class_()])) {
  ...
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"I", @"E", @"Y" } count:3 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'S'];
  }
  else {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithNSString:@"SK"];
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleTWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"TION" } count:1 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'X'];
    index += 3;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"TIA", @"TCH" } count:2 type:NSString_class_()])) {
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'X'];
    index += 3;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"TH" } count:1 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"TTH" } count:1 type:NSString_class_()])) {
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"OM", @"AM" } count:2 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"VAN ", @"VON " } count:2 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"SCH" } count:1 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'T'];
    }
    else {
    ...
    [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithChar:'T'];
    index = OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"T", @"D" } count:2 type:NSString_class_()]) ? index + 2 : index + 1;
  }
  return index;
}
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleWWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"WR" } count:1 type:NSString_class_()])) {
    ...
    else if ((index == [((NSString *) nil_chk(value)) java_length] - 1 && OrgApacheCommonsCodecLanguageDoubleMetaphone_isVowelWithChar_(self, [self charAtWithNSString:value withInt:index - 1])) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 5, [IOSObjectArray arrayWithObjects:(id[]){ @"EWSKI", @"EWSKY", @"OWSKI", @"OWSKY" } count:4 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"SCH" } count:1 type:NSString_class_()])) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendAlternateWithChar:'F'];
      index++;
    }
    else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"WICZ", @"WITZ" } count:2 type:NSString_class_()])) {
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleXWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index) {
  if (index == 0) {
    ...
    if (!((index == [((NSString *) nil_chk(value)) java_length] - 1) && (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 3, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"IAU", @"EAU" } count:2 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"AU", @"OU" } count:2 type:NSString_class_()])))) {
      [((OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *) nil_chk(result)) appendWithNSString:@"KS"];
    }
    index = OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"C", @"X" } count:2 type:NSString_class_()]) ? index + 2 : index + 1;
  }
  return index;
}
...
jint OrgApacheCommonsCodecLanguageDoubleMetaphone_handleZWithNSString_withOrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_withInt_withBoolean_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *result, jint index, jboolean slavoGermanic) {
  if ([self charAtWithNSString:value withInt:index + 1] == 'H') {
    ...
    if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"ZO", @"ZI", @"ZA" } count:3 type:NSString_class_()]) || (slavoGermanic && (index > 0 && [self charAtWithNSString:value withInt:index - 1] != 'T'))) {
...
jboolean OrgApacheCommonsCodecLanguageDoubleMetaphone_conditionC0WithNSString_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, jint index) {
  if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"CHIA" } count:1 type:NSString_class_()])) {
    return true;
  }
  else if (index <= 1) {
    return false;
  ...
  else if (!OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"ACH" } count:1 type:NSString_class_()])) {
    return false;
  }
  else {
    jchar c = [self charAtWithNSString:value withInt:index + 2];
    return (c != 'I' && c != 'E') || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 2, 6, [IOSObjectArray arrayWithObjects:(id[]){ @"BACHER", @"MACHER" } count:2 type:NSString_class_()]);
  }
}
...
jboolean OrgApacheCommonsCodecLanguageDoubleMetaphone_conditionCH0WithNSString_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, jint index) {
  ...
  else if (!OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 5, [IOSObjectArray arrayWithObjects:(id[]){ @"HARAC", @"HARIS" } count:2 type:NSString_class_()]) && !OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 1, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"HOR", @"HYM", @"HIA", @"HEM" } count:4 type:NSString_class_()])) {
    return false;
  }
  else if (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 5, [IOSObjectArray arrayWithObjects:(id[]){ @"CHORE" } count:1 type:NSString_class_()])) {
    return false;
  }
  else {
    return true;
...
jboolean OrgApacheCommonsCodecLanguageDoubleMetaphone_conditionCH1WithNSString_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, jint index) {
  return ((OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"VAN ", @"VON " } count:2 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, 0, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"SCH" } count:1 type:NSString_class_()])) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 2, 6, [IOSObjectArray arrayWithObjects:(id[]){ @"ORCHES", @"ARCHIT", @"ORCHID" } count:3 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"T", @"S" } count:2 type:NSString_class_()]) || ((OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"A", @"O", @"U", @"E" } count:4 type:NSString_class_()]) || index == 0) && (OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 1, OrgApacheCommonsCodecLanguageDoubleMetaphone_L_R_N_M_B_H_F_V_W_SPACE) || index + 1 == [((NSString *) nil_chk(value)) java_length] - 1)));
}
...
jboolean OrgApacheCommonsCodecLanguageDoubleMetaphone_conditionL0WithNSString_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, jint index) {
  if (index == [((NSString *) nil_chk(value)) java_length] - 3 && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"ILLO", @"ILLA", @"ALLE" } count:3 type:NSString_class_()])) {
    return true;
  }
  else if ((OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, [value java_length] - 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"AS", @"OS" } count:2 type:NSString_class_()]) || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, [value java_length] - 1, 1, [IOSObjectArray arrayWithObjects:(id[]){ @"A", @"O" } count:2 type:NSString_class_()])) && OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 4, [IOSObjectArray arrayWithObjects:(id[]){ @"ALLE" } count:1 type:NSString_class_()])) {
    return true;
  }
  else {
    return false;
...
jboolean OrgApacheCommonsCodecLanguageDoubleMetaphone_conditionM0WithNSString_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone *self, NSString *value, jint index) {
  ...
  return OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index - 1, 3, [IOSObjectArray arrayWithObjects:(id[]){ @"UMB" } count:1 type:NSString_class_()]) && ((index + 1) == [((NSString *) nil_chk(value)) java_length] - 1 || OrgApacheCommonsCodecLanguageDoubleMetaphone_containsWithNSString_withInt_withInt_withNSStringArray_(value, index + 2, 2, [IOSObjectArray arrayWithObjects:(id[]){ @"ER" } count:1 type:NSString_class_()]));
}
...
- (void)appendPrimaryWithNSString:(NSString *)value {
  ...
  if ([((NSString *) nil_chk(value)) java_length] <= addChars) {
    [self->primary_ appendWithNSString:value];
  }
  else {
    [self->primary_ appendWithNSString:[value java_substring:0 endIndex:addChars]];
  }
}
...
- (void)appendAlternateWithNSString:(NSString *)value {
  ...
  if ([((NSString *) nil_chk(value)) java_length] <= addChars) {
    [self->alternate_ appendWithNSString:value];
  }
  else {
    [self->alternate_ appendWithNSString:[value java_substring:0 endIndex:addChars]];
  }
}
...
void OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult_initWithOrgApacheCommonsCodecLanguageDoubleMetaphone_withInt_(OrgApacheCommonsCodecLanguageDoubleMetaphone_DoubleMetaphoneResult *self, OrgApacheCommonsCodecLanguageDoubleMetaphone *outer$, jint maxLength) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->primary_, new_JavaLangStringBuilder_initWithInt_([outer$ getMaxCodeLen]));
  JreStrongAssignAndConsume(&self->alternate_, new_JavaLangStringBuilder_initWithInt_([outer$ getMaxCodeLen]));
