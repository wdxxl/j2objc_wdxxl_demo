...
- (jboolean)patternAndContextMatchesWithJavaLangCharSequence:(id<JavaLangCharSequence>)input
                                                     withInt:(jint)i {
  if (i < 0) {
    @throw create_JavaLangIndexOutOfBoundsException_initWithNSString_(@"Can not match pattern at negative indexes");
  }
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecLanguageBmRule class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecLanguageBmRule_ALL_STRINGS_RMATCHER, new_OrgApacheCommonsCodecLanguageBmRule_1_init());
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecLanguageBmRule_RULES, new_JavaUtilEnumMap_initWithIOSClass_(OrgApacheCommonsCodecLanguageBmNameType_class_()));
    {
      {
        ...
        while (b__ < e__) {
          ...
          id<JavaUtilMap> rts = create_JavaUtilEnumMap_initWithIOSClass_(OrgApacheCommonsCodecLanguageBmRuleType_class_());
          {
            ...
            while (b__ < e__) {
              ...
              id<JavaUtilMap> rs = create_JavaUtilHashMap_init();
              ...
              for (NSString * __strong l in nil_chk([((OrgApacheCommonsCodecLanguageBmLanguages *) nil_chk(ls)) getLanguages])) {
                @try {
                  [rs putWithId:l withId:OrgApacheCommonsCodecLanguageBmRule_parseRulesWithJavaUtilScanner_withNSString_(OrgApacheCommonsCodecLanguageBmRule_createScannerWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withNSString_(s, rt, l), OrgApacheCommonsCodecLanguageBmRule_createResourceNameWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withNSString_(s, rt, l))];
                }
                @catch (JavaLangIllegalStateException *e) {
                  @throw create_JavaLangIllegalStateException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"Problem processing ", OrgApacheCommonsCodecLanguageBmRule_createResourceNameWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withNSString_(s, rt, l)), e);
                }
              }
              if (![((OrgApacheCommonsCodecLanguageBmRuleType *) nil_chk(rt)) isEqual:JreLoadEnum(OrgApacheCommonsCodecLanguageBmRuleType, RULES)]) {
                [rs putWithId:@"common" withId:OrgApacheCommonsCodecLanguageBmRule_parseRulesWithJavaUtilScanner_withNSString_(OrgApacheCommonsCodecLanguageBmRule_createScannerWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withNSString_(s, rt, @"common"), OrgApacheCommonsCodecLanguageBmRule_createResourceNameWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withNSString_(s, rt, @"common"))];
              }
              [rts putWithId:rt withId:JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(rs)];
            }
          }
          [OrgApacheCommonsCodecLanguageBmRule_RULES putWithId:s withId:JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(rts)];
        }
      }
    }
...
NSString *OrgApacheCommonsCodecLanguageBmRule_createResourceNameWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withNSString_(OrgApacheCommonsCodecLanguageBmNameType *nameType, OrgApacheCommonsCodecLanguageBmRuleType *rt, NSString *lang) {
  OrgApacheCommonsCodecLanguageBmRule_initialize();
  return NSString_java_formatWithNSString_withNSObjectArray_(@"org/apache/commons/codec/language/bm/%s_%s_%s.txt", [IOSObjectArray arrayWithObjects:(id[]){ [((OrgApacheCommonsCodecLanguageBmNameType *) nil_chk(nameType)) getName], [((OrgApacheCommonsCodecLanguageBmRuleType *) nil_chk(rt)) getName], lang } count:3 type:NSObject_class_()]);
}
...
JavaUtilScanner *OrgApacheCommonsCodecLanguageBmRule_createScannerWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withNSString_(OrgApacheCommonsCodecLanguageBmNameType *nameType, OrgApacheCommonsCodecLanguageBmRuleType *rt, NSString *lang) {
  ...
  if (rulesIS == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Unable to load resource: ", resName));
  }
  return create_JavaUtilScanner_initWithJavaIoInputStream_withNSString_(rulesIS, OrgApacheCommonsCodecLanguageBmResourceConstants_ENCODING);
}

JavaUtilScanner *OrgApacheCommonsCodecLanguageBmRule_createScannerWithNSString_(NSString *lang) {
  OrgApacheCommonsCodecLanguageBmRule_initialize();
  NSString *resName = NSString_java_formatWithNSString_withNSObjectArray_(@"org/apache/commons/codec/language/bm/%s.txt", [IOSObjectArray arrayWithObjects:(id[]){ lang } count:1 type:NSObject_class_()]);
  JavaIoInputStream *rulesIS = [((JavaLangClassLoader *) nil_chk([OrgApacheCommonsCodecLanguageBmLanguages_class_() getClassLoader])) getResourceAsStreamWithNSString:resName];
  if (rulesIS == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Unable to load resource: ", resName));
  }
...
id<JavaUtilList> OrgApacheCommonsCodecLanguageBmRule_getInstanceWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withOrgApacheCommonsCodecLanguageBmLanguages_LanguageSet_(OrgApacheCommonsCodecLanguageBmNameType *nameType, OrgApacheCommonsCodecLanguageBmRuleType *rt, OrgApacheCommonsCodecLanguageBmLanguages_LanguageSet *langs) {
  ...
  id<JavaUtilList> allRules = create_JavaUtilArrayList_init();
...
OrgApacheCommonsCodecLanguageBmRule_Phoneme *OrgApacheCommonsCodecLanguageBmRule_parsePhonemeWithNSString_(NSString *ph) {
  ...
  if (open >= 0) {
    if (![ph java_hasSuffix:@"]"]) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Phoneme expression contains a '[' but does not end in ']'");
    }
    NSString *before = [ph java_substring:0 endIndex:open];
    NSString *in = [ph java_substring:open + 1 endIndex:[ph java_length] - 1];
    id<JavaUtilSet> langs = create_JavaUtilHashSet_initWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_([((NSString *) nil_chk(in)) java_split:@"[+]"]));
    return create_OrgApacheCommonsCodecLanguageBmRule_Phoneme_initWithJavaLangCharSequence_withOrgApacheCommonsCodecLanguageBmLanguages_LanguageSet_(before, OrgApacheCommonsCodecLanguageBmLanguages_LanguageSet_fromWithJavaUtilSet_(langs));
  }
  else {
    return create_OrgApacheCommonsCodecLanguageBmRule_Phoneme_initWithJavaLangCharSequence_withOrgApacheCommonsCodecLanguageBmLanguages_LanguageSet_(ph, JreLoadStatic(OrgApacheCommonsCodecLanguageBmLanguages, ANY_LANGUAGE));
  }
}
...
id<OrgApacheCommonsCodecLanguageBmRule_PhonemeExpr> OrgApacheCommonsCodecLanguageBmRule_parsePhonemeExprWithNSString_(NSString *ph) {
  ...
  if ([((NSString *) nil_chk(ph)) java_hasPrefix:@"("]) {
    if (![ph java_hasSuffix:@")"]) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Phoneme starts with '(' so must end with ')'");
    }
    id<JavaUtilList> phs = create_JavaUtilArrayList_init();
    ...
    if ([body java_hasPrefix:@"|"] || [body java_hasSuffix:@"|"]) {
      [phs addWithId:create_OrgApacheCommonsCodecLanguageBmRule_Phoneme_initWithJavaLangCharSequence_withOrgApacheCommonsCodecLanguageBmLanguages_LanguageSet_(@"", JreLoadStatic(OrgApacheCommonsCodecLanguageBmLanguages, ANY_LANGUAGE))];
    }
    return create_OrgApacheCommonsCodecLanguageBmRule_PhonemeList_initWithJavaUtilList_(phs);
  }
  else {
    return OrgApacheCommonsCodecLanguageBmRule_parsePhonemeWithNSString_(ph);
  }
...
id<JavaUtilMap> OrgApacheCommonsCodecLanguageBmRule_parseRulesWithJavaUtilScanner_withNSString_(JavaUtilScanner *scanner, NSString *location) {
  OrgApacheCommonsCodecLanguageBmRule_initialize();
  id<JavaUtilMap> lines = create_JavaUtilHashMap_init();
  jint currentLine = 0;
      ...
      if ([((NSString *) nil_chk(line)) java_hasPrefix:OrgApacheCommonsCodecLanguageBmResourceConstants_EXT_CMT_START]) {
        ...
        if ([line java_hasPrefix:OrgApacheCommonsCodecLanguageBmRule_HASH_INCLUDE]) {
          ...
          if ([((NSString *) nil_chk(incl)) java_contains:@" "]) {
            @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$$", @"Malformed import statement '", rawLine, @"' in ", location));
          }
          else {
          ...
          if (((IOSObjectArray *) nil_chk(parts))->size_ != 4) {
            @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$$$$", @"Malformed rule statement split into ", parts->size_, @" parts: ", rawLine, @" in ", location));
          }
          else {
            @try {
              ...
              OrgApacheCommonsCodecLanguageBmRule *r = create_OrgApacheCommonsCodecLanguageBmRule_2_initWithInt_withNSString_withNSString_withNSString_withNSString_withNSString_withNSString_withNSString_withOrgApacheCommonsCodecLanguageBmRule_PhonemeExpr_(cLine, location, pat, lCon, rCon, pat, lCon, rCon, ph);
              ...
              if (rules == nil) {
                rules = create_JavaUtilArrayList_init();
                [lines putWithId:patternKey withId:rules];
              }
              [rules addWithId:r];
            }
            @catch (JavaLangIllegalArgumentException *e) {
              @throw create_JavaLangIllegalStateException_initWithNSString_withJavaLangThrowable_(JreStrcat("$I$$", @"Problem parsing line '", currentLine, @"' in ", location), e);
            }
          }
        }
      }
  ...
  if (!boxes) {
    if (startsWith && endsWith) {
      if ([content java_length] == 0) {
        return create_OrgApacheCommonsCodecLanguageBmRule_3_init();
      }
      else {
        return create_OrgApacheCommonsCodecLanguageBmRule_4_initWithNSString_(content);
      }
    }
      ...
      return create_OrgApacheCommonsCodecLanguageBmRule_5_initWithNSString_(content);
    }
    else if (endsWith) {
      return create_OrgApacheCommonsCodecLanguageBmRule_6_initWithNSString_(content);
    }
  }
  else {
    ...
    if (startsWithBox && endsWithBox) {
      ...
      if (![((NSString *) nil_chk(boxContent)) java_contains:@"["]) {
        ...
        if (startsWith && endsWith) {
          return create_OrgApacheCommonsCodecLanguageBmRule_7_initWithNSString_withBoolean_(bContent, shouldMatch);
        }
        else if (startsWith) {
          return create_OrgApacheCommonsCodecLanguageBmRule_8_initWithNSString_withBoolean_(bContent, shouldMatch);
        }
        else if (endsWith) {
          return create_OrgApacheCommonsCodecLanguageBmRule_9_initWithNSString_withBoolean_(bContent, shouldMatch);
        }
      }
    }
  }
  return create_OrgApacheCommonsCodecLanguageBmRule_10_initWithNSString_(regex);
}
...
void OrgApacheCommonsCodecLanguageBmRule_initWithNSString_withNSString_withNSString_withOrgApacheCommonsCodecLanguageBmRule_PhonemeExpr_(OrgApacheCommonsCodecLanguageBmRule *self, NSString *pattern, NSString *lContext, NSString *rContext, id<OrgApacheCommonsCodecLanguageBmRule_PhonemeExpr> phoneme) {
  ...
  JreStrongAssign(&self->lContext_, OrgApacheCommonsCodecLanguageBmRule_patternWithNSString_(JreStrcat("$C", lContext, '$')));
  JreStrongAssign(&self->rContext_, OrgApacheCommonsCodecLanguageBmRule_patternWithNSString_(JreStrcat("C$", '^', rContext)));
  JreStrongAssign(&self->phoneme_, phoneme);
}
...
- (OrgApacheCommonsCodecLanguageBmRule_Phoneme *)appendWithJavaLangCharSequence:(id<JavaLangCharSequence>)str {
  [((JavaLangStringBuilder *) nil_chk(self->phonemeText_)) appendWithJavaLangCharSequence:str];
  return self;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCodecLanguageBmRule_Phoneme class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsCodecLanguageBmRule_Phoneme_COMPARATOR, new_OrgApacheCommonsCodecLanguageBmRule_Phoneme_1_init());
...
void OrgApacheCommonsCodecLanguageBmRule_Phoneme_initWithJavaLangCharSequence_withOrgApacheCommonsCodecLanguageBmLanguages_LanguageSet_(OrgApacheCommonsCodecLanguageBmRule_Phoneme *self, id<JavaLangCharSequence> phonemeText, OrgApacheCommonsCodecLanguageBmLanguages_LanguageSet *languages) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->phonemeText_, new_JavaLangStringBuilder_initWithJavaLangCharSequence_(phonemeText));
...
void OrgApacheCommonsCodecLanguageBmRule_Phoneme_initWithOrgApacheCommonsCodecLanguageBmRule_Phoneme_withOrgApacheCommonsCodecLanguageBmRule_Phoneme_(OrgApacheCommonsCodecLanguageBmRule_Phoneme *self, OrgApacheCommonsCodecLanguageBmRule_Phoneme *phonemeLeft, OrgApacheCommonsCodecLanguageBmRule_Phoneme *phonemeRight) {
  ...
  [((JavaLangStringBuilder *) nil_chk(self->phonemeText_)) appendWithJavaLangCharSequence:((OrgApacheCommonsCodecLanguageBmRule_Phoneme *) nil_chk(phonemeRight))->phonemeText_];
}
...
- (NSString *)description {
  ...
  [sb appendWithNSString:@"Rule"];
  [((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"{line="])) appendWithInt:myLine_];
  [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@", loc='"])) appendWithNSString:loc_])) appendWithChar:'\''];
  [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@", pat='"])) appendWithNSString:val$pat_])) appendWithChar:'\''];
  [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@", lcon='"])) appendWithNSString:val$lCon_])) appendWithChar:'\''];
  [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@", rcon='"])) appendWithNSString:val$rCon_])) appendWithChar:'\''];
  [sb appendWithChar:'}'];
...
void OrgApacheCommonsCodecLanguageBmRule_2_initWithInt_withNSString_withNSString_withNSString_withNSString_withNSString_withNSString_withNSString_withOrgApacheCommonsCodecLanguageBmRule_PhonemeExpr_(OrgApacheCommonsCodecLanguageBmRule_2 *self, jint capture$0, NSString *capture$1, NSString *capture$2, NSString *capture$3, NSString *capture$4, NSString *pattern, NSString *lContext, NSString *rContext, id<OrgApacheCommonsCodecLanguageBmRule_PhonemeExpr> phoneme) {
  JreStrongAssign(&self->val$pat_, capture$2);
  JreStrongAssign(&self->val$lCon_, capture$3);
  JreStrongAssign(&self->val$rCon_, capture$4);
  OrgApacheCommonsCodecLanguageBmRule_initWithNSString_withNSString_withNSString_withOrgApacheCommonsCodecLanguageBmRule_PhonemeExpr_(self, pattern, lContext, rContext, phoneme);
  self->myLine_ = capture$0;
  JreStrongAssign(&self->loc_, capture$1);
}
...
void OrgApacheCommonsCodecLanguageBmRule_4_initWithNSString_(OrgApacheCommonsCodecLanguageBmRule_4 *self, NSString *capture$0) {
  JreStrongAssign(&self->val$content_, capture$0);
  NSObject_init(self);
}
...
void OrgApacheCommonsCodecLanguageBmRule_7_initWithNSString_withBoolean_(OrgApacheCommonsCodecLanguageBmRule_7 *self, NSString *capture$0, jboolean capture$1) {
  JreStrongAssign(&self->val$bContent_, capture$0);
...
void OrgApacheCommonsCodecLanguageBmRule_10_initWithNSString_(OrgApacheCommonsCodecLanguageBmRule_10 *self, NSString *capture$0) {
  NSObject_init(self);
  JreStrongAssign(&self->pattern_, JavaUtilRegexPattern_compileWithNSString_(capture$0));
}
