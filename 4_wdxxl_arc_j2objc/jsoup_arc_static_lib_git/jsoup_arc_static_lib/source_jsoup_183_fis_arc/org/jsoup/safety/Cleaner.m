...
jint OrgJsoupSafetyCleaner_copySafeNodesWithOrgJsoupNodesElement_withOrgJsoupNodesElement_(OrgJsoupSafetyCleaner *self, OrgJsoupNodesElement *source, OrgJsoupNodesElement *dest) {
  OrgJsoupSafetyCleaner_CleaningVisitor *cleaningVisitor = new_OrgJsoupSafetyCleaner_CleaningVisitor_initWithOrgJsoupSafetyCleaner_withOrgJsoupNodesElement_withOrgJsoupNodesElement_(self, source, dest);
  OrgJsoupSelectNodeTraversor *traversor = new_OrgJsoupSelectNodeTraversor_initWithOrgJsoupSelectNodeVisitor_(cleaningVisitor);
...
OrgJsoupSafetyCleaner_ElementMeta *OrgJsoupSafetyCleaner_createSafeElementWithOrgJsoupNodesElement_(OrgJsoupSafetyCleaner *self, OrgJsoupNodesElement *sourceEl) {
  ...
  OrgJsoupNodesAttributes *destAttrs = new_OrgJsoupNodesAttributes_init();
  OrgJsoupNodesElement *dest = new_OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_withOrgJsoupNodesAttributes_(OrgJsoupParserTag_valueOfWithNSString_(sourceTag), [sourceEl baseUri], destAttrs);
  jint numDiscarded = 0;
  ...
  return new_OrgJsoupSafetyCleaner_ElementMeta_initWithOrgJsoupNodesElement_withInt_(dest, numDiscarded);
}
...
- (void)headWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)source
  ...
  if ([source isKindOfClass:[OrgJsoupNodesElement class]]) {
    ...
    if ([((OrgJsoupSafetyWhitelist *) nil_chk(this$0_->whitelist_)) isSafeTagWithNSString:[((OrgJsoupNodesElement *) nil_chk(sourceEl)) tagName]]) {
      ...
      (void) [((OrgJsoupNodesElement *) nil_chk(destination_)) appendChildWithOrgJsoupNodesNode:destChild];
      numDiscarded_ += meta->numAttribsDiscarded_;
      destination_ = destChild;
    }
    ...
    OrgJsoupNodesTextNode *destText = new_OrgJsoupNodesTextNode_initWithNSString_withNSString_([((OrgJsoupNodesTextNode *) nil_chk(sourceText)) getWholeText], [((OrgJsoupNodesNode *) nil_chk(source)) baseUri]);
    (void) [((OrgJsoupNodesElement *) nil_chk(destination_)) appendChildWithOrgJsoupNodesNode:destText];
  }
    ...
    OrgJsoupNodesDataNode *destData = new_OrgJsoupNodesDataNode_initWithNSString_withNSString_([((OrgJsoupNodesDataNode *) nil_chk(sourceData)) getWholeData], [((OrgJsoupNodesNode *) nil_chk(source)) baseUri]);
    (void) [((OrgJsoupNodesElement *) nil_chk(destination_)) appendChildWithOrgJsoupNodesNode:destData];
  }
  else {
    numDiscarded_++;
  }
...
- (void)tailWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)source
  ...
  if ([source isKindOfClass:[OrgJsoupNodesElement class]] && [((OrgJsoupSafetyWhitelist *) nil_chk(this$0_->whitelist_)) isSafeTagWithNSString:[((OrgJsoupNodesNode *) nil_chk(source)) nodeName]]) {
    destination_ = [((OrgJsoupNodesElement *) nil_chk(destination_)) parent];
  }
}
