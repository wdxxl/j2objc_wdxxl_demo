...
- (OrgApacheCommonsCodecLanguageBmLanguages_LanguageSet *)restrictToWithOrgApacheCommonsCodecLanguageBmLanguages_LanguageSet:(OrgApacheCommonsCodecLanguageBmLanguages_LanguageSet *)other {
  if (other == JreLoadStatic(OrgApacheCommonsCodecLanguageBmLanguages, NO_LANGUAGES)) {
    ...
    id<JavaUtilSet> ls = new_JavaUtilHashSet_initWithInt_(JavaLangMath_minWithInt_withInt_([((id<JavaUtilSet>) nil_chk(languages_)) size], [((OrgApacheCommonsCodecLanguageBmLanguages_SomeLanguages *) nil_chk(sl))->languages_ size]));
...
- (OrgApacheCommonsCodecLanguageBmLanguages_LanguageSet *)mergeWithOrgApacheCommonsCodecLanguageBmLanguages_LanguageSet:(OrgApacheCommonsCodecLanguageBmLanguages_LanguageSet *)other {
  if (other == JreLoadStatic(OrgApacheCommonsCodecLanguageBmLanguages, NO_LANGUAGES)) {
    ...
    OrgApacheCommonsCodecLanguageBmLanguages_SomeLanguages *sl = (OrgApacheCommonsCodecLanguageBmLanguages_SomeLanguages *) cast_chk(other, [OrgApacheCommonsCodecLanguageBmLanguages_SomeLanguages class]);
    id<JavaUtilSet> ls = new_JavaUtilHashSet_initWithJavaUtilCollection_(languages_);
