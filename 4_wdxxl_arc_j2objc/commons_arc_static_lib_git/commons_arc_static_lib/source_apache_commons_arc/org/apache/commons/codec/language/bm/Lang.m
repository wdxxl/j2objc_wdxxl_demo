      ...
      if (inExtendedComment) {
        ...
        if ([((NSString *) nil_chk(line)) java_hasPrefix:OrgApacheCommonsCodecLanguageBmResourceConstants_EXT_CMT_START]) {
          ...
          if (((IOSObjectArray *) nil_chk(parts))->size_ != 3) {
            @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$$C", @"Malformed line '", rawLine, @"' in language resource '", languageRulesResourceName, '\''));
          }
