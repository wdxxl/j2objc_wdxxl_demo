...
inline NSString *OrgApacheCommonsLang3TimeDurationFormatUtils_get_ISO_EXTENDED_FORMAT_PATTERN(void);
...
inline id OrgApacheCommonsLang3TimeDurationFormatUtils_get_y(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline id OrgApacheCommonsLang3TimeDurationFormatUtils_get_M(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline id OrgApacheCommonsLang3TimeDurationFormatUtils_get_d(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline id OrgApacheCommonsLang3TimeDurationFormatUtils_get_H(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline id OrgApacheCommonsLang3TimeDurationFormatUtils_get_s(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
FOUNDATION_EXPORT OrgApacheCommonsLang3TimeDurationFormatUtils *new_OrgApacheCommonsLang3TimeDurationFormatUtils_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3TimeDurationFormatUtils *create_OrgApacheCommonsLang3TimeDurationFormatUtils_init(void);
