...
FOUNDATION_EXPORT OrgApacheCommonsLang3ExceptionDefaultExceptionContext *new_OrgApacheCommonsLang3ExceptionDefaultExceptionContext_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3ExceptionDefaultExceptionContext *create_OrgApacheCommonsLang3ExceptionDefaultExceptionContext_init(void);
