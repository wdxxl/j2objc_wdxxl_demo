...
FOUNDATION_EXPORT OrgApacheCommonsLang3TimeStopWatch *new_OrgApacheCommonsLang3TimeStopWatch_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsLang3TimeStopWatch *create_OrgApacheCommonsLang3TimeStopWatch_init(void);
