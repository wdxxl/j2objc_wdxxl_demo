...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/index/FormatPostingsFieldsWriter.java
//
...
- (OrgApacheLuceneIndexFormatPostingsTermsConsumer *)addFieldWithOrgApacheLuceneIndexFieldInfo:(OrgApacheLuceneIndexFieldInfo *)field {
  [((OrgApacheLuceneIndexFormatPostingsTermsWriter *) nil_chk([((JavaLangRefWeakReference *) nil_chk(termsWriter_)) get])) setFieldWithOrgApacheLuceneIndexFieldInfo:field];
  return [((JavaLangRefWeakReference *) nil_chk(termsWriter_)) get];
}

- (void)finish {
  OrgApacheLuceneUtilIOUtils_closeWithJavaIoCloseableArray_([IOSObjectArray newArrayWithObjects:(id[]){ termsOut_, [((JavaLangRefWeakReference *) nil_chk(termsWriter_)) get] } count:2 type:JavaIoCloseable_class_()]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "termsWriter_", "LJavaLangRefWeakReference;", .constantValue.asLong = 0, 0x0, -1, -1, 4, -1 },
  ...
  static const void *ptrTable[] = { "LOrgApacheLuceneIndexSegmentWriteState;LOrgApacheLuceneIndexFieldInfos;", "LJavaIoIOException;", "addField", "LOrgApacheLuceneIndexFieldInfo;", "Ljava/lang/ref/WeakReference<Lorg/apache/lucene/index/FormatPostingsTermsWriter;>;" };
...
void OrgApacheLuceneIndexFormatPostingsFieldsWriter_initWithOrgApacheLuceneIndexSegmentWriteState_withOrgApacheLuceneIndexFieldInfos_(OrgApacheLuceneIndexFormatPostingsFieldsWriter *self, OrgApacheLuceneIndexSegmentWriteState *state, OrgApacheLuceneIndexFieldInfos *fieldInfos) {
  ...
  @try {
    ...
    self->termsWriter_ = new_JavaLangRefWeakReference_initWithId_(new_OrgApacheLuceneIndexFormatPostingsTermsWriter_initWithOrgApacheLuceneIndexSegmentWriteState_withOrgApacheLuceneIndexFormatPostingsFieldsWriter_(state, self));
    success = true;
  }
  @finally {
    if (!success) {
      OrgApacheLuceneUtilIOUtils_closeWhileHandlingExceptionWithJavaIoCloseableArray_([IOSObjectArray newArrayWithObjects:(id[]){ self->termsOut_, [((JavaLangRefWeakReference *) nil_chk(self->termsWriter_)) get] } count:2 type:JavaIoCloseable_class_()]);
    }
  }
}
