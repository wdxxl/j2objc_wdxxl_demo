...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/grouping/SentinelIntSet.java
//
...
- (void)rehash {
  ...
  keys_ = [IOSIntArray newArrayWithLength:newSize];
...
void OrgApacheLuceneSearchGroupingSentinelIntSet_initWithInt_withInt_(OrgApacheLuceneSearchGroupingSentinelIntSet *self, jint size, jint emptyVal) {
  ...
  self->keys_ = [IOSIntArray newArrayWithLength:tsize];
