...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/grouping/AbstractAllGroupHeadsCollector.java
//
...
- (OrgApacheLuceneUtilFixedBitSet *)retrieveGroupHeadsWithInt:(jint)maxDoc {
  OrgApacheLuceneUtilFixedBitSet *bitSet = new_OrgApacheLuceneUtilFixedBitSet_initWithInt_(maxDoc);
...
- (IOSIntArray *)retrieveGroupHeads {
  id<JavaUtilCollection> groupHeads = [self getCollectedGroupHeads];
  IOSIntArray *docHeads = [IOSIntArray newArrayWithLength:[((id<JavaUtilCollection>) nil_chk(groupHeads)) size]];
  jint i = 0;
...
void OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_initWithInt_(OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector *self, jint numberOfSorts) {
  ...
  self->reversed_ = [IOSIntArray newArrayWithLength:numberOfSorts];
  self->compIDXEnd_ = numberOfSorts - 1;
  self->temporalResult_ = new_OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_TemporalResult_initWithOrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_(self);
}
