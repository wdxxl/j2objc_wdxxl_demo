...
//  source: jar:file:lucene_fis-core-grouping-3.5.0-sources_arc.jar!org/apache/lucene/search/grouping/TermAllGroupHeadsCollector.java
//
...
OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector *OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_createWithNSString_withOrgApacheLuceneSearchSort_withInt_(NSString *groupField, OrgApacheLuceneSearchSort *sortWithinGroup, jint initialSize) {
  ...
  jboolean sortAllFieldValue = true;
  {
    ...
    while (b__ < e__) {
      ...
      if ([((OrgApacheLuceneSearchSortField *) nil_chk(sortField)) getType] == OrgApacheLuceneSearchSortField_SCORE) {
        ...
        return new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector_initWithNSString_withOrgApacheLuceneSearchSort_(groupField, sortWithinGroup);
      }
      else {
        sortAllScore = false;
      }
  ...
  if (sortAllScore) {
    return new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector_initWithNSString_withOrgApacheLuceneSearchSort_withInt_(groupField, sortWithinGroup, initialSize);
  }
  else if (sortAllFieldValue) {
    return new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_initWithNSString_withOrgApacheLuceneSearchSort_withInt_(groupField, sortWithinGroup, initialSize);
  }
  else {
    return new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_initWithNSString_withOrgApacheLuceneSearchSort_withInt_(groupField, sortWithinGroup, initialSize);
  }
}
...
- (void)retrieveGroupHeadAndAddIfNotExistWithInt:(jint)doc {
  ...
  if (groupHead == nil) {
    groupHead = new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector_withNSString_withOrgApacheLuceneSearchSort_withInt_(self, groupValue, sortWithinGroup_, doc);
    (void) [groups_ putWithId:groupValue == nil ? nil : groupValue withId:groupHead];
  ...
  temporalResult_->groupHead_ = groupHead;
}
...
- (void)setNextReaderWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  self->indexReader_ = reader;
  self->docBase_ = docBase;
  groupIndex_ = [((id<OrgApacheLuceneSearchFieldCache>) nil_chk(JreLoadStatic(OrgApacheLuceneSearchFieldCache, DEFAULT))) getStringIndexWithOrgApacheLuceneIndexIndexReader:reader withNSString:groupField_];
...
void OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector_initWithNSString_withOrgApacheLuceneSearchSort_(OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector *self, NSString *groupField, OrgApacheLuceneSearchSort *sortWithinGroup) {
  ...
  self->sortWithinGroup_ = sortWithinGroup;
...
void OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector_withNSString_withOrgApacheLuceneSearchSort_withInt_(OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector_GroupHead *self, OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_GeneralAllGroupHeadsCollector *outer$, NSString *groupValue, OrgApacheLuceneSearchSort *sort, jint doc) {
  ...
  for (jint i = 0; i < sortFields->size_; i++) {
    (void) IOSObjectArray_Set(self->comparators_, i, [((OrgApacheLuceneSearchSortField *) nil_chk(IOSObjectArray_Get(sortFields, i))) getComparatorWithInt:1 withInt:i]);
...
- (void)retrieveGroupHeadAndAddIfNotExistWithInt:(jint)doc {
  ...
  if (![((OrgApacheLuceneSearchGroupingSentinelIntSet *) nil_chk(ordSet_)) existsWithInt:key]) {
    ...
    groupHead = new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_withInt_withNSString_(self, doc, term);
    [((id<JavaUtilList>) nil_chk(collectedGroups_)) addWithId:groupHead];
    (void) IOSObjectArray_Set(nil_chk(segmentGroupHeads_), key, groupHead);
    ((OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_TemporalResult *) nil_chk(temporalResult_))->stop_ = true;
  }
  else {
    ((OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_TemporalResult *) nil_chk(temporalResult_))->stop_ = false;
...
- (void)setNextReaderWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(fields_))->size_; i++) {
    ...
    (void) IOSObjectArray_Set(nil_chk(sortsIndex_), i, [JreLoadStatic(OrgApacheLuceneSearchFieldCache, DEFAULT) getStringIndexWithOrgApacheLuceneIndexIndexReader:reader withNSString:[((OrgApacheLuceneSearchSortField *) nil_chk(IOSObjectArray_Get(fields_, i))) getField]]);
  }
  [((OrgApacheLuceneSearchGroupingSentinelIntSet *) nil_chk(ordSet_)) clear];
  segmentGroupHeads_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(groupIndex_))->lookup_))->size_ type:OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_GroupHead_class_()];
  for (OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_GroupHead * __strong collectedGroup in nil_chk(collectedGroups_)) {
    ...
    if (ord >= 0) {
      ...
      (void) IOSObjectArray_Set(nil_chk(segmentGroupHeads_), ord, collectedGroup);
...
void OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_initWithNSString_withOrgApacheLuceneSearchSort_withInt_(OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector *self, NSString *groupField, OrgApacheLuceneSearchSort *sortWithinGroup, jint initialSize) {
  ...
  self->collectedGroups_ = new_JavaUtilArrayList_initWithInt_(initialSize);
  IOSObjectArray *sortFields = [sortWithinGroup getSort];
  self->fields_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(sortFields))->size_ type:OrgApacheLuceneSearchSortField_class_()];
  self->sortsIndex_ = [IOSObjectArray newArrayWithLength:sortFields->size_ type:OrgApacheLuceneSearchFieldCache_StringIndex_class_()];
  for (jint i = 0; i < sortFields->size_; i++) {
    *IOSIntArray_GetRef(nil_chk(self->reversed_), i) = [((OrgApacheLuceneSearchSortField *) nil_chk(IOSObjectArray_Get(sortFields, i))) getReverse] ? -1 : 1;
    (void) IOSObjectArray_Set(self->fields_, i, IOSObjectArray_Get(sortFields, i));
  }
}
...
void OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_withInt_withNSString_(OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector_GroupHead *self, OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdScoreAllGroupHeadsCollector *outer$, jint doc, NSString *groupValue) {
  self->this$0_ = outer$;
  OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_GroupHead_initWithId_withInt_(self, groupValue, doc + outer$->docBase_);
  self->sortValues_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(outer$->sortsIndex_))->size_ type:NSString_class_()];
  self->sortOrds_ = [IOSIntArray newArrayWithLength:outer$->sortsIndex_->size_];
  self->scores_ = [IOSFloatArray newArrayWithLength:outer$->sortsIndex_->size_];
...
- (void)retrieveGroupHeadAndAddIfNotExistWithInt:(jint)doc {
  ...
  if (![((OrgApacheLuceneSearchGroupingSentinelIntSet *) nil_chk(ordSet_)) existsWithInt:key]) {
    [ordSet_ putWithInt:key];
    NSString *term = key == 0 ? nil : IOSObjectArray_Get(nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(groupIndex_))->lookup_), key);
    groupHead = new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_withInt_withNSString_(self, doc, term);
    [((id<JavaUtilList>) nil_chk(collectedGroups_)) addWithId:groupHead];
    (void) IOSObjectArray_Set(nil_chk(segmentGroupHeads_), key, groupHead);
    ((OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_TemporalResult *) nil_chk(temporalResult_))->stop_ = true;
  }
...
- (void)setNextReaderWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  [((OrgApacheLuceneSearchGroupingSentinelIntSet *) nil_chk(ordSet_)) clear];
  segmentGroupHeads_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(groupIndex_))->lookup_))->size_ type:OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_GroupHead_class_()];
  for (OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_GroupHead * __strong collectedGroup in nil_chk(collectedGroups_)) {
    ...
    if (groupOrd >= 0) {
      ...
      (void) IOSObjectArray_Set(nil_chk(segmentGroupHeads_), groupOrd, collectedGroup);
      for (jint i = 0; i < ((IOSObjectArray *) nil_chk(sortsIndex_))->size_; i++) {
...
- (void)updateDocHeadWithInt:(jint)doc {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(this$0_->sortsIndex_))->size_; i++) {
    (void) IOSObjectArray_Set(nil_chk(sortValues_), i, IOSObjectArray_Get(nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(IOSObjectArray_Get(this$0_->sortsIndex_, i)))->lookup_), IOSIntArray_Get(nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(IOSObjectArray_Get(this$0_->sortsIndex_, i)))->order_), doc)));
    *IOSIntArray_GetRef(nil_chk(sortOrds_), i) = IOSIntArray_Get(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(IOSObjectArray_Get(this$0_->sortsIndex_, i)))->order_, doc);
  }
  self->doc_ = doc + this$0_->docBase_;
}
...
void OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_withInt_withNSString_(OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector_GroupHead *self, OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_OrdAllGroupHeadsCollector *outer$, jint doc, NSString *groupValue) {
  ...
  for (jint i = 0; i < outer$->sortsIndex_->size_; i++) {
    (void) IOSObjectArray_Set(self->sortValues_, i, IOSObjectArray_Get(nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(IOSObjectArray_Get(outer$->sortsIndex_, i)))->lookup_), IOSIntArray_Get(nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(IOSObjectArray_Get(outer$->sortsIndex_, i)))->order_), doc)));
...
- (void)retrieveGroupHeadAndAddIfNotExistWithInt:(jint)doc {
  ...
  if (![((OrgApacheLuceneSearchGroupingSentinelIntSet *) nil_chk(ordSet_)) existsWithInt:key]) {
    [ordSet_ putWithInt:key];
    NSString *term = key == 0 ? nil : IOSObjectArray_Get(nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(groupIndex_))->lookup_), key);
    groupHead = new_OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector_withInt_withNSString_(self, doc, term);
    [((id<JavaUtilList>) nil_chk(collectedGroups_)) addWithId:groupHead];
    (void) IOSObjectArray_Set(nil_chk(segmentGroupHeads_), key, groupHead);
    ((OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_TemporalResult *) nil_chk(temporalResult_))->stop_ = true;
  }
...
- (void)setNextReaderWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  groupIndex_ = [((id<OrgApacheLuceneSearchFieldCache>) nil_chk(JreLoadStatic(OrgApacheLuceneSearchFieldCache, DEFAULT))) getStringIndexWithOrgApacheLuceneIndexIndexReader:reader withNSString:groupField_];
  [((OrgApacheLuceneSearchGroupingSentinelIntSet *) nil_chk(ordSet_)) clear];
  segmentGroupHeads_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(groupIndex_))->lookup_))->size_ type:OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector_GroupHead_class_()];
...
void OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector_GroupHead_initWithOrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector_withInt_withNSString_(OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector_GroupHead *self, OrgApacheLuceneSearchGroupingTermAllGroupHeadsCollector_ScoreAllGroupHeadsCollector *outer$, jint doc, NSString *groupValue) {
  self->this$0_ = outer$;
  OrgApacheLuceneSearchGroupingAbstractAllGroupHeadsCollector_GroupHead_initWithId_withInt_(self, groupValue, doc + outer$->docBase_);
  self->scores_ = [IOSFloatArray newArrayWithLength:((IOSObjectArray *) nil_chk(outer$->fields_))->size_];
