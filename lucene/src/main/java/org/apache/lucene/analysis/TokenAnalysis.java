...
public class TokenAnalysis extends TermAttributeImpl
  ...
  public TokenAnalysis(int start, int end) {
    startOffset = start;
    endOffset = end;
  }
  ...
  public TokenAnalysis(int start, int end, String typ) {
    startOffset = start;
    endOffset = end;
    type = typ;
  }
   ...
   */
  public TokenAnalysis(int start, int end, int flags) {
    startOffset = start;
    endOffset = end;
    this.flags = flags;
  }
   ...
   */
  public TokenAnalysis(String text, int start, int end) {
    append(text);
    startOffset = start;
    endOffset = end;
  }
   ...
   */
  public TokenAnalysis(String text, int start, int end, String typ) {
    append(text);
    startOffset = start;
    endOffset = end;
    type = typ;
   ...
   */
  public TokenAnalysis(String text, int start, int end, int flags) {
    append(text);
    startOffset = start;
    endOffset = end;
    this.flags = flags;
   ...
   * @param end
   */
  public TokenAnalysis(char[] startTermBuffer, int termBufferOffset, int termBufferLength, int start, int end) {
  ...
  @Override
  public Object clone() {
    TokenAnalysis t = (TokenAnalysis)super.clone();
    // Do a deep clone
    if (payload != null) {
   ...
   * termBuffer. */
  public TokenAnalysis clone(char[] newTermBuffer, int newTermOffset, int newTermLength, int newStartOffset, int newEndOffset) {
    final TokenAnalysis t = new TokenAnalysis(newTermBuffer, newTermOffset, newTermLength, newStartOffset, newEndOffset);
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof TokenAnalysis) {
      final TokenAnalysis other = (TokenAnalysis) obj;
  ...
  public TokenAnalysis reinit(char[] newTermBuffer, int newTermOffset, int newTermLength, int newStartOffset, int newEndOffset, String newType) {
    clearNoTermBuffer();
   ...
   *  @return this Token instance */
  public TokenAnalysis reinit(char[] newTermBuffer, int newTermOffset, int newTermLength, int newStartOffset, int newEndOffset) {
    clearNoTermBuffer();
    copyBuffer(newTermBuffer, newTermOffset, newTermLength);
    startOffset = newStartOffset;
    endOffset = newEndOffset;
   ...
   *  {@link #setType}
   *  @return this Token instance */
  public TokenAnalysis reinit(String newTerm, int newStartOffset, int newEndOffset, String newType) {
    clear();
    append(newTerm);
    startOffset = newStartOffset;
    endOffset = newEndOffset;
   ...
   *  {@link #setType}
   *  @return this Token instance */
  public TokenAnalysis reinit(String newTerm, int newTermOffset, int newTermLength, int newStartOffset, int newEndOffset, String newType) {
    clear();
   ...
   *  {@link #setType} on Token.DEFAULT_TYPE
   *  @return this Token instance */
  public TokenAnalysis reinit(String newTerm, int newStartOffset, int newEndOffset) {
    clear();
    append(newTerm);
    startOffset = newStartOffset;
    endOffset = newEndOffset;
   ...
   *  {@link #setType} on Token.DEFAULT_TYPE
   *  @return this Token instance */
  public TokenAnalysis reinit(String newTerm, int newTermOffset, int newTermLength, int newStartOffset, int newEndOffset) {
    clear();
    append(newTerm, newTermOffset, newTermOffset + newTermLength);
    startOffset = newStartOffset;
    endOffset = newEndOffset;
   ...
   * @param prototype
   */
  public void reinit(TokenAnalysis prototype) {
   ...
   * @param newTerm
   */
  public void reinit(TokenAnalysis prototype, String newTerm) {
   ...
   * @param length
   */
  public void reinit(TokenAnalysis prototype, char[] newTermBuffer, int offset, int length) {
  ...
  public void copyTo(AttributeImpl target) {
    if (target instanceof TokenAnalysis) {
      final TokenAnalysis to = (TokenAnalysis) target;
      to.reinit(this);
  ...
  /** <b>Expert:</b> Creates a TokenAttributeFactory returning {@link TokenAnalysis} as instance for the basic attributes
  ...
  public static final class TokenAttributeFactory extends AttributeSource.AttributeFactory {
    ...
    /** <b>Expert</b>: Creates an AttributeFactory returning {@link TokenAnalysis} as instance for the basic attributes
     * and for all other attributes calls the given delegate factory. */
    ...
    public AttributeImpl createAttributeInstance(Class<? extends Attribute> attClass) {
      return attClass.isAssignableFrom(TokenAnalysis.class)
        ? new TokenAnalysis() : delegate.createAttributeInstance(attClass);
    }
