 ...
 * has moved from being {@link TokenAnalysis}-based to {@link Attribute}-based. While
 * {@link TokenAnalysis} still exists in 2.9 as a convenience class, the preferred way
 * to store the information of a {@link TokenAnalysis} is to use {@link AttributeImpl}s.
 * <p>
