...
final class ByteSliceReader extends IndexInput {
  ...
  public void init(ByteBlockPoolIndex pool, int startIndex, int endIndex) {
    ...
    final int firstSize = ByteBlockPoolIndex.levelSizeArray[0];
  ...
  public void nextSlice() {
    ...
    level = ByteBlockPoolIndex.nextLevelArray[level];
    final int newSize = ByteBlockPoolIndex.levelSizeArray[level];
