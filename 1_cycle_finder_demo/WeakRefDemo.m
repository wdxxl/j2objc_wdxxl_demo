...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "main", "[LNSString;", "LJavaLangInterruptedException;", "LWeakRefDemo_Demo;" };
  static const J2ObjcClassInfo _WeakRefDemo = { "WeakRefDemo", NULL, ptrTable, methods, NULL, 7, 0x1, 2, 0, -1, 3, -1, -1, -1 };
  return &_WeakRefDemo;
}
...
void WeakRefDemo_mainWithNSStringArray_(IOSObjectArray *args) {
  ...
  WeakRefDemo *weakRefDemo = create_WeakRefDemo_init();
  WeakRefDemo_Demo *demo = create_WeakRefDemo_Demo_initWithWeakRefDemo_withNSString_(weakRefDemo, @"Hello WeakRef");
  JavaLangRefWeakReference *wr = create_JavaLangRefWeakReference_initWithId_(demo);
